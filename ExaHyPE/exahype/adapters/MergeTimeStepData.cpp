...
peano::CommunicationSpecification   exahype::adapters::MergeTimeStepData::communicationSpecification() const {
...
peano::MappingSpecification   exahype::adapters::MergeTimeStepData::touchVertexLastTimeSpecification(int level) const {
...
peano::MappingSpecification   exahype::adapters::MergeTimeStepData::touchVertexFirstTimeSpecification(int level) const { 
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::MergeTimeStepData::enterCellSpecification(int level) const {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::MergeTimeStepData::leaveCellSpecification(int level) const {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::MergeTimeStepData::ascendSpecification(int level) const {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::MergeTimeStepData::descendSpecification(int level) const {
  return peano::MappingSpecification::getMinimalSpecification()
