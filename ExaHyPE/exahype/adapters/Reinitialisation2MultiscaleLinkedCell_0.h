...
#ifndef EXAHYPE_ADAPTERS_Reinitialisation2MultiscaleLinkedCell_0_H_
#define EXAHYPE_ADAPTERS_Reinitialisation2MultiscaleLinkedCell_0_H_
...
namespace exahype {
      namespace adapters {
        class Reinitialisation2MultiscaleLinkedCell_0;
      } 
}
 ...
 */
class exahype::adapters::Reinitialisation2MultiscaleLinkedCell_0 {
  public:
    ...
    Reinitialisation2MultiscaleLinkedCell_0();

    #if defined(SharedMemoryParallelisation)
    Reinitialisation2MultiscaleLinkedCell_0(const Reinitialisation2MultiscaleLinkedCell_0& masterThread);
    #endif

    virtual ~Reinitialisation2MultiscaleLinkedCell_0();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const Reinitialisation2MultiscaleLinkedCell_0& workerThread);
    #endif
