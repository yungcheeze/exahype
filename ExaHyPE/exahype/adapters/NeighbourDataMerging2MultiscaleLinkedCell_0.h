...
#ifndef EXAHYPE_ADAPTERS_NeighbourDataMerging2MultiscaleLinkedCell_0_H_
#define EXAHYPE_ADAPTERS_NeighbourDataMerging2MultiscaleLinkedCell_0_H_
...
namespace exahype {
      namespace adapters {
        class NeighbourDataMerging2MultiscaleLinkedCell_0;
      } 
}
 ...
 */
class exahype::adapters::NeighbourDataMerging2MultiscaleLinkedCell_0 {
  public:
    ...
    NeighbourDataMerging2MultiscaleLinkedCell_0();

    #if defined(SharedMemoryParallelisation)
    NeighbourDataMerging2MultiscaleLinkedCell_0(const NeighbourDataMerging2MultiscaleLinkedCell_0& masterThread);
    #endif

    virtual ~NeighbourDataMerging2MultiscaleLinkedCell_0();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const NeighbourDataMerging2MultiscaleLinkedCell_0& workerThread);
    #endif
