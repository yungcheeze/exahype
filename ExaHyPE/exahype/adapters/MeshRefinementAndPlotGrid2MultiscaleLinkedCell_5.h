...
#ifndef EXAHYPE_ADAPTERS_MeshRefinementAndPlotGrid2MultiscaleLinkedCell_5_H_
#define EXAHYPE_ADAPTERS_MeshRefinementAndPlotGrid2MultiscaleLinkedCell_5_H_
...
namespace exahype {
      namespace adapters {
        class MeshRefinementAndPlotGrid2MultiscaleLinkedCell_5;
      } 
}
 ...
 */
class exahype::adapters::MeshRefinementAndPlotGrid2MultiscaleLinkedCell_5 {
  public:
    ...
    MeshRefinementAndPlotGrid2MultiscaleLinkedCell_5();

    #if defined(SharedMemoryParallelisation)
    MeshRefinementAndPlotGrid2MultiscaleLinkedCell_5(const MeshRefinementAndPlotGrid2MultiscaleLinkedCell_5& masterThread);
    #endif

    virtual ~MeshRefinementAndPlotGrid2MultiscaleLinkedCell_5();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const MeshRefinementAndPlotGrid2MultiscaleLinkedCell_5& workerThread);
    #endif
