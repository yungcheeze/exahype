...
exahype::adapters::TimeStepDataMergingAndDropIncomingMPIMessages::TimeStepDataMergingAndDropIncomingMPIMessages() {
}
...
exahype::adapters::TimeStepDataMergingAndDropIncomingMPIMessages::TimeStepDataMergingAndDropIncomingMPIMessages(const TimeStepDataMergingAndDropIncomingMPIMessages&  masterThread):
...
void exahype::adapters::TimeStepDataMergingAndDropIncomingMPIMessages::mergeWithWorkerThread(const TimeStepDataMergingAndDropIncomingMPIMessages& workerThread) {
...
void exahype::adapters::TimeStepDataMergingAndDropIncomingMPIMessages::createHangingVertex(
...
void exahype::adapters::TimeStepDataMergingAndDropIncomingMPIMessages::destroyHangingVertex(
...
void exahype::adapters::TimeStepDataMergingAndDropIncomingMPIMessages::createInnerVertex(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::TimeStepDataMergingAndDropIncomingMPIMessages::createBoundaryVertex(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::TimeStepDataMergingAndDropIncomingMPIMessages::destroyVertex(
      const exahype::Vertex&   fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      exahype::Vertex * const  coarseGridVertices,
...
void exahype::adapters::TimeStepDataMergingAndDropIncomingMPIMessages::createCell(
...
void exahype::adapters::TimeStepDataMergingAndDropIncomingMPIMessages::destroyCell(
...
#ifdef Parallel
void exahype::adapters::TimeStepDataMergingAndDropIncomingMPIMessages::mergeWithNeighbour(
...
void exahype::adapters::TimeStepDataMergingAndDropIncomingMPIMessages::prepareSendToNeighbour(
  exahype::Vertex&  vertex,
  int                                           toRank,
...
void exahype::adapters::TimeStepDataMergingAndDropIncomingMPIMessages::prepareCopyToRemoteNode(
...
void exahype::adapters::TimeStepDataMergingAndDropIncomingMPIMessages::mergeWithRemoteDataDueToForkOrJoin(
  exahype::Vertex&  localVertex,
...
bool exahype::adapters::TimeStepDataMergingAndDropIncomingMPIMessages::prepareSendToWorker(
  exahype::Cell&                 fineGridCell,
  exahype::Vertex * const        fineGridVertices,
  const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
  exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::TimeStepDataMergingAndDropIncomingMPIMessages::prepareSendToMaster(
  exahype::Cell&                       localCell,
...
void exahype::adapters::TimeStepDataMergingAndDropIncomingMPIMessages::mergeWithMaster(
...
void exahype::adapters::TimeStepDataMergingAndDropIncomingMPIMessages::receiveDataFromMaster(
...
void exahype::adapters::TimeStepDataMergingAndDropIncomingMPIMessages::mergeWithWorker(
  exahype::Cell&           localCell, 
...
void exahype::adapters::TimeStepDataMergingAndDropIncomingMPIMessages::touchVertexFirstTime(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::TimeStepDataMergingAndDropIncomingMPIMessages::touchVertexLastTime(
      exahype::Vertex&         fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      exahype::Vertex * const  coarseGridVertices,
...
void exahype::adapters::TimeStepDataMergingAndDropIncomingMPIMessages::enterCell(
      exahype::Cell&                 fineGridCell,
      exahype::Vertex * const        fineGridVertices,
      const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::TimeStepDataMergingAndDropIncomingMPIMessages::leaveCell(
      exahype::Cell&           fineGridCell,
      exahype::Vertex * const  fineGridVertices,
      const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
      exahype::Vertex * const  coarseGridVertices,
...
void exahype::adapters::TimeStepDataMergingAndDropIncomingMPIMessages::beginIteration(
...
void exahype::adapters::TimeStepDataMergingAndDropIncomingMPIMessages::endIteration(
  exahype::State&  solverState
) {
...
void exahype::adapters::TimeStepDataMergingAndDropIncomingMPIMessages::descend(
...
void exahype::adapters::TimeStepDataMergingAndDropIncomingMPIMessages::ascend(
  exahype::Cell * const    fineGridCells,
  exahype::Vertex * const  fineGridVertices,
  const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
  exahype::Vertex * const  coarseGridVertices,
