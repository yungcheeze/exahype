...
#ifndef EXAHYPE_ADAPTERS_PlotAndADERDGTimeStep2MultiscaleLinkedCell_0_H_
#define EXAHYPE_ADAPTERS_PlotAndADERDGTimeStep2MultiscaleLinkedCell_0_H_
...
namespace exahype {
      namespace adapters {
        class PlotAndADERDGTimeStep2MultiscaleLinkedCell_0;
      } 
}
 ...
 */
class exahype::adapters::PlotAndADERDGTimeStep2MultiscaleLinkedCell_0 {
  public:
    ...
    PlotAndADERDGTimeStep2MultiscaleLinkedCell_0();

    #if defined(SharedMemoryParallelisation)
    PlotAndADERDGTimeStep2MultiscaleLinkedCell_0(const PlotAndADERDGTimeStep2MultiscaleLinkedCell_0& masterThread);
    #endif

    virtual ~PlotAndADERDGTimeStep2MultiscaleLinkedCell_0();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const PlotAndADERDGTimeStep2MultiscaleLinkedCell_0& workerThread);
    #endif
