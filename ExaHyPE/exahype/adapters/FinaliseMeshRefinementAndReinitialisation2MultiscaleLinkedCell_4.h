...
#ifndef EXAHYPE_ADAPTERS_FinaliseMeshRefinementAndReinitialisation2MultiscaleLinkedCell_4_H_
#define EXAHYPE_ADAPTERS_FinaliseMeshRefinementAndReinitialisation2MultiscaleLinkedCell_4_H_
...
namespace exahype {
      namespace adapters {
        class FinaliseMeshRefinementAndReinitialisation2MultiscaleLinkedCell_4;
      } 
}
 ...
 */
class exahype::adapters::FinaliseMeshRefinementAndReinitialisation2MultiscaleLinkedCell_4 {
  public:
    ...
    FinaliseMeshRefinementAndReinitialisation2MultiscaleLinkedCell_4();

    #if defined(SharedMemoryParallelisation)
    FinaliseMeshRefinementAndReinitialisation2MultiscaleLinkedCell_4(const FinaliseMeshRefinementAndReinitialisation2MultiscaleLinkedCell_4& masterThread);
    #endif

    virtual ~FinaliseMeshRefinementAndReinitialisation2MultiscaleLinkedCell_4();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const FinaliseMeshRefinementAndReinitialisation2MultiscaleLinkedCell_4& workerThread);
    #endif
