...
peano::CommunicationSpecification   exahype::adapters::Merging::communicationSpecification() {
...
peano::MappingSpecification   exahype::adapters::Merging::touchVertexLastTimeSpecification() {
...
peano::MappingSpecification   exahype::adapters::Merging::touchVertexFirstTimeSpecification() { 
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::Merging::enterCellSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::Merging::leaveCellSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::Merging::ascendSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::Merging::descendSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
