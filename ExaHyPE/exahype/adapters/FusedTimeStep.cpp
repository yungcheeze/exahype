...
peano::CommunicationSpecification   exahype::adapters::FusedTimeStep::communicationSpecification() const {
  return peano::CommunicationSpecification::getMinimalSpecification()
    &  _map2FusedTimeStep2MultiscaleLinkedCell_0.communicationSpecification()
...
peano::MappingSpecification   exahype::adapters::FusedTimeStep::touchVertexLastTimeSpecification(int level) const {
  return peano::MappingSpecification::getMinimalSpecification()
    &  _map2FusedTimeStep2MultiscaleLinkedCell_0.touchVertexLastTimeSpecification(level)
...
peano::MappingSpecification   exahype::adapters::FusedTimeStep::touchVertexFirstTimeSpecification(int level) const { 
  return peano::MappingSpecification::getMinimalSpecification()
    &  _map2FusedTimeStep2MultiscaleLinkedCell_0.touchVertexFirstTimeSpecification(level)
...
peano::MappingSpecification   exahype::adapters::FusedTimeStep::enterCellSpecification(int level) const {
  return peano::MappingSpecification::getMinimalSpecification()
    &  _map2FusedTimeStep2MultiscaleLinkedCell_0.enterCellSpecification(level)
...
peano::MappingSpecification   exahype::adapters::FusedTimeStep::leaveCellSpecification(int level) const {
  return peano::MappingSpecification::getMinimalSpecification()
    &  _map2FusedTimeStep2MultiscaleLinkedCell_0.leaveCellSpecification(level)
...
peano::MappingSpecification   exahype::adapters::FusedTimeStep::ascendSpecification(int level) const {
  return peano::MappingSpecification::getMinimalSpecification()
    &  _map2FusedTimeStep2MultiscaleLinkedCell_0.ascendSpecification(level)
...
peano::MappingSpecification   exahype::adapters::FusedTimeStep::descendSpecification(int level) const {
  return peano::MappingSpecification::getMinimalSpecification()
    &  _map2FusedTimeStep2MultiscaleLinkedCell_0.descendSpecification(level)
...
exahype::adapters::FusedTimeStep::FusedTimeStep(const FusedTimeStep&  masterThread):
  _map2FusedTimeStep2MultiscaleLinkedCell_0(masterThread._map2FusedTimeStep2MultiscaleLinkedCell_0) , 
...
void exahype::adapters::FusedTimeStep::mergeWithWorkerThread(const FusedTimeStep& workerThread) {
  _map2FusedTimeStep2MultiscaleLinkedCell_0.mergeWithWorkerThread(workerThread._map2FusedTimeStep2MultiscaleLinkedCell_0);
...
void exahype::adapters::FusedTimeStep::createHangingVertex(
  ...
  _map2FusedTimeStep2MultiscaleLinkedCell_0.createHangingVertex(fineGridVertex, fineGridX, fineGridH, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfVertex );
...
void exahype::adapters::FusedTimeStep::destroyHangingVertex(
  ...
  _map2FusedTimeStep2MultiscaleLinkedCell_0.destroyHangingVertex(fineGridVertex, fineGridX, fineGridH, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfVertex );
...
void exahype::adapters::FusedTimeStep::createInnerVertex(
  ...
  _map2FusedTimeStep2MultiscaleLinkedCell_0.createInnerVertex(fineGridVertex, fineGridX, fineGridH, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfVertex );
...
void exahype::adapters::FusedTimeStep::createBoundaryVertex(
  ...
  _map2FusedTimeStep2MultiscaleLinkedCell_0.createBoundaryVertex( fineGridVertex, fineGridX, fineGridH, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfVertex );
...
void exahype::adapters::FusedTimeStep::destroyVertex(
  ...
  _map2FusedTimeStep2MultiscaleLinkedCell_0.destroyVertex( fineGridVertex, fineGridX, fineGridH, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfVertex );
...
void exahype::adapters::FusedTimeStep::createCell(
  ...
  _map2FusedTimeStep2MultiscaleLinkedCell_0.createCell( fineGridCell, fineGridVertices, fineGridVerticesEnumerator, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfCell );
...
void exahype::adapters::FusedTimeStep::destroyCell(
  ...
  _map2FusedTimeStep2MultiscaleLinkedCell_0.destroyCell( fineGridCell, fineGridVertices, fineGridVerticesEnumerator, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfCell );
...
void exahype::adapters::FusedTimeStep::mergeWithNeighbour(
  ...
  int                                           level
   ...
   _map2FusedTimeStep2MultiscaleLinkedCell_0.mergeWithNeighbour( vertex, neighbour, fromRank, fineGridX, fineGridH, level );
...
void exahype::adapters::FusedTimeStep::prepareSendToNeighbour(
  ...
  int                                           level
   ...
   _map2FusedTimeStep2MultiscaleLinkedCell_0.prepareSendToNeighbour( vertex, toRank, x, h, level );
...
void exahype::adapters::FusedTimeStep::prepareCopyToRemoteNode(
  ...
  int                                           level
   ...
   _map2FusedTimeStep2MultiscaleLinkedCell_0.prepareCopyToRemoteNode( localVertex, toRank, x, h, level );
...
void exahype::adapters::FusedTimeStep::prepareCopyToRemoteNode(
  exahype::Cell&  localCell,
   ...
   _map2FusedTimeStep2MultiscaleLinkedCell_0.prepareCopyToRemoteNode( localCell, toRank, x, h, level );
...
void exahype::adapters::FusedTimeStep::mergeWithRemoteDataDueToForkOrJoin(
  ...
  int                                       level
   ...
   _map2FusedTimeStep2MultiscaleLinkedCell_0.mergeWithRemoteDataDueToForkOrJoin( localVertex, masterOrWorkerVertex, fromRank, x, h, level );
...
void exahype::adapters::FusedTimeStep::mergeWithRemoteDataDueToForkOrJoin(
  ...
  int                                       level
   ...
   _map2FusedTimeStep2MultiscaleLinkedCell_0.mergeWithRemoteDataDueToForkOrJoin( localCell, masterOrWorkerCell, fromRank, x, h, level );
...
bool exahype::adapters::FusedTimeStep::prepareSendToWorker(
  ...
  bool result = false;
   result |= _map2FusedTimeStep2MultiscaleLinkedCell_0.prepareSendToWorker( fineGridCell, fineGridVertices, fineGridVerticesEnumerator, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfCell, worker );
...
void exahype::adapters::FusedTimeStep::prepareSendToMaster(
  ...
  const tarch::la::Vector<DIMENSIONS,int>&   fineGridPositionOfCell
   ...
   _map2FusedTimeStep2MultiscaleLinkedCell_0.prepareSendToMaster( localCell, vertices, verticesEnumerator, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfCell );
...
void exahype::adapters::FusedTimeStep::mergeWithMaster(
  ...
  exahype::State&                masterState
   ...
   _map2FusedTimeStep2MultiscaleLinkedCell_0.mergeWithMaster( workerGridCell, workerGridVertices, workerEnumerator, fineGridCell, fineGridVertices, fineGridVerticesEnumerator, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfCell, worker, workerState, masterState );
...
void exahype::adapters::FusedTimeStep::mergeWithWorker(
  ...
  int                                          level
   ...
   _map2FusedTimeStep2MultiscaleLinkedCell_0.mergeWithWorker( localCell, receivedMasterCell, cellCentre, cellSize, level );
...
void exahype::adapters::FusedTimeStep::mergeWithWorker(
  ...
  int                                           level
   ...
   _map2FusedTimeStep2MultiscaleLinkedCell_0.mergeWithWorker( localVertex, receivedMasterVertex, x, h, level );
...
void exahype::adapters::FusedTimeStep::touchVertexFirstTime(
  ...
  _map2FusedTimeStep2MultiscaleLinkedCell_0.touchVertexFirstTime( fineGridVertex, fineGridX, fineGridH, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfVertex );
...
void exahype::adapters::FusedTimeStep::touchVertexLastTime(
  ...
  _map2FusedTimeStep2MultiscaleLinkedCell_0.touchVertexLastTime( fineGridVertex, fineGridX, fineGridH, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfVertex );
...
void exahype::adapters::FusedTimeStep::enterCell(
  ...
  _map2FusedTimeStep2MultiscaleLinkedCell_0.enterCell( fineGridCell, fineGridVertices, fineGridVerticesEnumerator, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfCell );
...
void exahype::adapters::FusedTimeStep::leaveCell(
  ...
  _map2FusedTimeStep2MultiscaleLinkedCell_0.leaveCell( fineGridCell, fineGridVertices, fineGridVerticesEnumerator, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfCell );
...
void exahype::adapters::FusedTimeStep::beginIteration(
  ...
  _map2FusedTimeStep2MultiscaleLinkedCell_0.beginIteration( solverState );
...
void exahype::adapters::FusedTimeStep::endIteration(
  ...
  _map2FusedTimeStep2MultiscaleLinkedCell_0.endIteration( solverState );
...
void exahype::adapters::FusedTimeStep::descend(
  ...
  _map2FusedTimeStep2MultiscaleLinkedCell_0.descend( fineGridCells, fineGridVertices, fineGridVerticesEnumerator, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell );
...
void exahype::adapters::FusedTimeStep::ascend(
  ...
  _map2FusedTimeStep2MultiscaleLinkedCell_0.ascend( fineGridCells, fineGridVertices, fineGridVerticesEnumerator, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell );
