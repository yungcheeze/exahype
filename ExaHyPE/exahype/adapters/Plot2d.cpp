...
peano::CommunicationSpecification   exahype::adapters::Plot2d::communicationSpecification() {
...
peano::MappingSpecification   exahype::adapters::Plot2d::touchVertexLastTimeSpecification() {
...
peano::MappingSpecification   exahype::adapters::Plot2d::touchVertexFirstTimeSpecification() { 
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::Plot2d::enterCellSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::Plot2d::leaveCellSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::Plot2d::ascendSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::Plot2d::descendSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
exahype::adapters::Plot2d::Plot2d() {
}
...
exahype::adapters::Plot2d::Plot2d(const Plot2d&  masterThread):
...
void exahype::adapters::Plot2d::mergeWithWorkerThread(const Plot2d& workerThread) {
...
void exahype::adapters::Plot2d::createHangingVertex(
...
void exahype::adapters::Plot2d::destroyHangingVertex(
...
void exahype::adapters::Plot2d::createInnerVertex(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::Plot2d::createBoundaryVertex(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::Plot2d::destroyVertex(
      const exahype::Vertex&   fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      exahype::Vertex * const  coarseGridVertices,
...
void exahype::adapters::Plot2d::createCell(
...
void exahype::adapters::Plot2d::destroyCell(
...
#ifdef Parallel
void exahype::adapters::Plot2d::mergeWithNeighbour(
...
void exahype::adapters::Plot2d::prepareSendToNeighbour(
  exahype::Vertex&  vertex,
  int                                           toRank,
...
void exahype::adapters::Plot2d::prepareCopyToRemoteNode(
...
void exahype::adapters::Plot2d::mergeWithRemoteDataDueToForkOrJoin(
  exahype::Vertex&  localVertex,
...
bool exahype::adapters::Plot2d::prepareSendToWorker(
  exahype::Cell&                 fineGridCell,
  exahype::Vertex * const        fineGridVertices,
  const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
  exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::Plot2d::prepareSendToMaster(
  exahype::Cell&                       localCell,
...
void exahype::adapters::Plot2d::mergeWithMaster(
...
void exahype::adapters::Plot2d::receiveDataFromMaster(
...
void exahype::adapters::Plot2d::mergeWithWorker(
  exahype::Cell&           localCell, 
...
void exahype::adapters::Plot2d::touchVertexFirstTime(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::Plot2d::touchVertexLastTime(
      exahype::Vertex&         fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      exahype::Vertex * const  coarseGridVertices,
...
void exahype::adapters::Plot2d::enterCell(
      exahype::Cell&                 fineGridCell,
      exahype::Vertex * const        fineGridVertices,
      const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::Plot2d::leaveCell(
      exahype::Cell&           fineGridCell,
      exahype::Vertex * const  fineGridVertices,
      const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
      exahype::Vertex * const  coarseGridVertices,
...
void exahype::adapters::Plot2d::beginIteration(
...
void exahype::adapters::Plot2d::endIteration(
  exahype::State&  solverState
) {
...
void exahype::adapters::Plot2d::descend(
...
void exahype::adapters::Plot2d::ascend(
  exahype::Cell * const    fineGridCells,
  exahype::Vertex * const  fineGridVertices,
  const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
  exahype::Vertex * const  coarseGridVertices,
