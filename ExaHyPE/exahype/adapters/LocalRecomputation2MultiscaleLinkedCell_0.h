...
#ifndef EXAHYPE_ADAPTERS_LocalRecomputation2MultiscaleLinkedCell_0_H_
#define EXAHYPE_ADAPTERS_LocalRecomputation2MultiscaleLinkedCell_0_H_
...
namespace exahype {
      namespace adapters {
        class LocalRecomputation2MultiscaleLinkedCell_0;
      } 
}
 ...
 */
class exahype::adapters::LocalRecomputation2MultiscaleLinkedCell_0 {
  public:
    ...
    LocalRecomputation2MultiscaleLinkedCell_0();

    #if defined(SharedMemoryParallelisation)
    LocalRecomputation2MultiscaleLinkedCell_0(const LocalRecomputation2MultiscaleLinkedCell_0& masterThread);
    #endif

    virtual ~LocalRecomputation2MultiscaleLinkedCell_0();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const LocalRecomputation2MultiscaleLinkedCell_0& workerThread);
    #endif
