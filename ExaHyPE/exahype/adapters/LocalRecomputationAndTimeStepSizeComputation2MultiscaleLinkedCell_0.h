...
#ifndef EXAHYPE_ADAPTERS_LocalRecomputationAndTimeStepSizeComputation2MultiscaleLinkedCell_0_H_
#define EXAHYPE_ADAPTERS_LocalRecomputationAndTimeStepSizeComputation2MultiscaleLinkedCell_0_H_
...
namespace exahype {
      namespace adapters {
        class LocalRecomputationAndTimeStepSizeComputation2MultiscaleLinkedCell_0;
      } 
}
 ...
 */
class exahype::adapters::LocalRecomputationAndTimeStepSizeComputation2MultiscaleLinkedCell_0 {
  public:
    ...
    LocalRecomputationAndTimeStepSizeComputation2MultiscaleLinkedCell_0();

    #if defined(SharedMemoryParallelisation)
    LocalRecomputationAndTimeStepSizeComputation2MultiscaleLinkedCell_0(const LocalRecomputationAndTimeStepSizeComputation2MultiscaleLinkedCell_0& masterThread);
    #endif

    virtual ~LocalRecomputationAndTimeStepSizeComputation2MultiscaleLinkedCell_0();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const LocalRecomputationAndTimeStepSizeComputation2MultiscaleLinkedCell_0& workerThread);
    #endif
