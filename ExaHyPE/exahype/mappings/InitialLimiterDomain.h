...
#ifndef EXAHYPE_MAPPINGS_InitialLimiterDomain_H_
#define EXAHYPE_MAPPINGS_InitialLimiterDomain_H_
 ...
 */
class exahype::mappings::InitialLimiterDomain {
 private:
  /**
 ...
 public:
   ...
   *
   * TODO(Dominic): This mapping should be renamed to InitialLimiterDomain.
   */
  void enterCell(
   ...
   * Nop
   */
  InitialLimiterDomain();

#if defined(SharedMemoryParallelisation)
  /**
   * Nop.
   */
  InitialLimiterDomain(const InitialLimiterDomain& masterThread);
#endif

  /**
   * Nop.
   */
  virtual ~InitialLimiterDomain();

#if defined(SharedMemoryParallelisation)
  /**
   * Nop.
   */
  void mergeWithWorkerThread(const InitialLimiterDomain& workerThread);
#endif
