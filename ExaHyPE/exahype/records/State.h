   ...
   class exahype::records::State { 
      ...
      public:
         ...
         enum AlgorithmSection {
            TimeStepping = 0, MeshRefinement = 1, MeshRefinementOrLocalOrGlobalRecomputation = 2, MeshRefinementOrLocalRecomputationAllSend = 3, GlobalRecomputationAllSend = 4, PredictionRerunAllSend = 5
         };
