...
std::string exahype::records::RepositoryState::toString(const Action& param) {
   switch (param) {
      ...
      case UseAdapterFinaliseMeshRefinementAndSubcellSending: return "UseAdapterFinaliseMeshRefinementAndSubcellSending";
