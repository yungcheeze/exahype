...
#test.settings['ExaBinary'] = "../../../ApplicationExamples/EulerFlow/ExaHyPE-EulerFlow"

test.settings['ExaBinary'] = '/bin/true'
test.settings['ExaBinaryTpl'] = '/bin/true'

test.settings['ExaSpecfile'] = "ShuVortexConvergenceTpl.exahype"
# template to set up a queueing system
test.settings['QRUNTPL'] = "srun -n1 --partition=x-men --time=29:00:00 --mem=0 --job-name=p{ExapOrder}-m{ExaMeshSize}-ConvergenceStudies-Euler"
