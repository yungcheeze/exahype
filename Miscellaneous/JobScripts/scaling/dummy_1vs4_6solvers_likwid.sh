...
export SCHEDULER_SCRIPT=./scheduler_submit_job_likwid.sh
# relative from project dir
export SCHEDULER_EXECUTABLE=./ExaHyPE-Euler2d-TBB-6
export SCHEDULER_EXECUTABLE_SERIAL=./ExaHyPE-Euler2d-None-6
export SCHEDULER_OUTPUT_DIR=${SCHEDULER_PROJECT_DIR}/scaling

export SCHEDULER_RUNS=2

export SCHEDULER_OUTPUT_PREFIX=1tr_dummy_6_likwid
...
export SCHEDULER_OUTPUT_PREFIX=4tr_dummy_6_likwid
