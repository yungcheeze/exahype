MODULE typesDef
  ...
  !
  INTEGER, PARAMETER :: N = ORDER__                               ! Polynomial degree of our approximation in space and time 
  ...
  INTEGER, PARAMETER :: nVar = NVAR__                            ! The number of variables of the PDE system 
  !
