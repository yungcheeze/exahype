#ifndef __ADERDG_CLASS_HEADER__
#define __ADERDG_CLASS_HEADER__
...
class Euler::ADERDG: public exahype::solvers::ADERDGSolver {
  public:
    ...
    ADERDG(double maximumMeshSize,exahype::solvers::Solver::TimeStepping timeStepping,std::vector<std::string>& cmdlineargs);
