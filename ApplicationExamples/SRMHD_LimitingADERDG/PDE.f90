...
SUBROUTINE PDEBoundaryValues(x,t,dt,faceIndex,nv,fluxIn,stateIn,fluxOut,stateOut)
  ...
  ! Or call some function to determine BC
  CALL MHDJetBC(x,t,dt,faceIndex,nv,fluxIn,stateIn,fluxOut,stateOut)

END SUBROUTINE PDEBoundaryValues

SUBROUTINE MHDJetBC(x,t,dt,faceIndex,nv,fluxIn,stateIn,fluxOut,stateOut)
