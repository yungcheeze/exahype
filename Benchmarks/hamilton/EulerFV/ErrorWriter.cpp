...
EulerFV::ErrorWriter::ErrorWriter() : exahype::plotters::FiniteVolumes2UserDefined::FiniteVolumes2UserDefined(){
  // @TODO Please insert your code here.
}


void EulerFV::ErrorWriter::plotPatch(
...
void EulerFV::ErrorWriter::startPlotting( double time) {
  _timeStamp = time;
...
void EulerFV::ErrorWriter::finishPlotting() {
  constexpr int numberOfVariables = AbstractEulerSolver::NumberOfVariables;
