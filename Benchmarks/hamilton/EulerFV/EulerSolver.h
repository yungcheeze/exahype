...
class EulerFV::EulerSolver : public EulerFV::AbstractEulerSolver {
  private:
    /**
     * Log device
     */
  ...
  public:
    EulerSolver(double maximumMeshSize,int maximumAdaptiveMeshDepth,exahype::solvers::Solver::TimeStepping timeStepping,std::vector<std::string>& cmdlineargs);
    ...
    static void sodShockTube(const double* const x, const double t, double* Q);
