...
class Euler::AbstractEulerSolver_FV : public exahype::solvers::FiniteVolumesSolver {
  public:
    ...
    static constexpr int PatchSize          = 15;
    ...
    AbstractEulerSolver_FV(double maximumMeshSize,int maximumAdaptiveMeshDepth,exahype::solvers::Solver::TimeStepping timeStepping);
