#ifndef __AbstractEulerSolver_CLASS_HEADER__
#define __AbstractEulerSolver_CLASS_HEADER__
...
namespace Euler{
  class EulerSolver;
  class AbstractEulerSolver;
}

class Euler::AbstractEulerSolver: public exahype::solvers::ADERDGSolver {
  public:
    ...
    AbstractEulerSolver(double maximumMeshSize,int maximumAdaptiveMeshDepth,int DMPObservables,exahype::solvers::Solver::TimeStepping timeStepping);
