 ...
 **/
class Euler::AbstractEulerSolver_FV::VariableShortcuts {
public:
 ...
 *
 **/
class Euler::AbstractEulerSolver_FV::VariableNames {
public:
...
class Euler::AbstractEulerSolver_FV::ReadOnlyVariables {
  private:
...
class Euler::AbstractEulerSolver_FV::Variables {
  private:
    double* _Q;
  public:
    static constexpr int SizeVariables  = 5;
...
class Euler::AbstractEulerSolver_FV::Fluxes {
  private:
    double** _F;
  public:
    static constexpr int SizeVariables = 5; 
