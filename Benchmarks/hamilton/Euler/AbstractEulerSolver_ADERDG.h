#ifndef __AbstractEulerSolver_ADERDG_CLASS_HEADER__
#define __AbstractEulerSolver_ADERDG_CLASS_HEADER__
...
namespace Euler{
  ...
  class AbstractEulerSolver_ADERDG;
}

class Euler::AbstractEulerSolver_ADERDG: public exahype::solvers::ADERDGSolver {
  public:
    ...
    AbstractEulerSolver_ADERDG(double maximumMeshSize,int maximumAdaptiveMeshDepth,int DMPObservables,exahype::solvers::Solver::TimeStepping timeStepping);
