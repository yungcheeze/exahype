...
// =============================---==============
#ifndef __EulerSolver_ADERDG_Variables_CLASS_HEADER__
#define __EulerSolver_ADERDG_Variables_CLASS_HEADER__
 ...
 **/
class Euler::AbstractEulerSolver_ADERDG::VariableShortcuts {
public:
 ...
 *
 **/
class Euler::AbstractEulerSolver_ADERDG::VariableNames {
public:
...
class Euler::AbstractEulerSolver_ADERDG::ReadOnlyVariables {
  private:
...
class Euler::AbstractEulerSolver_ADERDG::Variables {
  private:
    double* _Q;
  public:
    static constexpr int SizeVariables  = 5;
...
class Euler::AbstractEulerSolver_ADERDG::Fluxes {
  private:
    double** _F;
  public:
    static constexpr int SizeVariables = 5; 
