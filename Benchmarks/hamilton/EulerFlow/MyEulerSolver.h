...
class Euler::MyEulerSolver: public Euler::AbstractMyEulerSolver {
  private:
    ...
    void (*initialConditions)(const double* const x,double t, double* Q);
  public:
    MyEulerSolver(double maximumMeshSize,int maximumAdaptiveMeshDepth,int DMPObservables,exahype::solvers::Solver::TimeStepping timeStepping,std::vector<std::string>& cmdlineargs);
