...
public class GenerateSolverRegistration extends DepthFirstAdapter {
  ...
  public void writeVersionInfo(String singleline) {
      _versionBodyWriter.write("\n\t   << \""+singleline+"\\n\"");
  }

  public void writeVersionInfo(String key, Object value) {
  ...
  public void inAProject(AProject node) {
    ...
    try {
      ...
      writeVersionInfo("Project.name", _projectName);
      ...
      if(_useOptimisedKernels) {
        ...
        writeVersionInfo("OptimisedKernels.generated", "Yes");
      } else {
        writeVersionInfo("OptimisedKernels.generated", "Yes");
      }
  ...
  public void inAFiniteVolumesSolver(eu.exahype.node.AFiniteVolumesSolver node) {
    try {
      ...
      writeVersionInfo("Kernel["+_kernelNumber+"].type", "FiniteVolumesSolver");
      writeVersionInfo("Kernel["+_kernelNumber+"].name", _projectName + "::" + _solverName);
      writeVersionInfo("Kernel["+_kernelNumber+"].hasConstants", node.getConstants());
      writeVersionInfo("Kernel["+_kernelNumber+"].patchSize", patchSize);
  ...
  public void inAPlotSolution(eu.exahype.node.APlotSolution node) {
    try {
      ...
      if (_inALimitingADERDGSolver) {
        ...
        writeVersionInfo("Plotter["+_plotterNumber+"].kernelType", "LimitingADERDGSolver");
      } else {
        _methodBodyWriter.write(
            "  exahype::plotters::RegisteredPlotters.push_back( new exahype::plotters::Plotter("
        ...
        writeVersionInfo("Plotter["+_plotterNumber+"].kernelType", _projectName + "::" + _solverName);
      }
      _plotterNumber++;
  ...
  public void outAProject(AProject node) {    
    try {
      ...
      _writer.write("\tss << \"Generated SolverRegistration code by toolkit:\\n\"");
