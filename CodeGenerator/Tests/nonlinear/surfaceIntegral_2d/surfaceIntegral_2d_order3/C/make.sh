...
icpc -c -std=c++11 -O3 -DALIGNMENT=32 -xHost -restrict sources/surfaceIntegral.cpp
icpc -c -std=c++11 -O3 -DALIGNMENT=32 -xHost -restrict main.cpp
icpc -std=c++11  -O3 -DALIGNMENT=32 -xHost -restrict DGMatrices.o GaussLegendreQuadrature.o surfaceIntegral.o main.o -o $MAIN
echo "Done"
