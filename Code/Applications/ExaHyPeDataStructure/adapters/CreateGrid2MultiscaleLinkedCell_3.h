...
#ifndef EXAHYPE_ADAPTERS_CreateGrid2MultiscaleLinkedCell_3_H_
#define EXAHYPE_ADAPTERS_CreateGrid2MultiscaleLinkedCell_3_H_
...
namespace exahype {
      namespace adapters {
        class CreateGrid2MultiscaleLinkedCell_3;
      } 
}
 ...
 */
class exahype::adapters::CreateGrid2MultiscaleLinkedCell_3 {
  public:
    ...
    CreateGrid2MultiscaleLinkedCell_3();

    #if defined(SharedMemoryParallelisation)
    CreateGrid2MultiscaleLinkedCell_3(const CreateGrid2MultiscaleLinkedCell_3& masterThread);
    #endif

    virtual ~CreateGrid2MultiscaleLinkedCell_3();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const CreateGrid2MultiscaleLinkedCell_3& workerThread);
    #endif
