...
#include "ExaHyPeDataStructure/State.h"
 ...
 #include "ExaHyPeDataStructure/mappings/InitCellData.h"
...
class exahype::adapters::CreateGrid {
  private:
    ...
    typedef mappings::InitCellData Mapping2;
    typedef adapters::CreateGrid2MultiscaleLinkedCell_3 Mapping3;

     Mapping0  _map2CreateGrid;
     Mapping1  _map2InitCells;
     Mapping2  _map2InitCellData;
     Mapping3  _map2CreateGrid2MultiscaleLinkedCell_3;
