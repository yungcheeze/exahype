...
#ifndef EXAHYPE_MAPPINGS_UpdateCellData_H_
#define EXAHYPE_MAPPINGS_UpdateCellData_H_
 ...
 */
class exahype::mappings::UpdateCellData {
  private:
    /**
  ...
  public:
     ...
     */
    UpdateCellData(const UpdateCellData& masterThread);
    #endif

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~UpdateCellData();
     ...
     */   
    void mergeWithWorkerThread(const UpdateCellData& workerThread);
    #endif
