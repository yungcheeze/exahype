...
elasticwaves3d::MyElasticSolver::MyElasticSolver( int kernelNumber, std::unique_ptr<exahype::profilers::Profiler> profiler):
  exahype::solvers::Solver("MyElasticSolver",exahype::solvers::Solver::ADER_DG,kernelNumber,9,3+1,exahype::solvers::Solver::GlobalTimeStepping, std::move(profiler)) {
