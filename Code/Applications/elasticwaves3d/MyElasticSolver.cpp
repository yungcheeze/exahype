...
elasticwaves3d::MyElasticSolver::MyElasticSolver(int kernelNumber, double maximumMeshSize, exahype::solvers::Solver::TimeStepping timeStepping, std::unique_ptr<exahype::profilers::Profiler> profiler)
  : exahype::solvers::Solver(
            "MyElasticSolver", exahype::solvers::Solver::Type::ADER_DG, kernelNumber, 9, 0, 3+1, maximumMeshSize, timeStepping, std::move(profiler)) {
