...
elasticwaves3d::MyElasticSolver::MyElasticSolver(int kernelNumber, int nodesPerCoordinateAxis, double maximumMeshSize, exahype::solvers::Solver::TimeStepping timeStepping, std::unique_ptr<exahype::profilers::Profiler> profiler)
  : exahype::solvers::Solver(
            "MyElasticSolver", exahype::solvers::Solver::Type::ADER_DG, kernelNumber, 9, 0, nodesPerCoordinateAxis, maximumMeshSize, timeStepping, std::move(profiler)) {
