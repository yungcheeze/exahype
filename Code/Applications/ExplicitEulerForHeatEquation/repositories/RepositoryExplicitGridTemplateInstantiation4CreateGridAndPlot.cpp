...
namespace peano {
  namespace grid {
    template class Grid<myproject::Vertex,myproject::Cell,myproject::State, peano::stacks::VertexArrayStack<myproject::Vertex> ,peano::stacks::CellArrayStack<myproject::Cell> ,myproject::adapters::CreateGridAndPlot>;
    template class Grid<myproject::Vertex,myproject::Cell,myproject::State, peano::stacks::VertexSTDStack<  myproject::Vertex> ,peano::stacks::CellSTDStack<  myproject::Cell> ,myproject::adapters::CreateGridAndPlot>;
  }
}
