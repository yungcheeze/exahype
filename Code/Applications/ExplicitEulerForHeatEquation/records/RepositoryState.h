#ifndef _MYPROJECT_RECORDS_REPOSITORYSTATE_H
#define _MYPROJECT_RECORDS_REPOSITORYSTATE_H
 ...
 */
class myproject::records::RepositoryState { 
   
   public:
      
      typedef myproject::records::RepositoryStatePacked Packed;
      
      enum Action {
         WriteCheckpoint = 0, ReadCheckpoint = 1, Terminate = 2, RunOnAllNodes = 3, UseAdapterCreateGrid = 4, UseAdapterTimeStep = 5, UseAdapterCreateGridAndPlot = 6, UseAdapterTimeStepAndPlot = 7, NumberOfAdapters = 8
      };
 ...
 #endif 
 {
    ...
    * @date   16/10/2015 14:23
    */
   class myproject::records::RepositoryStatePacked { 
      
      public:
         
         typedef myproject::records::RepositoryState::Action Action;
