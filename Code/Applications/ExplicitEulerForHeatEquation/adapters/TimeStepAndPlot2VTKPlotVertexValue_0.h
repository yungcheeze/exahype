...
#ifndef MYPROJECT_ADAPTERS_TimeStepAndPlot2VTKPlotVertexValue_0_H_
#define MYPROJECT_ADAPTERS_TimeStepAndPlot2VTKPlotVertexValue_0_H_
...
namespace myproject {
      namespace adapters {
        class TimeStepAndPlot2VTKPlotVertexValue_0;
      } 
}
 ...
 */
class myproject::adapters::TimeStepAndPlot2VTKPlotVertexValue_0 {
  private:
    /**
  ...
  public:
    ...
    TimeStepAndPlot2VTKPlotVertexValue_0();

    #if defined(SharedMemoryParallelisation)
    TimeStepAndPlot2VTKPlotVertexValue_0(const TimeStepAndPlot2VTKPlotVertexValue_0& masterThread);
    #endif

    virtual ~TimeStepAndPlot2VTKPlotVertexValue_0();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const TimeStepAndPlot2VTKPlotVertexValue_0& workerThread);
    #endif
