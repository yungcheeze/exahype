...
#ifndef MYPROJECT_ADAPTERS_CreateGridAndPlot2VTKPlotVertexValue_1_H_
#define MYPROJECT_ADAPTERS_CreateGridAndPlot2VTKPlotVertexValue_1_H_
...
namespace myproject {
      namespace adapters {
        class CreateGridAndPlot2VTKPlotVertexValue_1;
      } 
}
 ...
 * getU   getter for vertex value (without brackets)
 * u   Legend title
 *
 * @author Tobias Weinzierl
 * @version $Revision: 1.10 $
 */
class myproject::adapters::CreateGridAndPlot2VTKPlotVertexValue_1 {
  private:
    /**
  ...
  public:
    ...
    CreateGridAndPlot2VTKPlotVertexValue_1();

    #if defined(SharedMemoryParallelisation)
    CreateGridAndPlot2VTKPlotVertexValue_1(const CreateGridAndPlot2VTKPlotVertexValue_1& masterThread);
    #endif

    virtual ~CreateGridAndPlot2VTKPlotVertexValue_1();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const CreateGridAndPlot2VTKPlotVertexValue_1& workerThread);
    #endif
