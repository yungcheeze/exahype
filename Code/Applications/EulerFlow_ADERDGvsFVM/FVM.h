#ifndef __FVM_CLASS_HEADER__
#define __FVM_CLASS_HEADER__
...
class Euler::FVM : public exahype::solvers::FiniteVolumesSolver {
  public:
    FVM(int cellsPerCoordinateAxis,double maximumMeshSize,exahype::solvers::Solver::TimeStepping timeStepping);
