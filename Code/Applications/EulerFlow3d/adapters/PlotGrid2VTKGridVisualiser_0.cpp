#include "EulerFlow3d/adapters/PlotGrid2VTKGridVisualiser_0.h"
...
int exahype::adapters::PlotGrid2VTKGridVisualiser_0::_snapshotCounter = 0;



peano::CommunicationSpecification   exahype::adapters::PlotGrid2VTKGridVisualiser_0::communicationSpecification() {
  return peano::CommunicationSpecification::getPessimisticSpecification();
}


peano::MappingSpecification   exahype::adapters::PlotGrid2VTKGridVisualiser_0::touchVertexLastTimeSpecification() {
  return peano::MappingSpecification(peano::MappingSpecification::Nop,peano::MappingSpecification::RunConcurrentlyOnFineGrid);
}


peano::MappingSpecification   exahype::adapters::PlotGrid2VTKGridVisualiser_0::touchVertexFirstTimeSpecification() { 
  return peano::MappingSpecification(peano::MappingSpecification::WholeTree,peano::MappingSpecification::Serial);
}


peano::MappingSpecification   exahype::adapters::PlotGrid2VTKGridVisualiser_0::enterCellSpecification() {
  return peano::MappingSpecification(peano::MappingSpecification::Nop,peano::MappingSpecification::AvoidFineGridRaces);
}


peano::MappingSpecification   exahype::adapters::PlotGrid2VTKGridVisualiser_0::leaveCellSpecification() {
  return peano::MappingSpecification(peano::MappingSpecification::WholeTree,peano::MappingSpecification::Serial);
}


peano::MappingSpecification   exahype::adapters::PlotGrid2VTKGridVisualiser_0::ascendSpecification() {
  return peano::MappingSpecification(peano::MappingSpecification::Nop,peano::MappingSpecification::RunConcurrentlyOnFineGrid);
}


peano::MappingSpecification   exahype::adapters::PlotGrid2VTKGridVisualiser_0::descendSpecification() {
  return peano::MappingSpecification(peano::MappingSpecification::Nop,peano::MappingSpecification::RunConcurrentlyOnFineGrid);
}


std::map<tarch::la::Vector<DIMENSIONS,double> , int, tarch::la::VectorCompare<DIMENSIONS> >  exahype::adapters::PlotGrid2VTKGridVisualiser_0::_vertex2IndexMap;


exahype::adapters::PlotGrid2VTKGridVisualiser_0::PlotGrid2VTKGridVisualiser_0():
  _vtkWriter(0),
  _vertexWriter(0),
  _cellWriter(0),
  _vertexTypeWriter(0),
...
exahype::adapters::PlotGrid2VTKGridVisualiser_0::PlotGrid2VTKGridVisualiser_0(const PlotGrid2VTKGridVisualiser_0&  masterThread):
...
void exahype::adapters::PlotGrid2VTKGridVisualiser_0::mergeWithWorkerThread(const PlotGrid2VTKGridVisualiser_0& workerThread) {
}
#endif
...
void exahype::adapters::PlotGrid2VTKGridVisualiser_0::plotVertex(
...
void exahype::adapters::PlotGrid2VTKGridVisualiser_0::createHangingVertex(
...
void exahype::adapters::PlotGrid2VTKGridVisualiser_0::destroyHangingVertex(
      const exahype::Vertex&   fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      exahype::Vertex * const  coarseGridVertices,
...
void exahype::adapters::PlotGrid2VTKGridVisualiser_0::createInnerVertex(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::PlotGrid2VTKGridVisualiser_0::createBoundaryVertex(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::PlotGrid2VTKGridVisualiser_0::destroyVertex(
      const exahype::Vertex&   fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      exahype::Vertex * const  coarseGridVertices,
...
void exahype::adapters::PlotGrid2VTKGridVisualiser_0::createCell(
...
void exahype::adapters::PlotGrid2VTKGridVisualiser_0::destroyCell(
...
#ifdef Parallel
void exahype::adapters::PlotGrid2VTKGridVisualiser_0::mergeWithNeighbour(
...
void exahype::adapters::PlotGrid2VTKGridVisualiser_0::prepareSendToNeighbour(
      exahype::Vertex&  vertex,
      int                                           toRank,
...
void exahype::adapters::PlotGrid2VTKGridVisualiser_0::prepareCopyToRemoteNode(
...
void exahype::adapters::PlotGrid2VTKGridVisualiser_0::mergeWithRemoteDataDueToForkOrJoin(
  exahype::Vertex&  localVertex,
...
bool exahype::adapters::PlotGrid2VTKGridVisualiser_0::prepareSendToWorker(
  exahype::Cell&                 fineGridCell,
  exahype::Vertex * const        fineGridVertices,
  const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
  exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::PlotGrid2VTKGridVisualiser_0::prepareSendToMaster(
      exahype::Cell&                       localCell,
...
void exahype::adapters::PlotGrid2VTKGridVisualiser_0::mergeWithMaster(
...
void exahype::adapters::PlotGrid2VTKGridVisualiser_0::receiveDataFromMaster(
...
void exahype::adapters::PlotGrid2VTKGridVisualiser_0::mergeWithWorker(
      exahype::Cell&           localCell, 
...
void exahype::adapters::PlotGrid2VTKGridVisualiser_0::touchVertexFirstTime(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::PlotGrid2VTKGridVisualiser_0::touchVertexLastTime(
      exahype::Vertex&         fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      exahype::Vertex * const  coarseGridVertices,
...
void exahype::adapters::PlotGrid2VTKGridVisualiser_0::enterCell(
      exahype::Cell&                 fineGridCell,
      exahype::Vertex * const        fineGridVertices,
      const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::PlotGrid2VTKGridVisualiser_0::leaveCell(
      exahype::Cell&           fineGridCell,
      exahype::Vertex * const  fineGridVertices,
      const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
      exahype::Vertex * const  coarseGridVertices,
...
void exahype::adapters::PlotGrid2VTKGridVisualiser_0::beginIteration(
...
void exahype::adapters::PlotGrid2VTKGridVisualiser_0::endIteration(
  exahype::State&  solverState
) {
  _vertexWriter->close();
  _cellWriter->close();
...
void exahype::adapters::PlotGrid2VTKGridVisualiser_0::descend(
...
void exahype::adapters::PlotGrid2VTKGridVisualiser_0::ascend(
  exahype::Cell * const    fineGridCells,
  exahype::Vertex * const  fineGridVertices,
  const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
  exahype::Vertex * const  coarseGridVertices,
