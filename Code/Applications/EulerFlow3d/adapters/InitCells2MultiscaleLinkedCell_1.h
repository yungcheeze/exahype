...
#ifndef EXAHYPE_ADAPTERS_InitCells2MultiscaleLinkedCell_1_H_
#define EXAHYPE_ADAPTERS_InitCells2MultiscaleLinkedCell_1_H_
...
namespace exahype {
      namespace adapters {
        class InitCells2MultiscaleLinkedCell_1;
      } 
}
 ...
 */
class exahype::adapters::InitCells2MultiscaleLinkedCell_1 {
  public:
    ...
    InitCells2MultiscaleLinkedCell_1();

    #if defined(SharedMemoryParallelisation)
    InitCells2MultiscaleLinkedCell_1(const InitCells2MultiscaleLinkedCell_1& masterThread);
    #endif

    virtual ~InitCells2MultiscaleLinkedCell_1();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const InitCells2MultiscaleLinkedCell_1& workerThread);
    #endif
