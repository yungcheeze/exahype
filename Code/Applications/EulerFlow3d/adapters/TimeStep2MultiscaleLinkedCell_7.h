...
#ifndef EXAHYPE_ADAPTERS_TimeStep2MultiscaleLinkedCell_7_H_
#define EXAHYPE_ADAPTERS_TimeStep2MultiscaleLinkedCell_7_H_
...
namespace exahype {
      namespace adapters {
        class TimeStep2MultiscaleLinkedCell_7;
      } 
}
 ...
 */
class exahype::adapters::TimeStep2MultiscaleLinkedCell_7 {
  public:
    ...
    TimeStep2MultiscaleLinkedCell_7();

    #if defined(SharedMemoryParallelisation)
    TimeStep2MultiscaleLinkedCell_7(const TimeStep2MultiscaleLinkedCell_7& masterThread);
    #endif

    virtual ~TimeStep2MultiscaleLinkedCell_7();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const TimeStep2MultiscaleLinkedCell_7& workerThread);
    #endif
