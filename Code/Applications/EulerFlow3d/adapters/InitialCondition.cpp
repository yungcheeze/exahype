...
peano::CommunicationSpecification   exahype::adapters::InitialCondition::communicationSpecification() {
...
peano::MappingSpecification   exahype::adapters::InitialCondition::touchVertexLastTimeSpecification() {
...
peano::MappingSpecification   exahype::adapters::InitialCondition::touchVertexFirstTimeSpecification() { 
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::InitialCondition::enterCellSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::InitialCondition::leaveCellSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::InitialCondition::ascendSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::InitialCondition::descendSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
exahype::adapters::InitialCondition::InitialCondition() {
}
...
exahype::adapters::InitialCondition::InitialCondition(const InitialCondition&  masterThread):
...
void exahype::adapters::InitialCondition::mergeWithWorkerThread(const InitialCondition& workerThread) {
...
void exahype::adapters::InitialCondition::createHangingVertex(
...
void exahype::adapters::InitialCondition::destroyHangingVertex(
...
void exahype::adapters::InitialCondition::createInnerVertex(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::InitialCondition::createBoundaryVertex(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::InitialCondition::destroyVertex(
      const exahype::Vertex&   fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      exahype::Vertex * const  coarseGridVertices,
...
void exahype::adapters::InitialCondition::createCell(
...
void exahype::adapters::InitialCondition::destroyCell(
...
#ifdef Parallel
void exahype::adapters::InitialCondition::mergeWithNeighbour(
...
void exahype::adapters::InitialCondition::prepareSendToNeighbour(
  exahype::Vertex&  vertex,
  int                                           toRank,
...
void exahype::adapters::InitialCondition::prepareCopyToRemoteNode(
...
void exahype::adapters::InitialCondition::mergeWithRemoteDataDueToForkOrJoin(
  exahype::Vertex&  localVertex,
...
bool exahype::adapters::InitialCondition::prepareSendToWorker(
  exahype::Cell&                 fineGridCell,
  exahype::Vertex * const        fineGridVertices,
  const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
  exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::InitialCondition::prepareSendToMaster(
  exahype::Cell&                       localCell,
...
void exahype::adapters::InitialCondition::mergeWithMaster(
...
void exahype::adapters::InitialCondition::receiveDataFromMaster(
...
void exahype::adapters::InitialCondition::mergeWithWorker(
  exahype::Cell&           localCell, 
...
void exahype::adapters::InitialCondition::touchVertexFirstTime(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::InitialCondition::touchVertexLastTime(
      exahype::Vertex&         fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      exahype::Vertex * const  coarseGridVertices,
...
void exahype::adapters::InitialCondition::enterCell(
      exahype::Cell&                 fineGridCell,
      exahype::Vertex * const        fineGridVertices,
      const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::InitialCondition::leaveCell(
      exahype::Cell&           fineGridCell,
      exahype::Vertex * const  fineGridVertices,
      const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
      exahype::Vertex * const  coarseGridVertices,
...
void exahype::adapters::InitialCondition::beginIteration(
...
void exahype::adapters::InitialCondition::endIteration(
  exahype::State&  solverState
) {
...
void exahype::adapters::InitialCondition::descend(
...
void exahype::adapters::InitialCondition::ascend(
  exahype::Cell * const    fineGridCells,
  exahype::Vertex * const  fineGridVertices,
  const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
  exahype::Vertex * const  coarseGridVertices,
