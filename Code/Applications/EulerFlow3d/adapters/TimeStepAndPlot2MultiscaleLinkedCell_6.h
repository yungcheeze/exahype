...
#ifndef EXAHYPE_ADAPTERS_TimeStepAndPlot2MultiscaleLinkedCell_6_H_
#define EXAHYPE_ADAPTERS_TimeStepAndPlot2MultiscaleLinkedCell_6_H_
...
namespace exahype {
      namespace adapters {
        class TimeStepAndPlot2MultiscaleLinkedCell_6;
      } 
}
 ...
 */
class exahype::adapters::TimeStepAndPlot2MultiscaleLinkedCell_6 {
  public:
    ...
    TimeStepAndPlot2MultiscaleLinkedCell_6();

    #if defined(SharedMemoryParallelisation)
    TimeStepAndPlot2MultiscaleLinkedCell_6(const TimeStepAndPlot2MultiscaleLinkedCell_6& masterThread);
    #endif

    virtual ~TimeStepAndPlot2MultiscaleLinkedCell_6();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const TimeStepAndPlot2MultiscaleLinkedCell_6& workerThread);
    #endif
