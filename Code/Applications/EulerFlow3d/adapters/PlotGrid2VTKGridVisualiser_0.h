...
#ifndef EXAHYPE_ADAPTERS_PlotGrid2VTKGridVisualiser_0_H_
#define EXAHYPE_ADAPTERS_PlotGrid2VTKGridVisualiser_0_H_
...
namespace exahype {
      namespace adapters {
        class PlotGrid2VTKGridVisualiser_0;
      } 
}
 ...
 */
class exahype::adapters::PlotGrid2VTKGridVisualiser_0 {
  private:
    /**
  ...
  public:
    ...
    PlotGrid2VTKGridVisualiser_0();

    #if defined(SharedMemoryParallelisation)
    PlotGrid2VTKGridVisualiser_0(const PlotGrid2VTKGridVisualiser_0& masterThread);
    #endif

    virtual ~PlotGrid2VTKGridVisualiser_0();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const PlotGrid2VTKGridVisualiser_0& workerThread);
    #endif
