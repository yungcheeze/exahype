...
peano::CommunicationSpecification   exahype::adapters::CreateGrid::communicationSpecification() {
  return peano::CommunicationSpecification::getMinimalSpecification()
   ...
   & exahype::adapters::CreateGrid2MultiscaleLinkedCell_1::communicationSpecification()
...
peano::MappingSpecification   exahype::adapters::CreateGrid::touchVertexLastTimeSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
   ...
   & exahype::adapters::CreateGrid2MultiscaleLinkedCell_1::touchVertexLastTimeSpecification()
...
peano::MappingSpecification   exahype::adapters::CreateGrid::touchVertexFirstTimeSpecification() { 
  return peano::MappingSpecification::getMinimalSpecification()
   ...
   & exahype::adapters::CreateGrid2MultiscaleLinkedCell_1::touchVertexFirstTimeSpecification()
...
peano::MappingSpecification   exahype::adapters::CreateGrid::enterCellSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
   ...
   & exahype::adapters::CreateGrid2MultiscaleLinkedCell_1::enterCellSpecification()
...
peano::MappingSpecification   exahype::adapters::CreateGrid::leaveCellSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
   ...
   & exahype::adapters::CreateGrid2MultiscaleLinkedCell_1::leaveCellSpecification()
...
peano::MappingSpecification   exahype::adapters::CreateGrid::ascendSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
   ...
   & exahype::adapters::CreateGrid2MultiscaleLinkedCell_1::ascendSpecification()
...
peano::MappingSpecification   exahype::adapters::CreateGrid::descendSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
   ...
   & exahype::adapters::CreateGrid2MultiscaleLinkedCell_1::descendSpecification()
...
exahype::adapters::CreateGrid::CreateGrid(const CreateGrid&  masterThread):
  ...
  _map2CreateGrid2MultiscaleLinkedCell_1(masterThread._map2CreateGrid2MultiscaleLinkedCell_1) 
...
void exahype::adapters::CreateGrid::mergeWithWorkerThread(const CreateGrid& workerThread) {
  ...
  _map2CreateGrid2MultiscaleLinkedCell_1.mergeWithWorkerThread(workerThread._map2CreateGrid2MultiscaleLinkedCell_1);
...
void exahype::adapters::CreateGrid::createHangingVertex(
  ...
  _map2CreateGrid2MultiscaleLinkedCell_1.createHangingVertex(fineGridVertex, fineGridX, fineGridH, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfVertex );
...
void exahype::adapters::CreateGrid::destroyHangingVertex(
  ...
  _map2CreateGrid2MultiscaleLinkedCell_1.destroyHangingVertex(fineGridVertex, fineGridX, fineGridH, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfVertex );
...
void exahype::adapters::CreateGrid::createInnerVertex(
  ...
  _map2CreateGrid2MultiscaleLinkedCell_1.createInnerVertex(fineGridVertex, fineGridX, fineGridH, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfVertex );
...
void exahype::adapters::CreateGrid::createBoundaryVertex(
  ...
  _map2CreateGrid2MultiscaleLinkedCell_1.createBoundaryVertex( fineGridVertex, fineGridX, fineGridH, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfVertex );
...
void exahype::adapters::CreateGrid::destroyVertex(
  ...
  _map2CreateGrid2MultiscaleLinkedCell_1.destroyVertex( fineGridVertex, fineGridX, fineGridH, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfVertex );
...
void exahype::adapters::CreateGrid::createCell(
  ...
  _map2CreateGrid2MultiscaleLinkedCell_1.createCell( fineGridCell, fineGridVertices, fineGridVerticesEnumerator, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfCell );
...
void exahype::adapters::CreateGrid::destroyCell(
  ...
  _map2CreateGrid2MultiscaleLinkedCell_1.destroyCell( fineGridCell, fineGridVertices, fineGridVerticesEnumerator, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfCell );
...
void exahype::adapters::CreateGrid::mergeWithNeighbour(
  ...
  int                                           level
   ...
   _map2CreateGrid2MultiscaleLinkedCell_1.mergeWithNeighbour( vertex, neighbour, fromRank, fineGridX, fineGridH, level );
...
void exahype::adapters::CreateGrid::prepareSendToNeighbour(
  ...
  int                                           level
   ...
   _map2CreateGrid2MultiscaleLinkedCell_1.prepareSendToNeighbour( vertex, toRank, x, h, level );
...
void exahype::adapters::CreateGrid::prepareCopyToRemoteNode(
  ...
  int                                           level
   ...
   _map2CreateGrid2MultiscaleLinkedCell_1.prepareCopyToRemoteNode( localVertex, toRank, x, h, level );
...
void exahype::adapters::CreateGrid::prepareCopyToRemoteNode(
  exahype::Cell&  localCell,
   ...
   _map2CreateGrid2MultiscaleLinkedCell_1.prepareCopyToRemoteNode( localCell, toRank, x, h, level );
...
void exahype::adapters::CreateGrid::mergeWithRemoteDataDueToForkOrJoin(
  ...
  int                                       level
   ...
   _map2CreateGrid2MultiscaleLinkedCell_1.mergeWithRemoteDataDueToForkOrJoin( localVertex, masterOrWorkerVertex, fromRank, x, h, level );
...
void exahype::adapters::CreateGrid::mergeWithRemoteDataDueToForkOrJoin(
  ...
  int                                       level
   ...
   _map2CreateGrid2MultiscaleLinkedCell_1.mergeWithRemoteDataDueToForkOrJoin( localCell, masterOrWorkerCell, fromRank, x, h, level );
...
bool exahype::adapters::CreateGrid::prepareSendToWorker(
  ...
  bool result = false;
   ...
   result |= _map2CreateGrid2MultiscaleLinkedCell_1.prepareSendToWorker( fineGridCell, fineGridVertices, fineGridVerticesEnumerator, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfCell, worker );
...
void exahype::adapters::CreateGrid::prepareSendToMaster(
  ...
  const tarch::la::Vector<DIMENSIONS,int>&   fineGridPositionOfCell
   ...
   _map2CreateGrid2MultiscaleLinkedCell_1.prepareSendToMaster( localCell, vertices, verticesEnumerator, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfCell );
...
void exahype::adapters::CreateGrid::mergeWithMaster(
  ...
  exahype::State&                masterState
   ...
   _map2CreateGrid2MultiscaleLinkedCell_1.mergeWithMaster( workerGridCell, workerGridVertices, workerEnumerator, fineGridCell, fineGridVertices, fineGridVerticesEnumerator, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfCell, worker, workerState, masterState );
...
void exahype::adapters::CreateGrid::receiveDataFromMaster(
   ...
   _map2CreateGrid2MultiscaleLinkedCell_1.receiveDataFromMaster( receivedCell, receivedVertices, receivedVerticesEnumerator, receivedCoarseGridVertices, receivedCoarseGridVerticesEnumerator, receivedCoarseGridCell, workersCoarseGridVertices, workersCoarseGridVerticesEnumerator, workersCoarseGridCell, fineGridPositionOfCell );
...
void exahype::adapters::CreateGrid::mergeWithWorker(
  ...
  int                                          level
   ...
   _map2CreateGrid2MultiscaleLinkedCell_1.mergeWithWorker( localCell, receivedMasterCell, cellCentre, cellSize, level );
...
void exahype::adapters::CreateGrid::mergeWithWorker(
  ...
  int                                           level
   ...
   _map2CreateGrid2MultiscaleLinkedCell_1.mergeWithWorker( localVertex, receivedMasterVertex, x, h, level );
...
void exahype::adapters::CreateGrid::touchVertexFirstTime(
  ...
  _map2CreateGrid2MultiscaleLinkedCell_1.touchVertexFirstTime( fineGridVertex, fineGridX, fineGridH, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfVertex );
...
void exahype::adapters::CreateGrid::touchVertexLastTime(
  ...
  _map2CreateGrid2MultiscaleLinkedCell_1.touchVertexLastTime( fineGridVertex, fineGridX, fineGridH, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfVertex );
...
void exahype::adapters::CreateGrid::enterCell(
  ...
  _map2CreateGrid2MultiscaleLinkedCell_1.enterCell( fineGridCell, fineGridVertices, fineGridVerticesEnumerator, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfCell );
...
void exahype::adapters::CreateGrid::leaveCell(
  ...
  _map2CreateGrid2MultiscaleLinkedCell_1.leaveCell( fineGridCell, fineGridVertices, fineGridVerticesEnumerator, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfCell );
...
void exahype::adapters::CreateGrid::beginIteration(
  ...
  _map2CreateGrid2MultiscaleLinkedCell_1.beginIteration( solverState );
...
void exahype::adapters::CreateGrid::endIteration(
  ...
  _map2CreateGrid2MultiscaleLinkedCell_1.endIteration( solverState );
...
void exahype::adapters::CreateGrid::descend(
  ...
  _map2CreateGrid2MultiscaleLinkedCell_1.descend( fineGridCells, fineGridVertices, fineGridVerticesEnumerator, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell );
...
void exahype::adapters::CreateGrid::ascend(
  ...
  _map2CreateGrid2MultiscaleLinkedCell_1.ascend( fineGridCells, fineGridVertices, fineGridVerticesEnumerator, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell );
