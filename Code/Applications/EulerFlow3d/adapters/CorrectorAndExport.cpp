...
exahype::adapters::CorrectorAndExport::CorrectorAndExport() {
}
...
void exahype::adapters::CorrectorAndExport::createHangingVertex(
...
void exahype::adapters::CorrectorAndExport::destroyHangingVertex(
...
void exahype::adapters::CorrectorAndExport::createInnerVertex(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::CorrectorAndExport::createBoundaryVertex(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::CorrectorAndExport::destroyVertex(
      const exahype::Vertex&   fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      exahype::Vertex * const  coarseGridVertices,
...
void exahype::adapters::CorrectorAndExport::createCell(
...
void exahype::adapters::CorrectorAndExport::destroyCell(
...
#ifdef Parallel
void exahype::adapters::CorrectorAndExport::mergeWithNeighbour(
...
void exahype::adapters::CorrectorAndExport::prepareSendToNeighbour(
  exahype::Vertex&  vertex,
  int                                           toRank,
...
void exahype::adapters::CorrectorAndExport::prepareCopyToRemoteNode(
...
void exahype::adapters::CorrectorAndExport::mergeWithRemoteDataDueToForkOrJoin(
  exahype::Vertex&  localVertex,
...
bool exahype::adapters::CorrectorAndExport::prepareSendToWorker(
  exahype::Cell&                 fineGridCell,
  exahype::Vertex * const        fineGridVertices,
  const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
  exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::CorrectorAndExport::prepareSendToMaster(
  exahype::Cell&                       localCell,
...
void exahype::adapters::CorrectorAndExport::mergeWithMaster(
...
void exahype::adapters::CorrectorAndExport::receiveDataFromMaster(
...
void exahype::adapters::CorrectorAndExport::mergeWithWorker(
  exahype::Cell&           localCell, 
...
void exahype::adapters::CorrectorAndExport::touchVertexFirstTime(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::CorrectorAndExport::touchVertexLastTime(
      exahype::Vertex&         fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      exahype::Vertex * const  coarseGridVertices,
...
void exahype::adapters::CorrectorAndExport::enterCell(
      exahype::Cell&                 fineGridCell,
      exahype::Vertex * const        fineGridVertices,
      const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::CorrectorAndExport::leaveCell(
      exahype::Cell&           fineGridCell,
      exahype::Vertex * const  fineGridVertices,
      const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
      exahype::Vertex * const  coarseGridVertices,
...
void exahype::adapters::CorrectorAndExport::descend(
...
void exahype::adapters::CorrectorAndExport::ascend(
  exahype::Cell * const    fineGridCells,
  exahype::Vertex * const  fineGridVertices,
  const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
  exahype::Vertex * const  coarseGridVertices,
