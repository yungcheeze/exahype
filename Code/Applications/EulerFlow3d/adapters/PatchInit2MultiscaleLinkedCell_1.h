...
#ifndef EXAHYPE_ADAPTERS_PatchInit2MultiscaleLinkedCell_1_H_
#define EXAHYPE_ADAPTERS_PatchInit2MultiscaleLinkedCell_1_H_
...
namespace exahype {
      namespace adapters {
        class PatchInit2MultiscaleLinkedCell_1;
      } 
}
 ...
 */
class exahype::adapters::PatchInit2MultiscaleLinkedCell_1 {
  public:
    ...
    PatchInit2MultiscaleLinkedCell_1();

    #if defined(SharedMemoryParallelisation)
    PatchInit2MultiscaleLinkedCell_1(const PatchInit2MultiscaleLinkedCell_1& masterThread);
    #endif

    virtual ~PatchInit2MultiscaleLinkedCell_1();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const PatchInit2MultiscaleLinkedCell_1& workerThread);
    #endif
