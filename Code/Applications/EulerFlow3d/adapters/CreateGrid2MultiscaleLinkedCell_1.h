...
#ifndef EXAHYPE_ADAPTERS_CreateGrid2MultiscaleLinkedCell_1_H_
#define EXAHYPE_ADAPTERS_CreateGrid2MultiscaleLinkedCell_1_H_
...
namespace exahype {
      namespace adapters {
        class CreateGrid2MultiscaleLinkedCell_1;
      } 
}
 ...
 */
class exahype::adapters::CreateGrid2MultiscaleLinkedCell_1 {
  public:
    ...
    CreateGrid2MultiscaleLinkedCell_1();

    #if defined(SharedMemoryParallelisation)
    CreateGrid2MultiscaleLinkedCell_1(const CreateGrid2MultiscaleLinkedCell_1& masterThread);
    #endif

    virtual ~CreateGrid2MultiscaleLinkedCell_1();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const CreateGrid2MultiscaleLinkedCell_1& workerThread);
    #endif
