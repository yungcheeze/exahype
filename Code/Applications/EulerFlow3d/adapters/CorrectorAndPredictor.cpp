...
peano::CommunicationSpecification   exahype::adapters::CorrectorAndPredictor::communicationSpecification() {
...
peano::MappingSpecification   exahype::adapters::CorrectorAndPredictor::touchVertexLastTimeSpecification() {
...
peano::MappingSpecification   exahype::adapters::CorrectorAndPredictor::touchVertexFirstTimeSpecification() { 
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::CorrectorAndPredictor::enterCellSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::CorrectorAndPredictor::leaveCellSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::CorrectorAndPredictor::ascendSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::CorrectorAndPredictor::descendSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
exahype::adapters::CorrectorAndPredictor::CorrectorAndPredictor() {
}
...
exahype::adapters::CorrectorAndPredictor::CorrectorAndPredictor(const CorrectorAndPredictor&  masterThread):
...
void exahype::adapters::CorrectorAndPredictor::mergeWithWorkerThread(const CorrectorAndPredictor& workerThread) {
...
void exahype::adapters::CorrectorAndPredictor::createHangingVertex(
...
void exahype::adapters::CorrectorAndPredictor::destroyHangingVertex(
...
void exahype::adapters::CorrectorAndPredictor::createInnerVertex(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::CorrectorAndPredictor::createBoundaryVertex(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::CorrectorAndPredictor::destroyVertex(
      const exahype::Vertex&   fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      exahype::Vertex * const  coarseGridVertices,
...
void exahype::adapters::CorrectorAndPredictor::createCell(
...
void exahype::adapters::CorrectorAndPredictor::destroyCell(
...
#ifdef Parallel
void exahype::adapters::CorrectorAndPredictor::mergeWithNeighbour(
...
void exahype::adapters::CorrectorAndPredictor::prepareSendToNeighbour(
  exahype::Vertex&  vertex,
  int                                           toRank,
...
void exahype::adapters::CorrectorAndPredictor::prepareCopyToRemoteNode(
...
void exahype::adapters::CorrectorAndPredictor::mergeWithRemoteDataDueToForkOrJoin(
  exahype::Vertex&  localVertex,
...
bool exahype::adapters::CorrectorAndPredictor::prepareSendToWorker(
  exahype::Cell&                 fineGridCell,
  exahype::Vertex * const        fineGridVertices,
  const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
  exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::CorrectorAndPredictor::prepareSendToMaster(
  exahype::Cell&                       localCell,
...
void exahype::adapters::CorrectorAndPredictor::mergeWithMaster(
...
void exahype::adapters::CorrectorAndPredictor::receiveDataFromMaster(
...
void exahype::adapters::CorrectorAndPredictor::mergeWithWorker(
  exahype::Cell&           localCell, 
...
void exahype::adapters::CorrectorAndPredictor::touchVertexFirstTime(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::CorrectorAndPredictor::touchVertexLastTime(
      exahype::Vertex&         fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      exahype::Vertex * const  coarseGridVertices,
...
void exahype::adapters::CorrectorAndPredictor::enterCell(
      exahype::Cell&                 fineGridCell,
      exahype::Vertex * const        fineGridVertices,
      const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::CorrectorAndPredictor::leaveCell(
      exahype::Cell&           fineGridCell,
      exahype::Vertex * const  fineGridVertices,
      const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
      exahype::Vertex * const  coarseGridVertices,
...
void exahype::adapters::CorrectorAndPredictor::beginIteration(
...
void exahype::adapters::CorrectorAndPredictor::endIteration(
  exahype::State&  solverState
) {
...
void exahype::adapters::CorrectorAndPredictor::descend(
...
void exahype::adapters::CorrectorAndPredictor::ascend(
  exahype::Cell * const    fineGridCells,
  exahype::Vertex * const  fineGridVertices,
  const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
  exahype::Vertex * const  coarseGridVertices,
