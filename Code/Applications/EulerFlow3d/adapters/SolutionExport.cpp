...
peano::CommunicationSpecification   exahype::adapters::SolutionExport::communicationSpecification() {
...
peano::MappingSpecification   exahype::adapters::SolutionExport::touchVertexLastTimeSpecification() {
...
peano::MappingSpecification   exahype::adapters::SolutionExport::touchVertexFirstTimeSpecification() { 
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::SolutionExport::enterCellSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::SolutionExport::leaveCellSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::SolutionExport::ascendSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::SolutionExport::descendSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
exahype::adapters::SolutionExport::SolutionExport() {
}
...
exahype::adapters::SolutionExport::SolutionExport(const SolutionExport&  masterThread):
...
void exahype::adapters::SolutionExport::mergeWithWorkerThread(const SolutionExport& workerThread) {
...
void exahype::adapters::SolutionExport::createHangingVertex(
...
void exahype::adapters::SolutionExport::destroyHangingVertex(
...
void exahype::adapters::SolutionExport::createInnerVertex(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::SolutionExport::createBoundaryVertex(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::SolutionExport::destroyVertex(
      const exahype::Vertex&   fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      exahype::Vertex * const  coarseGridVertices,
...
void exahype::adapters::SolutionExport::createCell(
...
void exahype::adapters::SolutionExport::destroyCell(
...
#ifdef Parallel
void exahype::adapters::SolutionExport::mergeWithNeighbour(
...
void exahype::adapters::SolutionExport::prepareSendToNeighbour(
  exahype::Vertex&  vertex,
  int                                           toRank,
...
void exahype::adapters::SolutionExport::prepareCopyToRemoteNode(
...
void exahype::adapters::SolutionExport::mergeWithRemoteDataDueToForkOrJoin(
  exahype::Vertex&  localVertex,
...
bool exahype::adapters::SolutionExport::prepareSendToWorker(
  exahype::Cell&                 fineGridCell,
  exahype::Vertex * const        fineGridVertices,
  const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
  exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::SolutionExport::prepareSendToMaster(
  exahype::Cell&                       localCell,
...
void exahype::adapters::SolutionExport::mergeWithMaster(
...
void exahype::adapters::SolutionExport::receiveDataFromMaster(
...
void exahype::adapters::SolutionExport::mergeWithWorker(
  exahype::Cell&           localCell, 
...
void exahype::adapters::SolutionExport::touchVertexFirstTime(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::SolutionExport::touchVertexLastTime(
      exahype::Vertex&         fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      exahype::Vertex * const  coarseGridVertices,
...
void exahype::adapters::SolutionExport::enterCell(
      exahype::Cell&                 fineGridCell,
      exahype::Vertex * const        fineGridVertices,
      const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::SolutionExport::leaveCell(
      exahype::Cell&           fineGridCell,
      exahype::Vertex * const  fineGridVertices,
      const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
      exahype::Vertex * const  coarseGridVertices,
...
void exahype::adapters::SolutionExport::beginIteration(
...
void exahype::adapters::SolutionExport::endIteration(
  exahype::State&  solverState
) {
...
void exahype::adapters::SolutionExport::descend(
...
void exahype::adapters::SolutionExport::ascend(
  exahype::Cell * const    fineGridCells,
  exahype::Vertex * const  fineGridVertices,
  const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
  exahype::Vertex * const  coarseGridVertices,
