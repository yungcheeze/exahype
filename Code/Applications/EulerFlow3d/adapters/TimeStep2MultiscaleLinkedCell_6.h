...
#ifndef EXAHYPE_ADAPTERS_TimeStep2MultiscaleLinkedCell_6_H_
#define EXAHYPE_ADAPTERS_TimeStep2MultiscaleLinkedCell_6_H_
...
namespace exahype {
      namespace adapters {
        class TimeStep2MultiscaleLinkedCell_6;
      } 
}
 ...
 */
class exahype::adapters::TimeStep2MultiscaleLinkedCell_6 {
  public:
    ...
    TimeStep2MultiscaleLinkedCell_6();

    #if defined(SharedMemoryParallelisation)
    TimeStep2MultiscaleLinkedCell_6(const TimeStep2MultiscaleLinkedCell_6& masterThread);
    #endif

    virtual ~TimeStep2MultiscaleLinkedCell_6();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const TimeStep2MultiscaleLinkedCell_6& workerThread);
    #endif
