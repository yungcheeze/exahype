...
#ifndef EXAHYPE_ADAPTERS_TimeStep2MultiscaleLinkedCell_5_H_
#define EXAHYPE_ADAPTERS_TimeStep2MultiscaleLinkedCell_5_H_
...
namespace exahype {
      namespace adapters {
        class TimeStep2MultiscaleLinkedCell_5;
      } 
}
 ...
 */
class exahype::adapters::TimeStep2MultiscaleLinkedCell_5 {
  public:
    ...
    TimeStep2MultiscaleLinkedCell_5();

    #if defined(SharedMemoryParallelisation)
    TimeStep2MultiscaleLinkedCell_5(const TimeStep2MultiscaleLinkedCell_5& masterThread);
    #endif

    virtual ~TimeStep2MultiscaleLinkedCell_5();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const TimeStep2MultiscaleLinkedCell_5& workerThread);
    #endif
