#include "EulerFlow3d/adapters/PredictorAndGlobalTimeStepComputation.h"


peano::CommunicationSpecification   exahype::adapters::PredictorAndGlobalTimeStepComputation::communicationSpecification() {
...
peano::MappingSpecification   exahype::adapters::PredictorAndGlobalTimeStepComputation::touchVertexLastTimeSpecification() {
...
peano::MappingSpecification   exahype::adapters::PredictorAndGlobalTimeStepComputation::touchVertexFirstTimeSpecification() { 
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::PredictorAndGlobalTimeStepComputation::enterCellSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::PredictorAndGlobalTimeStepComputation::leaveCellSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::PredictorAndGlobalTimeStepComputation::ascendSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::PredictorAndGlobalTimeStepComputation::descendSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
exahype::adapters::PredictorAndGlobalTimeStepComputation::PredictorAndGlobalTimeStepComputation() {
}
...
exahype::adapters::PredictorAndGlobalTimeStepComputation::PredictorAndGlobalTimeStepComputation(const PredictorAndGlobalTimeStepComputation&  masterThread):
...
void exahype::adapters::PredictorAndGlobalTimeStepComputation::mergeWithWorkerThread(const PredictorAndGlobalTimeStepComputation& workerThread) {
...
void exahype::adapters::PredictorAndGlobalTimeStepComputation::createHangingVertex(
...
void exahype::adapters::PredictorAndGlobalTimeStepComputation::destroyHangingVertex(
...
void exahype::adapters::PredictorAndGlobalTimeStepComputation::createInnerVertex(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::PredictorAndGlobalTimeStepComputation::createBoundaryVertex(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
#ifdef Parallel
void exahype::adapters::PredictorAndGlobalTimeStepComputation::mergeWithNeighbour(
...
void exahype::adapters::PredictorAndGlobalTimeStepComputation::prepareSendToNeighbour(
  exahype::Vertex&  vertex,
  int                                           toRank,
...
void exahype::adapters::PredictorAndGlobalTimeStepComputation::prepareCopyToRemoteNode(
...
void exahype::adapters::PredictorAndGlobalTimeStepComputation::mergeWithRemoteDataDueToForkOrJoin(
  exahype::Vertex&  localVertex,
...
bool exahype::adapters::PredictorAndGlobalTimeStepComputation::prepareSendToWorker(
  exahype::Cell&                 fineGridCell,
  exahype::Vertex * const        fineGridVertices,
  const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
  exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::PredictorAndGlobalTimeStepComputation::prepareSendToMaster(
  exahype::Cell&                       localCell,
...
void exahype::adapters::PredictorAndGlobalTimeStepComputation::receiveDataFromMaster(
...
void exahype::adapters::PredictorAndGlobalTimeStepComputation::touchVertexFirstTime(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::PredictorAndGlobalTimeStepComputation::touchVertexLastTime(
      exahype::Vertex&         fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      exahype::Vertex * const  coarseGridVertices,
