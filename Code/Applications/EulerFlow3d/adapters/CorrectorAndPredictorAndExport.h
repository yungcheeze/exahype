...
#ifndef EXAHYPE_ADAPTERS_CorrectorAndPredictorAndExport_H_
#define EXAHYPE_ADAPTERS_CorrectorAndPredictorAndExport_H_
...
namespace exahype {
      namespace adapters {
        class CorrectorAndPredictorAndExport;
      } 
}
 ...
 */
class exahype::adapters::CorrectorAndPredictorAndExport {
  private:
  ...
  public:
    ...
    CorrectorAndPredictorAndExport();

    #if defined(SharedMemoryParallelisation)
    CorrectorAndPredictorAndExport(const CorrectorAndPredictorAndExport& masterThread);
    #endif

    virtual ~CorrectorAndPredictorAndExport();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const CorrectorAndPredictorAndExport& workerThread);
    #endif
