...
#ifndef EXAHYPE_MAPPINGS_VTKPlotCellData_H_
#define EXAHYPE_MAPPINGS_VTKPlotCellData_H_
 ...
 */
class exahype::mappings::VTKPlotCellData {
  private:
    /**
...
//    tarch::plotter::griddata::Writer::CellDataWriter*                               _cellValueWriter;
  ...
  public:
     ...
     */
    VTKPlotCellData(const VTKPlotCellData& masterThread);
    #endif

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~VTKPlotCellData();
     ...
     */   
    void mergeWithWorkerThread(const VTKPlotCellData& workerThread);
    #endif
