 ...
 */
peano::CommunicationSpecification   exahype::mappings::ApplyBoundaryConditions::communicationSpecification() {
 ...
 * @todo Please tailor the parameters to your mapping's properties.
 */
peano::MappingSpecification   exahype::mappings::ApplyBoundaryConditions::touchVertexLastTimeSpecification() {
 ...
 * @todo Please tailor the parameters to your mapping's properties.
 */
peano::MappingSpecification   exahype::mappings::ApplyBoundaryConditions::touchVertexFirstTimeSpecification() { 
  return peano::MappingSpecification(peano::MappingSpecification::WholeTree,peano::MappingSpecification::RunConcurrentlyOnFineGrid);
}
 ...
 * @todo Please tailor the parameters to your mapping's properties.
 */
peano::MappingSpecification   exahype::mappings::ApplyBoundaryConditions::enterCellSpecification() {
 ...
 * @todo Please tailor the parameters to your mapping's properties.
 */
peano::MappingSpecification   exahype::mappings::ApplyBoundaryConditions::leaveCellSpecification() {
  return peano::MappingSpecification(peano::MappingSpecification::WholeTree,peano::MappingSpecification::AvoidFineGridRaces);
}
 ...
 * @todo Please tailor the parameters to your mapping's properties.
 */
peano::MappingSpecification   exahype::mappings::ApplyBoundaryConditions::ascendSpecification() {
 ...
 * @todo Please tailor the parameters to your mapping's properties.
 */
peano::MappingSpecification   exahype::mappings::ApplyBoundaryConditions::descendSpecification() {
  return peano::MappingSpecification(peano::MappingSpecification::WholeTree,peano::MappingSpecification::AvoidCoarseGridRaces);
}


tarch::logging::Log                exahype::mappings::ApplyBoundaryConditions::_log( "exahype::mappings::ApplyBoundaryConditions" ); 


exahype::mappings::ApplyBoundaryConditions::ApplyBoundaryConditions() {
  logTraceIn( "ApplyBoundaryConditions()" );
  // do nothing
...
exahype::mappings::ApplyBoundaryConditions::ApplyBoundaryConditions(const ApplyBoundaryConditions&  masterThread) {
  logTraceIn( "ApplyBoundaryConditions(ApplyBoundaryConditions)" );
  // do nothing
  logTraceOut( "ApplyBoundaryConditions(ApplyBoundaryConditions)" );
}


void exahype::mappings::ApplyBoundaryConditions::mergeWithWorkerThread(const ApplyBoundaryConditions& workerThread) {
  logTraceIn( "mergeWithWorkerThread(ApplyBoundaryConditions)" );
  // do nothing
  logTraceOut( "mergeWithWorkerThread(ApplyBoundaryConditions)" );
}
#endif


void exahype::mappings::ApplyBoundaryConditions::createHangingVertex(
...
void exahype::mappings::ApplyBoundaryConditions::destroyHangingVertex(
...
void exahype::mappings::ApplyBoundaryConditions::createInnerVertex(
    exahype::Vertex&               fineGridVertex,
    const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
    const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
    exahype::Vertex * const        coarseGridVertices,
...
void exahype::mappings::ApplyBoundaryConditions::createBoundaryVertex(
    exahype::Vertex&               fineGridVertex,
    const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
    const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
    exahype::Vertex * const        coarseGridVertices,
...
void exahype::mappings::ApplyBoundaryConditions::destroyVertex(
    const exahype::Vertex&   fineGridVertex,
    const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
    const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
    exahype::Vertex * const  coarseGridVertices,
...
void exahype::mappings::ApplyBoundaryConditions::createCell(
...
void exahype::mappings::ApplyBoundaryConditions::destroyCell(
...
#ifdef Parallel
void exahype::mappings::ApplyBoundaryConditions::mergeWithNeighbour(
...
void exahype::mappings::ApplyBoundaryConditions::prepareSendToNeighbour(
    exahype::Vertex&  vertex,
    int                                           toRank,
...
void exahype::mappings::ApplyBoundaryConditions::prepareCopyToRemoteNode(
...
void exahype::mappings::ApplyBoundaryConditions::mergeWithRemoteDataDueToForkOrJoin(
    exahype::Vertex&  localVertex,
...
bool exahype::mappings::ApplyBoundaryConditions::prepareSendToWorker(
    exahype::Cell&                 fineGridCell,
    exahype::Vertex * const        fineGridVertices,
    const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
    exahype::Vertex * const        coarseGridVertices,
...
void exahype::mappings::ApplyBoundaryConditions::prepareSendToMaster(
    exahype::Cell&                       localCell,
...
void exahype::mappings::ApplyBoundaryConditions::mergeWithMaster(
...
void exahype::mappings::ApplyBoundaryConditions::receiveDataFromMaster(
...
void exahype::mappings::ApplyBoundaryConditions::mergeWithWorker(
    exahype::Cell&           localCell,
...
void exahype::mappings::ApplyBoundaryConditions::touchVertexFirstTime(
    exahype::Vertex&               fineGridVertex,
    const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
    const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
    exahype::Vertex * const        coarseGridVertices,
...
void exahype::mappings::ApplyBoundaryConditions::touchVertexLastTime(
    exahype::Vertex&         fineGridVertex,
    const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
    const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
    exahype::Vertex * const  coarseGridVertices,
...
void exahype::mappings::ApplyBoundaryConditions::enterCell(
    exahype::Cell&                 fineGridCell,
    exahype::Vertex * const        fineGridVertices,
    const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
    exahype::Vertex * const        coarseGridVertices,
...
void exahype::mappings::ApplyBoundaryConditions::leaveCell(
    exahype::Cell&           fineGridCell,
    exahype::Vertex * const  fineGridVertices,
    const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
    exahype::Vertex * const  coarseGridVertices,
...
void exahype::mappings::ApplyBoundaryConditions::beginIteration(
...
void exahype::mappings::ApplyBoundaryConditions::endIteration(
    exahype::State&  solverState
) {
...
void exahype::mappings::ApplyBoundaryConditions::descend(
...
void exahype::mappings::ApplyBoundaryConditions::ascend(
    exahype::Cell * const    fineGridCells,
    exahype::Vertex * const  fineGridVertices,
    const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
    exahype::Vertex * const  coarseGridVertices,
