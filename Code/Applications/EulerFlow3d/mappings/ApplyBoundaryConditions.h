...
#ifndef EXAHYPE_MAPPINGS_ApplyBoundaryConditions_H_
#define EXAHYPE_MAPPINGS_ApplyBoundaryConditions_H_
 ...
 */
class exahype::mappings::ApplyBoundaryConditions {
  private:
    /**
  ...
  public:
     ...
     */
    ApplyBoundaryConditions(const ApplyBoundaryConditions& masterThread);
    #endif

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~ApplyBoundaryConditions();
     ...
     */   
    void mergeWithWorkerThread(const ApplyBoundaryConditions& workerThread);
    #endif
