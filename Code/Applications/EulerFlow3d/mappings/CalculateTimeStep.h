...
#ifndef EXAHYPE_MAPPINGS_CalculateTimeStep_H_
#define EXAHYPE_MAPPINGS_CalculateTimeStep_H_
 ...
 */
class exahype::mappings::CalculateTimeStep {
  private:
    /**
  ...
  public:
     ...
     */
    CalculateTimeStep(const CalculateTimeStep& masterThread);
    #endif

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~CalculateTimeStep();
     ...
     */   
    void mergeWithWorkerThread(const CalculateTimeStep& workerThread);
    #endif
