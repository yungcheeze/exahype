 ...
 *elements.
 *
 *  -DEC: The functions should be modified such that they take vector arguments
 *and return vectors.
 */
///////////////////////////////////////////////////////////////////////////////
 ...
 */
inline void mapping2d(const double centerX, const double centerY,
                      const double dx, const double dy, const double dxPatch,
                      const double dyPatch, const int i, const int j,
                      const double r, const double s, double* x, double* y) {
