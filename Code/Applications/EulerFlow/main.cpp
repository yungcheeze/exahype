...
int main(int argc, char** argv) {
  ...
  //  tarch::logging::CommandLineLogger::getInstance().setLogFormat( ... please
  //  consult source code documentation );

  // Runs the unit tests
  tarch::tests::TestCaseRegistry::getInstance().getTestCaseCollection().run();
  programExitCode = tarch::tests::TestCaseRegistry::getInstance()
  ...
  //  programExitCode =
  //  tarch::tests::TestCaseRegistry::getInstance().getIntegrationTestCaseCollection().getNumberOfErrors();
  //}
