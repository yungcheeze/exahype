...
exahype::adapters::InitialConditionAndExportAndGlobalTimeStepComputation::
...
exahype::adapters::InitialConditionAndExportAndGlobalTimeStepComputation::
    InitialConditionAndExportAndGlobalTimeStepComputation(
        const InitialConditionAndExportAndGlobalTimeStepComputation&
            masterThread)
...
void exahype::adapters::InitialConditionAndExportAndGlobalTimeStepComputation::
...
bool exahype::adapters::InitialConditionAndExportAndGlobalTimeStepComputation::
    prepareSendToWorker(
        exahype::Cell& fineGridCell, exahype::Vertex* const fineGridVertices,
        const peano::grid::VertexEnumerator& fineGridVerticesEnumerator,
        exahype::Vertex* const coarseGridVertices,
