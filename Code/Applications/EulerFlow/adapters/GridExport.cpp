...
exahype::adapters::GridExport::communicationSpecification() {
...
exahype::adapters::GridExport::touchVertexLastTimeSpecification() {
...
peano::MappingSpecification
exahype::adapters::GridExport::touchVertexFirstTimeSpecification() {
  return peano::MappingSpecification::getMinimalSpecification() &
         exahype::adapters::GridExport2VTKGridVisualiser_0::
...
peano::MappingSpecification
exahype::adapters::GridExport::enterCellSpecification() {
  return peano::MappingSpecification::getMinimalSpecification() &
         exahype::adapters::GridExport2VTKGridVisualiser_0::
...
peano::MappingSpecification
exahype::adapters::GridExport::leaveCellSpecification() {
  return peano::MappingSpecification::getMinimalSpecification() &
         exahype::adapters::GridExport2VTKGridVisualiser_0::
...
peano::MappingSpecification
exahype::adapters::GridExport::ascendSpecification() {
  return peano::MappingSpecification::getMinimalSpecification() &
         exahype::adapters::GridExport2VTKGridVisualiser_0::
             ascendSpecification()
...
peano::MappingSpecification
exahype::adapters::GridExport::descendSpecification() {
  return peano::MappingSpecification::getMinimalSpecification() &
         exahype::adapters::GridExport2VTKGridVisualiser_0::
...
exahype::adapters::GridExport::GridExport(const GridExport& masterThread)
    : _map2GridExport2VTKGridVisualiser_0(
          masterThread._map2GridExport2VTKGridVisualiser_0)

{}

void exahype::adapters::GridExport::mergeWithWorkerThread(
    const GridExport& workerThread) {
  _map2GridExport2VTKGridVisualiser_0.mergeWithWorkerThread(
      workerThread._map2GridExport2VTKGridVisualiser_0);
}
#endif
...
void exahype::adapters::GridExport::createHangingVertex(
  ...
  _map2GridExport2VTKGridVisualiser_0.createHangingVertex(
...
void exahype::adapters::GridExport::destroyHangingVertex(
    ...
    exahype::Cell& coarseGridCell,
    const tarch::la::Vector<DIMENSIONS, int>& fineGridPositionOfVertex) {
  _map2GridExport2VTKGridVisualiser_0.destroyHangingVertex(
      fineGridVertex, fineGridX, fineGridH, coarseGridVertices,
      coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfVertex);
}
...
void exahype::adapters::GridExport::createInnerVertex(
    ...
    exahype::Cell& coarseGridCell,
    const tarch::la::Vector<DIMENSIONS, int>& fineGridPositionOfVertex) {
  _map2GridExport2VTKGridVisualiser_0.createInnerVertex(
      fineGridVertex, fineGridX, fineGridH, coarseGridVertices,
      coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfVertex);
}
...
void exahype::adapters::GridExport::createBoundaryVertex(
    ...
    exahype::Cell& coarseGridCell,
    const tarch::la::Vector<DIMENSIONS, int>& fineGridPositionOfVertex) {
  _map2GridExport2VTKGridVisualiser_0.createBoundaryVertex(
      fineGridVertex, fineGridX, fineGridH, coarseGridVertices,
      coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfVertex);
}
...
void exahype::adapters::GridExport::destroyVertex(
    ...
    exahype::Cell& coarseGridCell,
    const tarch::la::Vector<DIMENSIONS, int>& fineGridPositionOfVertex) {
  _map2GridExport2VTKGridVisualiser_0.destroyVertex(
      fineGridVertex, fineGridX, fineGridH, coarseGridVertices,
      coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfVertex);
}
...
void exahype::adapters::GridExport::createCell(
  ...
  _map2GridExport2VTKGridVisualiser_0.createCell(
...
void exahype::adapters::GridExport::destroyCell(
    ...
    exahype::Cell& coarseGridCell,
    const tarch::la::Vector<DIMENSIONS, int>& fineGridPositionOfCell) {
  _map2GridExport2VTKGridVisualiser_0.destroyCell(
      fineGridCell, fineGridVertices, fineGridVerticesEnumerator,
      coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell,
      fineGridPositionOfCell);
}
...
void exahype::adapters::GridExport::mergeWithNeighbour(
  ...
  _map2GridExport2VTKGridVisualiser_0.mergeWithNeighbour(
...
void exahype::adapters::GridExport::prepareSendToNeighbour(
  ...
  _map2GridExport2VTKGridVisualiser_0.prepareSendToNeighbour(vertex, toRank, x,
                                                             h, level);
}
...
void exahype::adapters::GridExport::prepareCopyToRemoteNode(
    ...
    const tarch::la::Vector<DIMENSIONS, double>& x,
    const tarch::la::Vector<DIMENSIONS, double>& h, int level) {
  _map2GridExport2VTKGridVisualiser_0.prepareCopyToRemoteNode(
...
void exahype::adapters::GridExport::prepareCopyToRemoteNode(
    ...
    const tarch::la::Vector<DIMENSIONS, double>& x,
    const tarch::la::Vector<DIMENSIONS, double>& h, int level) {
  _map2GridExport2VTKGridVisualiser_0.prepareCopyToRemoteNode(localCell, toRank,
                                                              x, h, level);
}
...
void exahype::adapters::GridExport::mergeWithRemoteDataDueToForkOrJoin(
    ...
    const tarch::la::Vector<DIMENSIONS, double>& h, int level) {
  _map2GridExport2VTKGridVisualiser_0.mergeWithRemoteDataDueToForkOrJoin(
...
bool exahype::adapters::GridExport::prepareSendToWorker(
    ...
    int worker) {
  bool result = false;
  result |= _map2GridExport2VTKGridVisualiser_0.prepareSendToWorker(
      fineGridCell, fineGridVertices, fineGridVerticesEnumerator,
      coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell,
...
void exahype::adapters::GridExport::prepareSendToMaster(
    ...
    const tarch::la::Vector<DIMENSIONS, int>& fineGridPositionOfCell) {
  _map2GridExport2VTKGridVisualiser_0.prepareSendToMaster(
...
void exahype::adapters::GridExport::mergeWithMaster(
  ...
  _map2GridExport2VTKGridVisualiser_0.mergeWithMaster(
...
void exahype::adapters::GridExport::receiveDataFromMaster(
    ...
    const tarch::la::Vector<DIMENSIONS, int>& fineGridPositionOfCell) {
  _map2GridExport2VTKGridVisualiser_0.receiveDataFromMaster(
...
void exahype::adapters::GridExport::mergeWithWorker(
  ...
  _map2GridExport2VTKGridVisualiser_0.mergeWithWorker(
...
void exahype::adapters::GridExport::touchVertexFirstTime(
    ...
    exahype::Cell& coarseGridCell,
    const tarch::la::Vector<DIMENSIONS, int>& fineGridPositionOfVertex) {
  _map2GridExport2VTKGridVisualiser_0.touchVertexFirstTime(
      fineGridVertex, fineGridX, fineGridH, coarseGridVertices,
      coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfVertex);
}
...
void exahype::adapters::GridExport::touchVertexLastTime(
    ...
    exahype::Cell& coarseGridCell,
    const tarch::la::Vector<DIMENSIONS, int>& fineGridPositionOfVertex) {
  _map2GridExport2VTKGridVisualiser_0.touchVertexLastTime(
      fineGridVertex, fineGridX, fineGridH, coarseGridVertices,
      coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfVertex);
}
...
void exahype::adapters::GridExport::enterCell(
    ...
    exahype::Cell& coarseGridCell,
    const tarch::la::Vector<DIMENSIONS, int>& fineGridPositionOfCell) {
  _map2GridExport2VTKGridVisualiser_0.enterCell(
      fineGridCell, fineGridVertices, fineGridVerticesEnumerator,
      coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell,
      fineGridPositionOfCell);
}
...
void exahype::adapters::GridExport::leaveCell(
    ...
    exahype::Cell& coarseGridCell,
    const tarch::la::Vector<DIMENSIONS, int>& fineGridPositionOfCell) {
  _map2GridExport2VTKGridVisualiser_0.leaveCell(
      fineGridCell, fineGridVertices, fineGridVerticesEnumerator,
      coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell,
      fineGridPositionOfCell);
}
...
void exahype::adapters::GridExport::endIteration(exahype::State& solverState) {
...
void exahype::adapters::GridExport::descend(
    ...
    const peano::grid::VertexEnumerator& coarseGridVerticesEnumerator,
    exahype::Cell& coarseGridCell) {
  _map2GridExport2VTKGridVisualiser_0.descend(
...
void exahype::adapters::GridExport::ascend(
    ...
    const peano::grid::VertexEnumerator& coarseGridVerticesEnumerator,
    exahype::Cell& coarseGridCell) {
  _map2GridExport2VTKGridVisualiser_0.ascend(
      fineGridCells, fineGridVertices, fineGridVerticesEnumerator,
      coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell);
}
