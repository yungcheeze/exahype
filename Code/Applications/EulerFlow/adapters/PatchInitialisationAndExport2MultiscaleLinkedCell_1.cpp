...
exahype::adapters::PatchInitialisationAndExport2MultiscaleLinkedCell_1::
...
peano::MappingSpecification exahype::adapters::
    PatchInitialisationAndExport2MultiscaleLinkedCell_1::ascendSpecification() {
  return peano::MappingSpecification(
      peano::MappingSpecification::Nop,
      peano::MappingSpecification::AvoidFineGridRaces);
}
...
exahype::adapters::PatchInitialisationAndExport2MultiscaleLinkedCell_1::
    PatchInitialisationAndExport2MultiscaleLinkedCell_1(
        const PatchInitialisationAndExport2MultiscaleLinkedCell_1&
            masterThread) {}

void exahype::adapters::PatchInitialisationAndExport2MultiscaleLinkedCell_1::
...
bool exahype::adapters::PatchInitialisationAndExport2MultiscaleLinkedCell_1::
    prepareSendToWorker(
        exahype::Cell& fineGridCell, exahype::Vertex* const fineGridVertices,
        const peano::grid::VertexEnumerator& fineGridVerticesEnumerator,
        exahype::Vertex* const coarseGridVertices,
