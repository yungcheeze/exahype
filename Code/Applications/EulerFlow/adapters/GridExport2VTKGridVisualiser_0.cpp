...
peano::CommunicationSpecification   exahype::adapters::GridExport2VTKGridVisualiser_0::communicationSpecification() {
  return peano::CommunicationSpecification::getPessimisticSpecification();
}


peano::MappingSpecification   exahype::adapters::GridExport2VTKGridVisualiser_0::touchVertexLastTimeSpecification() {
  return peano::MappingSpecification(peano::MappingSpecification::Nop,peano::MappingSpecification::RunConcurrentlyOnFineGrid);
}


peano::MappingSpecification   exahype::adapters::GridExport2VTKGridVisualiser_0::touchVertexFirstTimeSpecification() { 
  return peano::MappingSpecification(peano::MappingSpecification::WholeTree,peano::MappingSpecification::Serial);
}


peano::MappingSpecification   exahype::adapters::GridExport2VTKGridVisualiser_0::enterCellSpecification() {
  return peano::MappingSpecification(peano::MappingSpecification::Nop,peano::MappingSpecification::AvoidFineGridRaces);
}


peano::MappingSpecification   exahype::adapters::GridExport2VTKGridVisualiser_0::leaveCellSpecification() {
  return peano::MappingSpecification(peano::MappingSpecification::WholeTree,peano::MappingSpecification::Serial);
}


peano::MappingSpecification   exahype::adapters::GridExport2VTKGridVisualiser_0::ascendSpecification() {
  return peano::MappingSpecification(peano::MappingSpecification::Nop,peano::MappingSpecification::RunConcurrentlyOnFineGrid);
}


peano::MappingSpecification   exahype::adapters::GridExport2VTKGridVisualiser_0::descendSpecification() {
  return peano::MappingSpecification(peano::MappingSpecification::Nop,peano::MappingSpecification::RunConcurrentlyOnFineGrid);
}


std::map<tarch::la::Vector<DIMENSIONS,double> , int, tarch::la::VectorCompare<DIMENSIONS> >  exahype::adapters::GridExport2VTKGridVisualiser_0::_vertex2IndexMap;


exahype::adapters::GridExport2VTKGridVisualiser_0::GridExport2VTKGridVisualiser_0():
  _vtkWriter(0),
  _vertexWriter(0),
  _cellWriter(0),
  _vertexTypeWriter(0),
...
exahype::adapters::GridExport2VTKGridVisualiser_0::GridExport2VTKGridVisualiser_0(const GridExport2VTKGridVisualiser_0&  masterThread):
...
void exahype::adapters::GridExport2VTKGridVisualiser_0::mergeWithWorkerThread(const GridExport2VTKGridVisualiser_0& workerThread) {
}
#endif
...
void exahype::adapters::GridExport2VTKGridVisualiser_0::mergeWithRemoteDataDueToForkOrJoin(
  exahype::Vertex&  localVertex,
