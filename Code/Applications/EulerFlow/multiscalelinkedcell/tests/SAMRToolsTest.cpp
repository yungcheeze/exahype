#include "EulerFlow/multiscalelinkedcell/tests/SAMRToolsTest.h"
#include "EulerFlow/multiscalelinkedcell/SAMRTools.h"
...
void multiscalelinkedcell::tests::SAMRToolsTest::
    testComputeIterationRangeA0A1() {
#if Dim2
  ...
  multiscalelinkedcell::SAMRTools::computeIterationRangeFromRelativePosition(
      relativePositionOfSrcCellToDestCall, cellDescriptionSize, haloSize,
      cellOffset, range);
  ...
  multiscalelinkedcell::SAMRTools::
      computeIterationRangeFromCellDescriptionOverlap(
...
void multiscalelinkedcell::tests::SAMRToolsTest::
  ...
  tarch::la::assignList(leftBottom) = 2.0 / 3.0 + 1.0 / 27.0,
  1.0 / 3.0 - 1.0 / 27.0 / 6.0;
  tarch::la::assignList(rightTop) = 2.0 / 3.0 + 1.0 / 27.0 + 1.0 / 27.0 / 6.0,
  1.0 / 3.0;
...
void multiscalelinkedcell::tests::SAMRToolsTest::
    testComputeIterationRangeD0D1() {}

void multiscalelinkedcell::tests::SAMRToolsTest::
    testComputeIterationRangeB1C1() {}
