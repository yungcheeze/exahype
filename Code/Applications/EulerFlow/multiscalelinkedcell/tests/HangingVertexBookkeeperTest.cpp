#include "EulerFlow/multiscalelinkedcell/tests/HangingVertexBookkeeperTest.h"
...
#pragma optimize("", off)
    ...
    multiscalelinkedcell::tests::HangingVertexBookkeeperTest::
        HangingVertexBookkeeperTest()
    : tarch::tests::TestCase(
          "multiscalelinkedcell::HangingVertexBookkeeperTest") {
}
...
void multiscalelinkedcell::tests::HangingVertexBookkeeperTest::test0() {
  ...
  tarch::la::assignList(adjacencyEntries) = 593, 594, 595, 596, -3, -3, 596,
  1385, 595, 596, 597, 598, 596, 1385, 598, 1385;

  tarch::la::assignList(x) = 0.1, 0.0 / 3.0;
  tarch::la::assignList(fineGridPositionOfVertex) = 3, 0;

  result = HangingVertexBookkeeper::getInstance().createHangingVertex(
      x, 4, fineGridPositionOfVertex, adjacencyEntries);
