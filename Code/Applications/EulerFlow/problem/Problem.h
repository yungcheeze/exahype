 ...
 */
void PDEInitialValue2d(const double x, const double y, double *restrict Q);
 ...
 */
void PDEFlux(const double *restrict const Q, double *restrict f,
             double *restrict g);
...
void PDEEigenvalues(const double *restrict const Q,
                    const double *restrict const n, double *restrict lambda);

/**
 * @note Unused. Leftover from debugging.
 */
double PDENormalFlux(const double x, const double y, const double nx,
                     const double ny);

/**
 * @note Unused. Leftover from debugging.
 */
double DGNormalFlux(const double x, const double y, const double nx,
                    const double ny);

/**
 * @note Unused. Leftover from debugging.
 */
void DGRiemannSolver(const double x, const double y, const double nx,
                     const double ny, double *selfFlux, double *neighbourFlux);
}  // namespace problem
}  // namespace exahype
