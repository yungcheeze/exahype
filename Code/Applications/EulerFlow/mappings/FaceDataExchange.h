...
#ifndef EXAHYPE_MAPPINGS_FaceDataExchange_H_
#define EXAHYPE_MAPPINGS_FaceDataExchange_H_
 ...
 */
class exahype::mappings::FaceDataExchange {
 private:
  /**
...
tarch::parallel::Node::getInstance().getRank() ) ) {
 ...
  ...
  /**
   * @brief Copies the boundary conditions to the respective ghost cell of the
   * current patch.
   */
  void setBoundaryGhostValues(records::CellDescription& dataSelf,
                              const int patchIndexGhostSelf,
                              const int patchIndexRealSelf, const int face,
                              const int numberOfDofOnFace);

  /**
   * @brief Copies the neighbour's face data to the respective ghost cell of the
   * current patch.
   */
  void copyGhostValues(records::CellDescription& dataSelf,
                       const records::CellDescription& dataNeighbour,
                       const int indexGhostSelf, const int indexNeighbor,
