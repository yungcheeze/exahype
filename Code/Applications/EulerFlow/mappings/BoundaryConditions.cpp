...
void exahype::mappings::BoundaryConditions::enterCell(
  ...
  //    cellDescriptionsOfAllNeighbours =
  ...
  //
  //    // Store neighbour flux in LEFT (0,r=-1),RIGHT (1,r=+1),FRONT
  //    (2,s=-1),BACK (3,s=+1),BOTTOM (4,t=-1),TOP (5,t=+1)
  //    // manner, where r,s,t refer to the reference coordinates.
  //    cellDescriptionsOfNeighbors[EXAHYPE_FACE_LEFT  ] =
  //    cellDescriptionsOfAllNeighbours[PEANO_3D_NEIGHBOUR_LEFT  ];
  //    cellDescriptionsOfNeighbors[EXAHYPE_FACE_RIGHT ] =
  //    cellDescriptionsOfAllNeighbours[PEANO_3D_NEIGHBOUR_RIGHT ];
  //    cellDescriptionsOfNeighbors[EXAHYPE_FACE_FRONT ] =
  //    cellDescriptionsOfAllNeighbours[PEANO_3D_NEIGHBOUR_FRONT ];
  //    cellDescriptionsOfNeighbors[EXAHYPE_FACE_BACK  ] =
  //    cellDescriptionsOfAllNeighbours[PEANO_3D_NEIGHBOUR_BACK  ];
  //    cellDescriptionsOfNeighbors[EXAHYPE_FACE_BOTTOM] =
  //    cellDescriptionsOfAllNeighbours[PEANO_3D_NEIGHBOUR_BOTTOM];
  //    cellDescriptionsOfNeighbors[EXAHYPE_FACE_TOP   ] =
  //    cellDescriptionsOfAllNeighbours[PEANO_3D_NEIGHBOUR_TOP   ];
  //
  ...
  //    // the length of the path element; constant on the face
  ...
  //    fineGridCell.getCellDescription(0);
  //
  //    double solution =
  //    DataHeap::getInstance().getData(cellDescription.getSolution())[0]._persistentRecords._u;
  //    double update   =
  //    DataHeap::getInstance().getData(cellDescription.getUpdate())[0]._persistentRecords._u;
  //
  ...
  //      if
  //      (cellDescriptionsOfNeighbors[face]==multiscalelinkedcell::HangingVertexBookkeeper::DomainBoundaryAdjacencyIndex)
  //      {
  ...
  //
  //    DataHeap::getInstance().getData(cellDescription.getUpdate())[0]._persistentRecords._u
  //    += update+selfFlux*solution+inflow;
  //  }
