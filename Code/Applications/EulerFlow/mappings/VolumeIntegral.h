...
#ifndef EXAHYPE_MAPPINGS_VolumeIntegral_H_
#define EXAHYPE_MAPPINGS_VolumeIntegral_H_
 ...
 */
class exahype::mappings::VolumeIntegral {
 private:
  /**
 ...
 public:
   ...
   */
  VolumeIntegral(const VolumeIntegral& masterThread);
#endif
   ...
   */
  void mergeWithWorkerThread(const VolumeIntegral& workerThread);
#endif
...
tarch::parallel::Node::getInstance().getRank() ) ) {
 ...
   ...
   */
  void computeVolumeIntegral(double* lduh, double* lFhi,
                             const tarch::la::Vector<DIMENSIONS, double> center,
                             const double dxPatch, const double dyPatch,
                             const int patchIndex, const int nvar,
                             const int basisSize);
