...
class exahype::repositories::Repository {
 public:
  ...
  virtual void
  switchToInitialConditionAndExportAndGlobalTimeStepComputation() = 0;
  ...
  virtual void
  switchToCorrectorAndPredictorAndGlobalTimeStepComputationAndExport() = 0;
  ...
  virtual bool
  isActiveAdapterCorrectorAndPredictorAndGlobalTimeStepComputation() const = 0;
  virtual bool
