...
exahype::records::State::PersistentRecords::PersistentRecords(
    const double& timeStepSize, const double& oldTimeStepSize,
    const double& time,
...
exahype::records::State::State(const PersistentRecords& persistentRecords)
    : _persistentRecords(
          persistentRecords._timeStepSize, persistentRecords._oldTimeStepSize,
          persistentRecords._time, persistentRecords._minMeshWidth,
          persistentRecords._maxMeshWidth,
...
exahype::records::State::State(
    ...
    const bool& subWorkerIsInvolvedInJoinOrFork)
    : _persistentRecords(
          timeStepSize, oldTimeStepSize, time, minMeshWidth, maxMeshWidth,
...
exahype::records::StatePacked exahype::records::State::convert() const {
  return StatePacked(
      getTimeStepSize(), getOldTimeStepSize(), getTime(), getMinMeshWidth(),
...
void exahype::records::State::initDatatype() {
  {
    ...
    MPI_Address(const_cast<void*>(static_cast<const void*>(
                    &(dummyState[0]._persistentRecords._timeStepSize))),
                &disp[0]);
    MPI_Address(const_cast<void*>(static_cast<const void*>(
                    &(dummyState[0]._persistentRecords._oldTimeStepSize))),
                &disp[1]);
    MPI_Address(const_cast<void*>(static_cast<const void*>(
                    &(dummyState[0]._persistentRecords._time))),
                &disp[2]);
    MPI_Address(const_cast<void*>(static_cast<const void*>(
    ...
    MPI_Address(
        ...
        &disp[25]);
    MPI_Address(const_cast<void*>(static_cast<const void*>(
                    &(dummyState[1]._persistentRecords._timeStepSize))),
                &disp[26]);
...
void exahype::records::StatePacked::initDatatype() {
  {
    ...
    MPI_Address(
        ...
        &base);
    MPI_Address(const_cast<void*>(static_cast<const void*>(
                    &(dummyStatePacked[0]._persistentRecords._timeStepSize))),
                &disp[0]);
    MPI_Address(
        const_cast<void*>(static_cast<const void*>(
            &(dummyStatePacked[0]._persistentRecords._oldTimeStepSize))),
        &disp[1]);
    MPI_Address(const_cast<void*>(static_cast<const void*>(
                    &(dummyStatePacked[0]._persistentRecords._time))),
                &disp[2]);
    MPI_Address(
        const_cast<void*>(static_cast<const void*>(
    ...
    MPI_Address(const_cast<void*>(static_cast<const void*>(
                ...
                &disp[17]);
    MPI_Address(const_cast<void*>(static_cast<const void*>(
                    &(dummyStatePacked[1]._persistentRecords._timeStepSize))),
                &disp[18]);
