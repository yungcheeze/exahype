...
class exahype::records::CellDescription {
 public:
  ...
  struct PersistentRecords {
     ...
     * @see convert()
     */
    inline tarch::la::Vector<EXAHYPE_PATCH_SIZE_TOTAL, int>
    getSpaceTimePredictor() const
     ...
     * @see convert()
     */
    inline void setSpaceTimePredictor(const tarch::la::Vector<
        EXAHYPE_PATCH_SIZE_TOTAL, int>& spaceTimePredictor)
#ifdef UseManualInlining
        __attribute__((always_inline))
#endif
    {
     ...
     * @see convert()
     */
    inline void setSpaceTimeVolumeFlux(const tarch::la::Vector<
        EXAHYPE_PATCH_SIZE_TOTAL, int>& spaceTimeVolumeFlux)
#ifdef UseManualInlining
        __attribute__((always_inline))
#endif
    {
     ...
     * @see convert()
     */
    inline tarch::la::Vector<EXAHYPE_PATCH_SIZE_TOTAL, int> getVolumeFlux()
        const
#ifdef UseManualInlining
        __attribute__((always_inline))
#endif
     ...
     */
    inline tarch::la::Vector<EXAHYPE_PATCH_SIZE_TOTAL, int>
    getExtrapolatedPredictor() const
#ifdef UseManualInlining
        __attribute__((always_inline))
#endif
    {
     ...
     * @see convert()
     */
    inline void setExtrapolatedPredictor(const tarch::la::Vector<
        EXAHYPE_PATCH_SIZE_TOTAL, int>& extrapolatedPredictor)
#ifdef UseManualInlining
        __attribute__((always_inline))
#endif
    {
     ...
     * @see convert()
     */
    inline tarch::la::Vector<EXAHYPE_PATCH_SIZE_TOTAL, int> getFluctuation()
        const
#ifdef UseManualInlining
        __attribute__((always_inline))
#endif
 ...
 public:
  ...
  inline void setSpaceTimePredictor(int elementIndex,
  ...
  inline void setSpaceTimeVolumeFlux(int elementIndex,
  ...
  inline void setExtrapolatedPredictor(int elementIndex,
...
#endif
  {
    assertion(elementIndex >= 0);
    assertion(elementIndex < EXAHYPE_PATCH_SIZE_TOTAL);
    _persistentRecords._extrapolatedPredictor[elementIndex] =
        extrapolatedPredictor;
  }
