#include "EulerFlow/records/Vertex.h"

#if defined(Parallel) && defined(Asserts)
exahype::records::Vertex::PersistentRecords::PersistentRecords() {}

exahype::records::Vertex::PersistentRecords::PersistentRecords(
    const tarch::la::Vector<TWO_POWER_D, int>& cellDescriptionsIndex,
...
exahype::records::VertexPacked exahype::records::Vertex::convert() const {
  return VertexPacked(
      getCellDescriptionsIndex(), getIsHangingNode(), getRefinementControl(),
      getAdjacentCellsHeight(), getAdjacentCellsHeightOfPreviousIteration(),
...
void exahype::records::Vertex::initDatatype() {
  ...
  }
  {
    ...
    MPI_Address(
        const_cast<void*>(static_cast<const void*>(
            &(dummyVertex[0]._persistentRecords._cellDescriptionsIndex[0]))),
        &disp[0]);
    MPI_Address(const_cast<void*>(static_cast<const void*>(
                    &(dummyVertex[0]._persistentRecords._isHangingNode))),
                &disp[1]);
    ...
    MPI_Address(
        const_cast<void*>(static_cast<const void*>(
            &dummyVertex[1]._persistentRecords._cellDescriptionsIndex[0])),
        &disp[11]);
...
void exahype::records::VertexPacked::initDatatype() {
  ...
  }
  {
    ...
    MPI_Address(const_cast<void*>(static_cast<const void*>(
                    &(dummyVertexPacked[0]
                          ._persistentRecords._cellDescriptionsIndex[0]))),
                &disp[0]);
    MPI_Address(
        const_cast<void*>(static_cast<const void*>(
...
exahype::records::Vertex exahype::records::VertexPacked::convert() const {
  return Vertex(getCellDescriptionsIndex(), getIsHangingNode(),
...
exahype::records::VertexPacked exahype::records::Vertex::convert() const {
  return VertexPacked(getCellDescriptionsIndex(), getIsHangingNode(),
                      getRefinementControl(), getAdjacentCellsHeight(),
                      getAdjacentCellsHeightOfPreviousIteration(),
