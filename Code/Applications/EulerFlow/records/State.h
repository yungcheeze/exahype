...
class exahype::records::State {
 public:
  ...
  struct PersistentRecords {
     ...
     * Generated
     */
    PersistentRecords(const double& timeStepSize, const double& oldTimeStepSize,
                      const double& time,
                      const tarch::la::Vector<DIMENSIONS, double>& minMeshWidth,
                      const tarch::la::Vector<DIMENSIONS, double>& maxMeshWidth,
                      const double& numberOfInnerVertices,
                      const double& numberOfBoundaryVertices,
                      const double& numberOfOuterVertices,
                      const double& numberOfInnerCells,
                      const double& numberOfOuterCells,
                      const double& numberOfInnerLeafVertices,
                      const double& numberOfBoundaryLeafVertices,
                      const double& numberOfOuterLeafVertices,
                      const double& numberOfInnerLeafCells,
                      const double& numberOfOuterLeafCells, const int& maxLevel,
                      const bool& hasRefined,
                      const bool& hasTriggeredRefinementForNextIteration,
                      const bool& hasErased,
    ...
    inline double getOldTimeStepSize() const
#ifdef UseManualInlining
        __attribute__((always_inline))
#endif
    {
      return _oldTimeStepSize;
    }

    inline void setOldTimeStepSize(const double& oldTimeStepSize)
#ifdef UseManualInlining
        __attribute__((always_inline))
#endif
    {
    ...
    inline void setNumberOfBoundaryVertices(
        const double& numberOfBoundaryVertices)
#ifdef UseManualInlining
        __attribute__((always_inline))
#endif
    ...
    inline void setNumberOfInnerLeafVertices(
        const double& numberOfInnerLeafVertices)
#ifdef UseManualInlining
        __attribute__((always_inline))
#endif
    ...
    inline void setNumberOfBoundaryLeafVertices(
        const double& numberOfBoundaryLeafVertices)
#ifdef UseManualInlining
        __attribute__((always_inline))
#endif
    ...
    inline void setNumberOfOuterLeafVertices(
        const double& numberOfOuterLeafVertices)
#ifdef UseManualInlining
        __attribute__((always_inline))
#endif
    ...
    inline void setHasTriggeredRefinementForNextIteration(
        const bool& hasTriggeredRefinementForNextIteration)
#ifdef UseManualInlining
        __attribute__((always_inline))
#endif
    ...
    inline void setHasTriggeredEraseForNextIteration(
        const bool& hasTriggeredEraseForNextIteration)
#ifdef UseManualInlining
        __attribute__((always_inline))
#endif
    ...
    inline void setHasChangedVertexOrCellState(
        const bool& hasChangedVertexOrCellState)
#ifdef UseManualInlining
        __attribute__((always_inline))
#endif
    ...
    inline void setHasModifiedGridInPreviousIteration(
        const bool& hasModifiedGridInPreviousIteration)
#ifdef UseManualInlining
        __attribute__((always_inline))
#endif
    ...
    inline void setCouldNotEraseDueToDecompositionFlag(
        const bool& couldNotEraseDueToDecompositionFlag)
#ifdef UseManualInlining
        __attribute__((always_inline))
#endif
    {
      _couldNotEraseDueToDecompositionFlag =
          couldNotEraseDueToDecompositionFlag;
    }
    ...
    inline void setSubWorkerIsInvolvedInJoinOrFork(
        const bool& subWorkerIsInvolvedInJoinOrFork)
#ifdef UseManualInlining
        __attribute__((always_inline))
#endif
 ...
 public:
   ...
   * Generated
   */
  State(const double& timeStepSize, const double& oldTimeStepSize,
        const double& time,
        const tarch::la::Vector<DIMENSIONS, double>& minMeshWidth,
        const tarch::la::Vector<DIMENSIONS, double>& maxMeshWidth,
        const double& numberOfInnerVertices,
        ...
        const bool& hasRefined,
        const bool& hasTriggeredRefinementForNextIteration,
        const bool& hasErased, const bool& hasTriggeredEraseForNextIteration,
        const bool& hasChangedVertexOrCellState,
        const bool& hasModifiedGridInPreviousIteration,
...
#endif
  {
    return _persistentRecords._oldTimeStepSize;
  }
...
#endif
  {
    _persistentRecords._oldTimeStepSize = oldTimeStepSize;
  }
...
#endif
  {
    _persistentRecords._hasTriggeredRefinementForNextIteration =
        hasTriggeredRefinementForNextIteration;
  }
...
#endif
  {
    _persistentRecords._hasChangedVertexOrCellState =
        hasChangedVertexOrCellState;
  }
...
#endif
  {
    _persistentRecords._hasModifiedGridInPreviousIteration =
        hasModifiedGridInPreviousIteration;
  }
...
class exahype::records::StatePacked {
 public:
  struct PersistentRecords {
    ...
    {
      short int mask = 1 << (0);
      _packedRecords0 = static_cast<short int>(
          hasRefined ? (_packedRecords0 | mask) : (_packedRecords0 & ~mask));
    }
...
#endif
    {
      short int mask = 1 << (1);
      _packedRecords0 = static_cast<short int>(
          hasTriggeredRefinementForNextIteration ? (_packedRecords0 | mask)
...
#endif
    {
      short int mask = 1 << (2);
      _packedRecords0 = static_cast<short int>(
          hasErased ? (_packedRecords0 | mask) : (_packedRecords0 & ~mask));
    }
    ...
    {
      short int mask = 1 << (3);
      _packedRecords0 = static_cast<short int>(hasTriggeredEraseForNextIteration
                                                   ? (_packedRecords0 | mask)
                                                   : (_packedRecords0 & ~mask));
    }
    ...
    {
      short int mask = 1 << (4);
      _packedRecords0 = static_cast<short int>(hasChangedVertexOrCellState
                                                   ? (_packedRecords0 | mask)
                                                   : (_packedRecords0 & ~mask));
    }
...
#endif
    {
      short int mask = 1 << (5);
      _packedRecords0 = static_cast<short int>(
          hasModifiedGridInPreviousIteration ? (_packedRecords0 | mask)
                                             : (_packedRecords0 & ~mask));
    }
    ...
    {
      short int mask = 1 << (6);
      _packedRecords0 = static_cast<short int>(reduceStateAndCell
                                                   ? (_packedRecords0 | mask)
                                                   : (_packedRecords0 & ~mask));
    }
...
#endif
    {
      short int mask = 1 << (7);
      _packedRecords0 = static_cast<short int>(
          couldNotEraseDueToDecompositionFlag ? (_packedRecords0 | mask)
                                              : (_packedRecords0 & ~mask));
    }
    ...
    {
      short int mask = 1 << (8);
      _packedRecords0 = static_cast<short int>(subWorkerIsInvolvedInJoinOrFork
                                                   ? (_packedRecords0 | mask)
                                                   : (_packedRecords0 & ~mask));
    }
  };
 ...
 public:
   ...
   * Generated
   */
  StatePacked(const double& timeStepSize, const double& oldTimeStepSize,
              const double& time,
              const tarch::la::Vector<DIMENSIONS, double>& minMeshWidth,
              const tarch::la::Vector<DIMENSIONS, double>& maxMeshWidth,
              const double& numberOfInnerVertices,
...
#endif
  {
    short int mask = 1 << (0);
    short int tmp =
        static_cast<short int>(_persistentRecords._packedRecords0 & mask);
    return (tmp != 0);
  }
  ...
  {
    short int mask = 1 << (0);
    _persistentRecords._packedRecords0 = static_cast<short int>(
        hasRefined ? (_persistentRecords._packedRecords0 | mask)
...
#endif
  {
    short int mask = 1 << (2);
    _persistentRecords._packedRecords0 = static_cast<short int>(
        hasErased ? (_persistentRecords._packedRecords0 | mask)
                  : (_persistentRecords._packedRecords0 & ~mask));
  }
...
#endif
  {
    short int mask = 1 << (6);
    _persistentRecords._packedRecords0 = static_cast<short int>(
        reduceStateAndCell ? (_persistentRecords._packedRecords0 | mask)
                           : (_persistentRecords._packedRecords0 & ~mask));
  }
