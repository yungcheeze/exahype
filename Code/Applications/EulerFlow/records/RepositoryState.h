...
class exahype::records::RepositoryState {
 public:
  ...
  enum Action {
    ...
    Terminate = 2,
    RunOnAllNodes = 3,
    UseAdapterInitialGrid = 4,
    UseAdapterGridExport = 5,
    UseAdapterPatchInitialisation = 6,
    UseAdapterPatchInitialisationAndExport = 7,
    UseAdapterFaceDataExchange = 8,
    UseAdapterInitialConditionAndGlobalTimeStepComputation = 9,
    ...
    UseAdapterCorrectorAndPredictorAndGlobalTimeStepComputationAndExport = 13,
    NumberOfAdapters = 14
  };
  ...
  struct PersistentRecords {
    ...
    inline void setExchangeBoundaryVertices(
        const bool& exchangeBoundaryVertices)
#ifdef UseManualInlining
        __attribute__((always_inline))
#endif
