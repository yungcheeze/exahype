...
class exahype::records::Vertex {
 public:
  ...
  struct PersistentRecords {
     ...
     * @see convert()
     */
    inline void setCellDescriptionsIndex(
        const tarch::la::Vector<TWO_POWER_D, int>& cellDescriptionsIndex)
#ifdef UseManualInlining
        __attribute__((always_inline))
#endif
 ...
 public:
   ...
   * Generated
   */
  Vertex(const tarch::la::Vector<TWO_POWER_D, int>& cellDescriptionsIndex,
         const bool& isHangingNode, const RefinementControl& refinementControl,
         const int& adjacentCellsHeight,
         const InsideOutsideDomain& insideOutsideDomain,
         const tarch::la::Vector<DIMENSIONS, double>& x, const int& level,
  ...
  inline void setCellDescriptionsIndex(int elementIndex,
...
#endif
  {
    assertion(elementIndex >= 0);
    assertion(elementIndex < TWO_POWER_D);
    _persistentRecords._cellDescriptionsIndex[elementIndex] =
...
class exahype::records::VertexPacked {
 ...
 public:
   ...
   * Generated
   */
  VertexPacked(const tarch::la::Vector<TWO_POWER_D, int>& cellDescriptionsIndex,
               const bool& isHangingNode,
               const RefinementControl& refinementControl,
               const int& adjacentCellsHeight,
               const InsideOutsideDomain& insideOutsideDomain,
               const tarch::la::Vector<DIMENSIONS, double>& x, const int& level,
               const tarch::la::Vector<TWO_POWER_D, int>& adjacentRanks,
