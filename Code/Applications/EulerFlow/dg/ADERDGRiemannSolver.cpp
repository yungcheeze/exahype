...
void exahype::dg::solveRiemannProblem<3>(
    double *restrict /*out*/ FL, double *restrict /*out*/ FR,
    const double *restrict const /*in*/ QL,
    const double *restrict const /*in*/ QR, double *restrict /*local*/ QavL,
    double *restrict /*local*/ QavR, double *restrict /*local*/ lambdaL,
    double *restrict /*local*/ lambdaR, const double /*unused*/ dt,
    const double /*unused*/ hFace, const double *restrict const /*in*/ n) {
