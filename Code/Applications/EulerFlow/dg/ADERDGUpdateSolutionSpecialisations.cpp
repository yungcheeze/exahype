...
// 3D specialisation
template <>
void exahype::dg::updateSolution<3>(double* restrict /*inout*/ luh,
...
// 2D specialisation
template <>
void exahype::dg::updateSolution<2>(double* restrict /*inout*/ luh,
                                    const double* restrict const /*in*/ lduh,
                                    const double /*in*/ dt) {
  ...
  for (int ii = 0; ii < basisSize; ii++) {
    for (int jj = 0; jj < basisSize; jj++) {
      ...
      double weight = exahype::quad::gaussLegendreWeights[ii] *
                      exahype::quad::gaussLegendreWeights[jj];
