...
namespace elasticwaves2d{
  class MyElasticSolver;
}


class elasticwaves2d::MyElasticSolver: public exahype::solvers::Solver {
  public:
    MyElasticSolver(int kernelNumber, std::unique_ptr<exahype::profilers::Profiler> profiler); 
