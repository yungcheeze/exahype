...
#ifndef EXAHYPE_MAPPINGS_ComputeCellData_H_
#define EXAHYPE_MAPPINGS_ComputeCellData_H_
 ...
 */
class exahype::mappings::ComputeCellData {
  private:
    /**
  ...
  public:
     ...
     */
    ComputeCellData(const ComputeCellData& masterThread);
    #endif

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~ComputeCellData();
     ...
     */   
    void mergeWithWorkerThread(const ComputeCellData& workerThread);
    #endif
