...
#ifndef EXAHYPE_ADAPTERS_CreateGrid2MultiscaleLinkedCell_0_H_
#define EXAHYPE_ADAPTERS_CreateGrid2MultiscaleLinkedCell_0_H_
...
namespace exahype {
      namespace adapters {
        class CreateGrid2MultiscaleLinkedCell_0;
      } 
}
 ...
 */
class exahype::adapters::CreateGrid2MultiscaleLinkedCell_0 {
  public:
    ...
    CreateGrid2MultiscaleLinkedCell_0();

    #if defined(SharedMemoryParallelisation)
    CreateGrid2MultiscaleLinkedCell_0(const CreateGrid2MultiscaleLinkedCell_0& masterThread);
    #endif

    virtual ~CreateGrid2MultiscaleLinkedCell_0();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const CreateGrid2MultiscaleLinkedCell_0& workerThread);
    #endif
