...
#ifndef _MYPROJECTREPOSITORIES__REPOSITORY_FACTORY_H_ 
#define _MYPROJECTREPOSITORIES__REPOSITORY_FACTORY_H_
 ...
 */
class myproject::repositories::RepositoryFactory {
  private:
    RepositoryFactory();
  public:
