...
#ifndef _MYPROJECTREPOSITORIES__REPOSITORY_H_ 
#define _MYPROJECTREPOSITORIES__REPOSITORY_H_
 ...
 */
class myproject::repositories::Repository {
  public:
    virtual ~Repository() {};
    ...
    virtual myproject::State& getState() = 0;
    virtual const myproject::State& getState() const = 0;
     ...
     */
    virtual void writeCheckpoint(peano::grid::Checkpoint<myproject::Vertex,myproject::Cell> * const checkpoint) = 0; 
     ...
     */
    virtual void readCheckpoint( peano::grid::Checkpoint<myproject::Vertex,myproject::Cell> const * const checkpoint ) = 0;
     ...
     * - Destroy the checkpoint object on the heap. 
     */
    virtual peano::grid::Checkpoint<myproject::Vertex,myproject::Cell>* createEmptyCheckpoint() = 0;
