...
#ifndef MYPROJECT_ADAPTERS_CreateGridAndPlot_H_
#define MYPROJECT_ADAPTERS_CreateGridAndPlot_H_
...
#include "ExplicitEulerForHeatEquation/State.h"
 ...
 #include "ExplicitEulerForHeatEquation/mappings/CreateGrid.h"
 ...
 */
class myproject::adapters::CreateGridAndPlot {
  private:
    myproject::mappings::CreateGrid _map2CreateGrid;

    myproject::adapters::CreateGridAndPlot2VTKPlotCellValue_0 _map2CreateGridAndPlot2VTKPlotCellValue_0;
    myproject::adapters::CreateGridAndPlot2VTKPlotVertexValue_1 _map2CreateGridAndPlot2VTKPlotVertexValue_1;
