...
#ifndef MYPROJECT_MAPPINGS_Inject_H_
#define MYPROJECT_MAPPINGS_Inject_H_
 ...
 */
class myproject::mappings::Inject {
  private:
    /**
  ...
  public:
     ...
     */
    Inject(const Inject& masterThread);
    #endif
     ...
     */   
    void mergeWithWorkerThread(const Inject& workerThread);
    #endif
