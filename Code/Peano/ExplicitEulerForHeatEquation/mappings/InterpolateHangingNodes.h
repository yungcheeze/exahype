...
#ifndef MYPROJECT_MAPPINGS_InterpolateHangingNodes_H_
#define MYPROJECT_MAPPINGS_InterpolateHangingNodes_H_
 ...
 */
class myproject::mappings::InterpolateHangingNodes {
  private:
    /**
  ...
  public:
     ...
     */
    InterpolateHangingNodes(const InterpolateHangingNodes& masterThread);
    #endif

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~InterpolateHangingNodes();
     ...
     */   
    void mergeWithWorkerThread(const InterpolateHangingNodes& workerThread);
    #endif
