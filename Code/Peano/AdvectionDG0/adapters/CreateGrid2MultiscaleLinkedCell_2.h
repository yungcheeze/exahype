...
#ifndef EXAHYPE_ADAPTERS_CreateGrid2MultiscaleLinkedCell_2_H_
#define EXAHYPE_ADAPTERS_CreateGrid2MultiscaleLinkedCell_2_H_
...
namespace exahype {
      namespace adapters {
        class CreateGrid2MultiscaleLinkedCell_2;
      } 
}
 ...
 */
class exahype::adapters::CreateGrid2MultiscaleLinkedCell_2 {
  public:
    ...
    CreateGrid2MultiscaleLinkedCell_2();

    #if defined(SharedMemoryParallelisation)
    CreateGrid2MultiscaleLinkedCell_2(const CreateGrid2MultiscaleLinkedCell_2& masterThread);
    #endif

    virtual ~CreateGrid2MultiscaleLinkedCell_2();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const CreateGrid2MultiscaleLinkedCell_2& workerThread);
    #endif
