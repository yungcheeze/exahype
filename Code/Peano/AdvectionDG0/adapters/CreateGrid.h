...
#include "AdvectionDG0/State.h"
 ...
 #include "AdvectionDG0/mappings/CreateGrid.h"
 #include "AdvectionDG0/mappings/InitCells.h"
 #include "AdvectionDG0/adapters/CreateGrid2MultiscaleLinkedCell_2.h"
...
class exahype::adapters::CreateGrid {
  private:
    ...
    typedef mappings::InitCells Mapping1;
    typedef adapters::CreateGrid2MultiscaleLinkedCell_2 Mapping2;
    typedef mappings::InitCellData Mapping3;

     Mapping0  _map2CreateGrid;
     Mapping1  _map2InitCells;
     Mapping2  _map2CreateGrid2MultiscaleLinkedCell_2;
     Mapping3  _map2InitCellData;
