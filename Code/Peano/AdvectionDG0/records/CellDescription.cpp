#include "AdvectionDG0/records/CellDescription.h"
   ...
   void exahype::records::CellDescription::initDatatype() {
      {
         ...
         MPI_Address( const_cast<void*>(static_cast<const void*>(&(dummyCellDescription[1]._persistentRecords._spaceTimePredictor))), 		&disp[11] );
   ...
   void exahype::records::CellDescriptionPacked::initDatatype() {
      {
         ...
         MPI_Address( const_cast<void*>(static_cast<const void*>(&(dummyCellDescriptionPacked[1]._persistentRecords._spaceTimePredictor))), 		&disp[11] );
