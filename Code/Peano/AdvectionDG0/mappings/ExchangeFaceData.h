...
#ifndef EXAHYPE_MAPPINGS_ExchangeFaceData_H_
#define EXAHYPE_MAPPINGS_ExchangeFaceData_H_
 ...
 */
class exahype::mappings::ExchangeFaceData {
  private:
    /**
  ...
  public:
     ...
     */
    ExchangeFaceData(const ExchangeFaceData& masterThread);
    #endif

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~ExchangeFaceData();
     ...
     */   
    void mergeWithWorkerThread(const ExchangeFaceData& workerThread);
    #endif
