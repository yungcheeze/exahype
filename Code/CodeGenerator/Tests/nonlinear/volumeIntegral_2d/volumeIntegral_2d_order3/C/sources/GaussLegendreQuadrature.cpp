...
void kernels::aderdg::optimised::initGaussLegendreNodesAndWeights(const std::set<int>& orders) {
  weights1 = (double *) _mm_malloc(sizeof(double)*4, ALIGNMENT);
  weights2 = (double *) _mm_malloc(sizeof(double)*4, ALIGNMENT);
  weights3 = (double *) _mm_malloc(sizeof(double)*16, ALIGNMENT);
  weights1[0] = 1.739274225687e-01;
  weights1[1] = 3.260725774313e-01;
  weights1[2] = 3.260725774313e-01;
  weights1[3] = 1.739274225687e-01;
  weights2[0] = 1.739274225687e-01;
  weights2[1] = 3.260725774313e-01;
  weights2[2] = 3.260725774313e-01;
  weights2[3] = 1.739274225687e-01;
  weights3[0] = 3.025074832140e-02;
  weights3[1] = 5.671296296296e-02;
  weights3[2] = 5.671296296296e-02;
  weights3[3] = 3.025074832140e-02;
  weights3[4] = 5.671296296296e-02;
  weights3[5] = 1.063233257527e-01;
  weights3[6] = 1.063233257527e-01;
  weights3[7] = 5.671296296296e-02;
  weights3[8] = 5.671296296296e-02;
  weights3[9] = 1.063233257527e-01;
  weights3[10] = 1.063233257527e-01;
  weights3[11] = 5.671296296296e-02;
  weights3[12] = 3.025074832140e-02;
  weights3[13] = 5.671296296296e-02;
  weights3[14] = 5.671296296296e-02;
  weights3[15] = 3.025074832140e-02;
  constexpr int MAX_ORDER=9;
