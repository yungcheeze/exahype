...
void exahype::tests::GenericEulerKernelTest::run() {
  ...
  testMethod(testSpaceTimePredictor3d);
...
#if DIMENSIONS == 2
void exahype::tests::GenericEulerKernelTest::testFlux(const double *const Q,
                                                      double *f, double *g) {
...
void exahype::tests::GenericEulerKernelTest::testEigenvalues(
...
void exahype::tests::GenericEulerKernelTest::testSolutionUpdate2d() {
  ...
  double lduh[80] = {
      ...
      3.33519014225e-319, 2.05164022212e-16, -1.54928352239e-16, 10.6914754372,
      -10.6914754372, 0, -5.42249232835e-16, -6.4862093408e-17, -10.6914754372,
      -10.6914754372, 0, -2.27017326925e-16, 3.71888723946e-17, 14.4447033527,
      -5.70284315505, 0, 1.3016105338e-16, 3.915089398e-17, -7.70481849073,
      7.70481849073, 0, 1.3702812893e-16, 5.71591661983e-17, 5.70284315505,
      14.4447033527, 0, 2.00057081693e-16, 3.71888723946e-17, -5.70284315505,
      14.4447033527, 0, 1.3016105338e-16, 5.14845862726e-17, 7.70481849073,
      7.70481849073, 0, 1.80196051954e-16};
...
void exahype::tests::GenericEulerKernelTest::testSpaceTimePredictor3d() {
