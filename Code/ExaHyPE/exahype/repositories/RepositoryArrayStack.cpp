...
exahype::repositories::RepositoryArrayStack::RepositoryArrayStack(
  ...
  _solverState(),
  _gridWithRegularMesh(_vertexStack,_cellStack,_geometry,_solverState,domainSize,domainOffset,_regularGridContainer,_traversalOrderOnTopLevel),
  ...
  _gridWithPlotAndGlobalTimeStepComputation(_vertexStack,_cellStack,_geometry,_solverState,domainSize,domainOffset,_regularGridContainer,_traversalOrderOnTopLevel),
...
void exahype::repositories::RepositoryArrayStack::iterate(int numberOfIterations, bool exchangeBoundaryVertices) {
 ...
 void exahype::repositories::RepositoryArrayStack::switchToRegularMesh() { _repositoryState.setAction(exahype::records::RepositoryState::UseAdapterRegularMesh); }
 ...
 void exahype::repositories::RepositoryArrayStack::switchToPlotAndGlobalTimeStepComputation() { _repositoryState.setAction(exahype::records::RepositoryState::UseAdapterPlotAndGlobalTimeStepComputation); }
 ...
 bool exahype::repositories::RepositoryArrayStack::isActiveAdapterRegularMesh() const { return _repositoryState.getAction() == exahype::records::RepositoryState::UseAdapterRegularMesh; }
 ...
 bool exahype::repositories::RepositoryArrayStack::isActiveAdapterPlotAndGlobalTimeStepComputation() const { return _repositoryState.getAction() == exahype::records::RepositoryState::UseAdapterPlotAndGlobalTimeStepComputation; }
