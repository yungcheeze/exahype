...
exahype::repositories::RepositoryArrayStack::RepositoryArrayStack(
  ...
  _gridWithAugmentedAMRGridNoLoadBalancing(_vertexStack,_cellStack,_geometry,_solverState,domainSize,domainOffset,_regularGridContainer,_traversalOrderOnTopLevel),
...
void exahype::repositories::RepositoryArrayStack::iterate(int numberOfIterations, bool exchangeBoundaryVertices) {
 ...
 void exahype::repositories::RepositoryArrayStack::switchToAugmentedAMRGridNoLoadBalancing() { _repositoryState.setAction(exahype::records::RepositoryState::UseAdapterAugmentedAMRGridNoLoadBalancing); }
 ...
 bool exahype::repositories::RepositoryArrayStack::isActiveAdapterAugmentedAMRGridNoLoadBalancing() const { return _repositoryState.getAction() == exahype::records::RepositoryState::UseAdapterAugmentedAMRGridNoLoadBalancing; }
