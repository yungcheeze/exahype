...
exahype::repositories::RepositorySTDStack::RepositorySTDStack(
  ...
  _gridWithAugmentedAMRGridNoLoadBalancing(_vertexStack,_cellStack,_geometry,_solverState,domainSize,computationalDomainOffset,_regularGridContainer,_traversalOrderOnTopLevel),
...
exahype::repositories::RepositorySTDStack::RepositorySTDStack(
  ...
  _gridWithAugmentedAMRGridNoLoadBalancing(_vertexStack,_cellStack,_geometry,_solverState,_regularGridContainer,_traversalOrderOnTopLevel),
...
void exahype::repositories::RepositorySTDStack::restart(
  ...
  _gridWithAugmentedAMRGridNoLoadBalancing.restart(domainSize,domainOffset,domainLevel, positionOfCentralElementWithRespectToCoarserRemoteLevel);
...
void exahype::repositories::RepositorySTDStack::terminate() {
  ...
  _gridWithAugmentedAMRGridNoLoadBalancing.terminate();
...
void exahype::repositories::RepositorySTDStack::iterate(int numberOfIterations, bool exchangeBoundaryVertices) {
  ...
  for (int i=0; i<numberOfIterations; i++) {
    switch ( _repositoryState.getAction()) {
      ...
      case exahype::records::RepositoryState::UseAdapterAugmentedAMRGridNoLoadBalancing: watch.startTimer(); _gridWithAugmentedAMRGridNoLoadBalancing.iterate(); watch.stopTimer(); _measureAugmentedAMRGridNoLoadBalancingCPUTime.setValue( watch.getCPUTime() ); _measureAugmentedAMRGridNoLoadBalancingCalendarTime.setValue( watch.getCalendarTime() ); break;
 ...
 void exahype::repositories::RepositorySTDStack::switchToAugmentedAMRGridNoLoadBalancing() { _repositoryState.setAction(exahype::records::RepositoryState::UseAdapterAugmentedAMRGridNoLoadBalancing); }
 ...
 bool exahype::repositories::RepositorySTDStack::isActiveAdapterAugmentedAMRGridNoLoadBalancing() const { return _repositoryState.getAction() == exahype::records::RepositoryState::UseAdapterAugmentedAMRGridNoLoadBalancing; }
...
void exahype::repositories::RepositorySTDStack::logIterationStatistics(bool logAllAdapters) const {
  logInfo( "logIterationStatistics()", "|| adapter name \t || iterations \t || total CPU time [t]=s \t || average CPU time [t]=s \t || total user time [t]=s \t || average user time [t]=s  || CPU time properties  || user time properties " );  
   ...
   if (logAllAdapters || _measureAugmentedAMRGridNoLoadBalancingCPUTime.getNumberOfMeasurements()>0) logInfo( "logIterationStatistics()", "| AugmentedAMRGridNoLoadBalancing \t |  " << _measureAugmentedAMRGridNoLoadBalancingCPUTime.getNumberOfMeasurements() << " \t |  " << _measureAugmentedAMRGridNoLoadBalancingCPUTime.getAccumulatedValue() << " \t |  " << _measureAugmentedAMRGridNoLoadBalancingCPUTime.getValue()  << " \t |  " << _measureAugmentedAMRGridNoLoadBalancingCalendarTime.getAccumulatedValue() << " \t |  " << _measureAugmentedAMRGridNoLoadBalancingCalendarTime.getValue() << " \t |  " << _measureAugmentedAMRGridNoLoadBalancingCPUTime.toString() << " \t |  " << _measureAugmentedAMRGridNoLoadBalancingCalendarTime.toString() );
...
void exahype::repositories::RepositorySTDStack::clearIterationStatistics() {
   ...
   _measureAugmentedAMRGridNoLoadBalancingCPUTime.erase();
   ...
   _measureAugmentedAMRGridNoLoadBalancingCalendarTime.erase();
