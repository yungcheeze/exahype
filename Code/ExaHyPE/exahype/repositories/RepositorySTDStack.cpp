...
exahype::repositories::RepositorySTDStack::RepositorySTDStack(
  ...
  _gridWithInitialLimiterDomainAndTimeStepSizeComputation(_vertexStack,_cellStack,_geometry,_solverState,domainSize,computationalDomainOffset,_regularGridContainer,_traversalOrderOnTopLevel),
...
void exahype::repositories::RepositorySTDStack::iterate(int numberOfIterations, bool exchangeBoundaryVertices) {
 ...
 void exahype::repositories::RepositorySTDStack::switchToInitialLimiterDomainAndTimeStepSizeComputation() { _repositoryState.setAction(exahype::records::RepositoryState::UseAdapterInitialLimiterDomainAndTimeStepSizeComputation); }
 ...
 bool exahype::repositories::RepositorySTDStack::isActiveAdapterInitialLimiterDomainAndTimeStepSizeComputation() const { return _repositoryState.getAction() == exahype::records::RepositoryState::UseAdapterInitialLimiterDomainAndTimeStepSizeComputation; }
