...
exahype::repositories::RepositorySTDStack::RepositorySTDStack(
  ...
  _gridWithSolutionRecomputation(_vertexStack,_cellStack,_geometry,_solverState,domainSize,computationalDomainOffset,_regularGridContainer,_traversalOrderOnTopLevel),
...
void exahype::repositories::RepositorySTDStack::iterate(int numberOfIterations, bool exchangeBoundaryVertices) {
 ...
 void exahype::repositories::RepositorySTDStack::switchToSolutionRecomputation() { _repositoryState.setAction(exahype::records::RepositoryState::UseAdapterSolutionRecomputation); }
 ...
 bool exahype::repositories::RepositorySTDStack::isActiveAdapterSolutionRecomputation() const { return _repositoryState.getAction() == exahype::records::RepositoryState::UseAdapterSolutionRecomputation; }
