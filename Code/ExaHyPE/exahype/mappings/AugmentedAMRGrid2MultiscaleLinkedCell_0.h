...
#ifndef EXAHYPE_ADAPTERS_AugmentedAMRGrid2MultiscaleLinkedCell_0_H_
#define EXAHYPE_ADAPTERS_AugmentedAMRGrid2MultiscaleLinkedCell_0_H_
...
namespace exahype {
      namespace adapters {
        class AugmentedAMRGrid2MultiscaleLinkedCell_0;
      } 
}
 ...
 */
class exahype::adapters::AugmentedAMRGrid2MultiscaleLinkedCell_0 {
  public:
    ...
    AugmentedAMRGrid2MultiscaleLinkedCell_0();

    #if defined(SharedMemoryParallelisation)
    AugmentedAMRGrid2MultiscaleLinkedCell_0(const AugmentedAMRGrid2MultiscaleLinkedCell_0& masterThread);
    #endif

    virtual ~AugmentedAMRGrid2MultiscaleLinkedCell_0();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const AugmentedAMRGrid2MultiscaleLinkedCell_0& workerThread);
    #endif
