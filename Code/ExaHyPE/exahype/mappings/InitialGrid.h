...
#ifndef EXAHYPE_MAPPINGS_InitialGrid_H_
#define EXAHYPE_MAPPINGS_InitialGrid_H_
 ...
 */
class exahype::mappings::InitialGrid {
 private:
  /**
 ...
 public:
   ...
   */
  InitialGrid(const InitialGrid& masterThread);
#endif
   ...
   */
  void mergeWithWorkerThread(const InitialGrid& workerThread);
#endif
