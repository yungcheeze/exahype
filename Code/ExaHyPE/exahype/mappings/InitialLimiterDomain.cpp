 ...
 */
peano::CommunicationSpecification   exahype::mappings::InitialLimiterDomain::communicationSpecification() {
 ...
 * @todo Please tailor the parameters to your mapping's properties.
 */
peano::MappingSpecification   exahype::mappings::InitialLimiterDomain::touchVertexLastTimeSpecification() {
 ...
 * @todo Please tailor the parameters to your mapping's properties.
 */
peano::MappingSpecification   exahype::mappings::InitialLimiterDomain::touchVertexFirstTimeSpecification() { 
  return peano::MappingSpecification(peano::MappingSpecification::WholeTree,peano::MappingSpecification::RunConcurrentlyOnFineGrid);
}
 ...
 * @todo Please tailor the parameters to your mapping's properties.
 */
peano::MappingSpecification   exahype::mappings::InitialLimiterDomain::enterCellSpecification() {
 ...
 * @todo Please tailor the parameters to your mapping's properties.
 */
peano::MappingSpecification   exahype::mappings::InitialLimiterDomain::leaveCellSpecification() {
  return peano::MappingSpecification(peano::MappingSpecification::WholeTree,peano::MappingSpecification::AvoidFineGridRaces);
}
 ...
 * @todo Please tailor the parameters to your mapping's properties.
 */
peano::MappingSpecification   exahype::mappings::InitialLimiterDomain::ascendSpecification() {
 ...
 * @todo Please tailor the parameters to your mapping's properties.
 */
peano::MappingSpecification   exahype::mappings::InitialLimiterDomain::descendSpecification() {
  return peano::MappingSpecification(peano::MappingSpecification::WholeTree,peano::MappingSpecification::AvoidCoarseGridRaces);
}


tarch::logging::Log                exahype::mappings::InitialLimiterDomain::_log( "exahype::mappings::InitialLimiterDomain" ); 


exahype::mappings::InitialLimiterDomain::InitialLimiterDomain() {
  logTraceIn( "InitialLimiterDomain()" );
  // @todo Insert your code here
  logTraceOut( "InitialLimiterDomain()" );
}
...
exahype::mappings::InitialLimiterDomain::InitialLimiterDomain(const InitialLimiterDomain&  masterThread) {
  logTraceIn( "InitialLimiterDomain(InitialLimiterDomain)" );
  // @todo Insert your code here
  logTraceOut( "InitialLimiterDomain(InitialLimiterDomain)" );
}


void exahype::mappings::InitialLimiterDomain::mergeWithWorkerThread(const InitialLimiterDomain& workerThread) {
  logTraceIn( "mergeWithWorkerThread(InitialLimiterDomain)" );
  // @todo Insert your code here
  logTraceOut( "mergeWithWorkerThread(InitialLimiterDomain)" );
}
#endif
