...
#ifndef EXAHYPE_MAPPINGS_CellDescriptionCleaningialisation_H_
#define EXAHYPE_MAPPINGS_CellDescriptionCleaningialisation_H_
 ...
 */
class exahype::mappings::CellDescriptionCleaning {
 private:
  /**
 ...
 public:
   ...
   */
  CellDescriptionCleaning(const CellDescriptionCleaning& masterThread);
#endif

  /**
   * Destructor. Typically does not implement any operation.
   */
  virtual ~CellDescriptionCleaning();
   ...
   */
  void mergeWithWorkerThread(const CellDescriptionCleaning& workerThread);
#endif
