...
#ifndef EXAHYPE_MAPPINGS_InitialisationAndCleaning_H_
#define EXAHYPE_MAPPINGS_InitialisationAndCleaning_H_
...
namespace exahype {
namespace mappings {
class InitialisationAndCleaning;
}
}
 ...
 */
class exahype::mappings::InitialisationAndCleaning {
 private:
  /**
 ...
 public:
   ...
   */
  InitialisationAndCleaning(const InitialisationAndCleaning& masterThread);
#endif

  /**
   * Destructor. Typically does not implement any operation.
   */
  virtual ~InitialisationAndCleaning();
   ...
   */
  void mergeWithWorkerThread(const InitialisationAndCleaning& workerThread);
#endif
