...
#ifndef EXAHYPE_MAPPINGS_BoundaryConditions_H_
#define EXAHYPE_MAPPINGS_BoundaryConditions_H_
...
class exahype::mappings::BoundaryConditions {
 private:
   ...
   */
  void applyBoundaryConditions(tarch::la::Vector<TWO_POWER_D, int>&
 ...
 public:
   ...
   */
  BoundaryConditions(const BoundaryConditions& masterThread);
#endif
   ...
   */
  void mergeWithWorkerThread(const BoundaryConditions& workerThread);
#endif
