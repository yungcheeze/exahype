...
#ifndef EXAHYPE_MAPPINGS_Reduction_H_
#define EXAHYPE_MAPPINGS_Reduction_H_
 ...
 */
class exahype::mappings::Reduction {
 public:
 ...
 public:
  ...
  /**
    ...
    * Nop.
    */
   Reduction(const Reduction& masterThread);
 #endif
   /**
    * Nop.
    */
    ...
    * Nop.
    */
   void mergeWithWorkerThread(const Reduction& workerThread);
 #endif
   /**
    * Nop.
    */
