...
class exahype::records::Vertex {
 public:
  ...
  enum InsideOutsideDomain { Inside = 0, Boundary = 1, Outside = 2 };

  enum RefinementControl {
    Unrefined = 0,
    Refined = 1,
    RefinementTriggered = 2,
    Refining = 3,
    EraseTriggered = 4,
    Erasing = 5,
  ...
  struct PersistentRecords {
     ...
     * @see convert()
     */
    inline tarch::la::Vector<TWO_POWER_D, int> getADERDGCellDescriptionsIndex()
        const
     ...
     * @see convert()
     */
    inline void setADERDGCellDescriptionsIndex(
        const tarch::la::Vector<TWO_POWER_D, int>& ADERDGCellDescriptionsIndex)
#ifdef UseManualInlining
        __attribute__((always_inline))
#endif
    ...
    inline void setInsideOutsideDomain(
        const InsideOutsideDomain& insideOutsideDomain)
#ifdef UseManualInlining
        __attribute__((always_inline))
#endif
    ...
    inline void setAdjacentSubtreeForksIntoOtherRank(
        const bool& adjacentSubtreeForksIntoOtherRank)
#ifdef UseManualInlining
        __attribute__((always_inline))
#endif
 ...
 public:
   ...
   * Generated
   */
  Vertex(const tarch::la::Vector<TWO_POWER_D, int>& ADERDGCellDescriptionsIndex,
         const bool& isHangingNode, const RefinementControl& refinementControl,
         const int& adjacentCellsHeight,
         const InsideOutsideDomain& insideOutsideDomain,
         const tarch::la::Vector<DIMENSIONS, double>& x, const int& level,
  ...
  inline void setADERDGCellDescriptionsIndex(
      int elementIndex, const int& ADERDGCellDescriptionsIndex)
#ifdef UseManualInlining
      __attribute__((always_inline))
#endif
  {
    assertion(elementIndex >= 0);
    assertion(elementIndex < TWO_POWER_D);
    _persistentRecords._ADERDGCellDescriptionsIndex[elementIndex] =
        ADERDGCellDescriptionsIndex;
  }
  ...
  inline void setAdjacentCellsHeightOfPreviousIteration(
      const int& adjacentCellsHeightOfPreviousIteration)
#ifdef UseManualInlining
      __attribute__((always_inline))
#endif
  ...
  inline void setNumberOfAdjacentRefinedCells(
      const int& numberOfAdjacentRefinedCells)
#ifdef UseManualInlining
      __attribute__((always_inline))
#endif
...
class exahype::records::VertexPacked {
 public:
  ...
  struct PersistentRecords {
    ...
    {
      int mask = 1 << (0);
      _packedRecords0 = static_cast<int>(
          isHangingNode ? (_packedRecords0 | mask) : (_packedRecords0 & ~mask));
    }
...
#endif
    {
      ...
      _packedRecords0 = static_cast<int>(
          _packedRecords0 | static_cast<int>(refinementControl) << (1));
    }
...
#endif
    {
      ...
      _packedRecords0 = static_cast<int>(_packedRecords0 & ~mask);
      _packedRecords0 = static_cast<int>(
          _packedRecords0 | static_cast<int>(insideOutsideDomain) << (4));
    }
    ...
    {
      int mask = 1 << (6);
      _packedRecords0 = static_cast<int>(adjacentSubtreeForksIntoOtherRank
 ...
 public:
  ...
  {
    int mask = 1 << (0);
    _persistentRecords._packedRecords0 = static_cast<int>(
        isHangingNode ? (_persistentRecords._packedRecords0 | mask)
...
#endif
  {
    ...
    int mask = (1 << (3)) - 1;
    mask = static_cast<int>(mask << (1));
    _persistentRecords._packedRecords0 =
        static_cast<int>(_persistentRecords._packedRecords0 & ~mask);
    _persistentRecords._packedRecords0 =
        static_cast<int>(_persistentRecords._packedRecords0 |
                         static_cast<int>(refinementControl) << (1));
  }
...
#endif
  {
    ...
    _persistentRecords._packedRecords0 =
        static_cast<int>(_persistentRecords._packedRecords0 |
                         static_cast<int>(insideOutsideDomain) << (4));
  }
...
#endif
  {
    int mask = 1 << (6);
    _persistentRecords._packedRecords0 =
        static_cast<int>(adjacentSubtreeForksIntoOtherRank
                             ? (_persistentRecords._packedRecords0 | mask)
                             : (_persistentRecords._packedRecords0 & ~mask));
  }
