...
class exahype::records::Cell {
 public:
  ...
  enum State { Leaf = 0, Refined = 1, Root = 2 };
  ...
  struct PersistentRecords {
    ...
    inline void setADERDGCellDescriptionsIndex(
        const int& ADERDGCellDescriptionsIndex)
#ifdef UseManualInlining
        __attribute__((always_inline))
#endif
    {
     ...
     * @see convert()
     */
    inline tarch::la::Vector<DIMENSIONS_TIMES_TWO, short int> getAccessNumber()
        const
#ifdef UseManualInlining
        __attribute__((always_inline))
#endif
    ...
    inline void setNumberOfLoadsFromInputStream(
        const int& numberOfLoadsFromInputStream)
#ifdef UseManualInlining
        __attribute__((always_inline))
#endif
    ...
    inline void setNumberOfStoresToOutputStream(
        const int& numberOfStoresToOutputStream)
#ifdef UseManualInlining
        __attribute__((always_inline))
#endif
 ...
 public:
   ...
   * Generated
   */
  Cell(const int& ADERDGCellDescriptionsIndex, const bool& isInside,
       const State& state, const std::bitset<DIMENSIONS>& evenFlags,
       const tarch::la::Vector<DIMENSIONS_TIMES_TWO, short int>& accessNumber,
       const int& numberOfLoadsFromInputStream,
       const int& numberOfStoresToOutputStream);
...
class exahype::records::CellPacked {
 public:
  ...
  struct PersistentRecords {
    ...
    {
      int mask = 1 << (0);
      _packedRecords0 = static_cast<int>(isInside ? (_packedRecords0 | mask)
...
#endif
    {
      ...
      _packedRecords0 =
          static_cast<int>(_packedRecords0 | static_cast<int>(state) << (1));
    }
...
#endif
    {
      ...
      _packedRecords0 = static_cast<int>(_packedRecords0 & ~mask);
      _packedRecords0 =
          static_cast<int>(_packedRecords0 | evenFlags.to_ulong() << (3));
    }
 ...
 public:
...
#endif
  {
    ...
    _persistentRecords._packedRecords0 = static_cast<int>(
        isInside ? (_persistentRecords._packedRecords0 | mask)
...
#endif
  {
    ...
    _persistentRecords._packedRecords0 = static_cast<int>(
        _persistentRecords._packedRecords0 | static_cast<int>(state) << (1));
  }
...
#endif
  {
    ...
    _persistentRecords._packedRecords0 =
        static_cast<int>(_persistentRecords._packedRecords0 & ~mask);
    _persistentRecords._packedRecords0 = static_cast<int>(
        _persistentRecords._packedRecords0 | evenFlags.to_ulong() << (3));
  }
...
#endif
  {
    ...
    _persistentRecords._packedRecords0 =
        _persistentRecords._packedRecords0 & ~mask;
    _persistentRecords._packedRecords0 =
        _persistentRecords._packedRecords0 | shiftedValue;
  }
...
class exahype::records::CellPacked {
 public:
  ...
  struct PersistentRecords {
...
#endif
    {
      int mask = 1 << (DIMENSIONS + 3);
      _packedRecords0 =
          static_cast<int>(cellIsAForkCandidate ? (_packedRecords0 | mask)
                                                : (_packedRecords0 & ~mask));
    }
  };
 ...
 public:
...
#endif
  {
    int mask = 1 << (DIMENSIONS + 3);
    _persistentRecords._packedRecords0 = static_cast<int>(
        cellIsAForkCandidate ? (_persistentRecords._packedRecords0 | mask)
                             : (_persistentRecords._packedRecords0 & ~mask));
  }
