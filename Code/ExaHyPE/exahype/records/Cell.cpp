#include "exahype/records/Cell.h"
   ...
   exahype::records::Cell::PersistentRecords::PersistentRecords(const std::bitset<EXAHYPE_NPROBLEMS>& isPDEActive, const int& ADERDGCellDescriptionsIndex, const bool& isInside, const State& state, const std::bitset<DIMENSIONS>& evenFlags, const tarch::la::Vector<DIMENSIONS_TIMES_TWO,short int>& accessNumber, const int& numberOfLoadsFromInputStream, const int& numberOfStoresToOutputStream):
   ...
   void exahype::records::Cell::toString (std::ostream& out) const {
      out << "("; 
      out << "isPDEActive:[";
   for (int i = 0; i < EXAHYPE_NPROBLEMS-1; i++) {
      out << getIsPDEActive(i) << ",";
   }
   out << getIsPDEActive(EXAHYPE_NPROBLEMS-1) << "]";
      out << ",";
...
exahype::records::CellPacked::CellPacked(const std::bitset<EXAHYPE_NPROBLEMS>& isPDEActive, const int& ADERDGCellDescriptionsIndex, const bool& isInside, const State& state, const std::bitset<DIMENSIONS>& evenFlags, const tarch::la::Vector<DIMENSIONS_TIMES_TWO,short int>& accessNumber, const int& numberOfLoadsFromInputStream, const int& numberOfStoresToOutputStream):
_persistentRecords(isPDEActive, ADERDGCellDescriptionsIndex, isInside, state, evenFlags, accessNumber, numberOfLoadsFromInputStream, numberOfStoresToOutputStream) {
   if ((DIMENSIONS+3 >= (8 * sizeof(int)))) {
      std::cerr << "Packed-Type in " << __FILE__ << " too small. Either use bigger data type or append " << std::endl << std::endl;
      std::cerr << "  Packed-Type: int hint-size no-of-bits;  " << std::endl << std::endl;
...
exahype::records::Cell::PersistentRecords::PersistentRecords(const std::bitset<EXAHYPE_NPROBLEMS>& isPDEActive, const int& ADERDGCellDescriptionsIndex, const bool& isInside, const State& state, const int& level, const std::bitset<DIMENSIONS>& evenFlags, const tarch::la::Vector<DIMENSIONS_TIMES_TWO,short int>& accessNumber):
_isPDEActive(isPDEActive),
_ADERDGCellDescriptionsIndex(ADERDGCellDescriptionsIndex),
_isInside(isInside),
_state(state),
...
exahype::records::Cell::Cell(const std::bitset<EXAHYPE_NPROBLEMS>& isPDEActive, const int& ADERDGCellDescriptionsIndex, const bool& isInside, const State& state, const int& level, const std::bitset<DIMENSIONS>& evenFlags, const tarch::la::Vector<DIMENSIONS_TIMES_TWO,short int>& accessNumber):
...
exahype::records::CellPacked::PersistentRecords::PersistentRecords(const std::bitset<EXAHYPE_NPROBLEMS>& isPDEActive, const int& ADERDGCellDescriptionsIndex, const bool& isInside, const State& state, const int& level, const std::bitset<DIMENSIONS>& evenFlags, const tarch::la::Vector<DIMENSIONS_TIMES_TWO,short int>& accessNumber):
_isPDEActive(isPDEActive),
_ADERDGCellDescriptionsIndex(ADERDGCellDescriptionsIndex),
_level(level),
_accessNumber(accessNumber) {
...
exahype::records::CellPacked::CellPacked(const std::bitset<EXAHYPE_NPROBLEMS>& isPDEActive, const int& ADERDGCellDescriptionsIndex, const bool& isInside, const State& state, const int& level, const std::bitset<DIMENSIONS>& evenFlags, const tarch::la::Vector<DIMENSIONS_TIMES_TWO,short int>& accessNumber):
_persistentRecords(isPDEActive, ADERDGCellDescriptionsIndex, isInside, state, level, evenFlags, accessNumber) {
if ((DIMENSIONS+3 >= (8 * sizeof(int)))) {
std::cerr << "Packed-Type in " << __FILE__ << " too small. Either use bigger data type or append " << std::endl << std::endl;
std::cerr << "  Packed-Type: int hint-size no-of-bits;  " << std::endl << std::endl;
...
exahype::records::Cell::PersistentRecords::PersistentRecords(const std::bitset<EXAHYPE_NPROBLEMS>& isPDEActive, const int& ADERDGCellDescriptionsIndex, const bool& isInside, const State& state, const std::bitset<DIMENSIONS>& evenFlags, const tarch::la::Vector<DIMENSIONS_TIMES_TWO,short int>& accessNumber):
_isPDEActive(isPDEActive),
_ADERDGCellDescriptionsIndex(ADERDGCellDescriptionsIndex),
_isInside(isInside),
_state(state),
...
exahype::records::Cell::Cell(const std::bitset<EXAHYPE_NPROBLEMS>& isPDEActive, const int& ADERDGCellDescriptionsIndex, const bool& isInside, const State& state, const std::bitset<DIMENSIONS>& evenFlags, const tarch::la::Vector<DIMENSIONS_TIMES_TWO,short int>& accessNumber):
...
exahype::records::CellPacked::PersistentRecords::PersistentRecords(const std::bitset<EXAHYPE_NPROBLEMS>& isPDEActive, const int& ADERDGCellDescriptionsIndex, const bool& isInside, const State& state, const std::bitset<DIMENSIONS>& evenFlags, const tarch::la::Vector<DIMENSIONS_TIMES_TWO,short int>& accessNumber):
_isPDEActive(isPDEActive),
_ADERDGCellDescriptionsIndex(ADERDGCellDescriptionsIndex),
_accessNumber(accessNumber) {
setIsInside(isInside);
...
exahype::records::CellPacked::CellPacked(const std::bitset<EXAHYPE_NPROBLEMS>& isPDEActive, const int& ADERDGCellDescriptionsIndex, const bool& isInside, const State& state, const std::bitset<DIMENSIONS>& evenFlags, const tarch::la::Vector<DIMENSIONS_TIMES_TWO,short int>& accessNumber):
_persistentRecords(isPDEActive, ADERDGCellDescriptionsIndex, isInside, state, evenFlags, accessNumber) {
if ((DIMENSIONS+3 >= (8 * sizeof(int)))) {
std::cerr << "Packed-Type in " << __FILE__ << " too small. Either use bigger data type or append " << std::endl << std::endl;
std::cerr << "  Packed-Type: int hint-size no-of-bits;  " << std::endl << std::endl;
...
exahype::records::CellPacked::CellPacked(const std::bitset<EXAHYPE_NPROBLEMS>& isPDEActive, const int& ADERDGCellDescriptionsIndex, const bool& isInside, const State& state, const int& level, const std::bitset<DIMENSIONS>& evenFlags, const tarch::la::Vector<DIMENSIONS_TIMES_TWO,short int>& accessNumber, const int& responsibleRank, const bool& subtreeHoldsWorker, const double& nodeWorkload, const double& localWorkload, const double& totalWorkload, const double& maxWorkload, const double& minWorkload, const bool& cellIsAForkCandidate, const int& numberOfLoadsFromInputStream, const int& numberOfStoresToOutputStream):
_persistentRecords(isPDEActive, ADERDGCellDescriptionsIndex, isInside, state, level, evenFlags, accessNumber, responsibleRank, subtreeHoldsWorker, nodeWorkload, localWorkload, totalWorkload, maxWorkload, minWorkload, cellIsAForkCandidate, numberOfLoadsFromInputStream, numberOfStoresToOutputStream) {
if ((DIMENSIONS+4 >= (8 * sizeof(int)))) {
std::cerr << "Packed-Type in " << __FILE__ << " too small. Either use bigger data type or append " << std::endl << std::endl;
std::cerr << "  Packed-Type: int hint-size no-of-bits;  " << std::endl << std::endl;
