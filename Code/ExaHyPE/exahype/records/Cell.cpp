...
exahype::records::Cell::PersistentRecords::PersistentRecords(
    const int& ADERDGCellDescriptionsIndex, const bool& isInside,
    const State& state, const std::bitset<DIMENSIONS>& evenFlags,
...
exahype::records::Cell::Cell(
    ...
    const int& numberOfLoadsFromInputStream,
    const int& numberOfStoresToOutputStream)
    : _persistentRecords(ADERDGCellDescriptionsIndex, isInside, state,
...
exahype::records::CellPacked exahype::records::Cell::convert() const {
  return CellPacked(getADERDGCellDescriptionsIndex(), getIsInside(), getState(),
...
void exahype::records::Cell::initDatatype() {
  {
    ...
    MPI_Address(
        const_cast<void*>(static_cast<const void*>(
            &(dummyCell[0]._persistentRecords._ADERDGCellDescriptionsIndex))),
        &disp[0]);
    ...
    MPI_Address(
        const_cast<void*>(static_cast<const void*>(
            &(dummyCell[1]._persistentRecords._ADERDGCellDescriptionsIndex))),
        &disp[3]);
...
exahype::records::Cell exahype::records::CellPacked::convert() const {
  return Cell(getADERDGCellDescriptionsIndex(), getIsInside(), getState(),
              getEvenFlags(), getAccessNumber(),
              getNumberOfLoadsFromInputStream(),
              getNumberOfStoresToOutputStream());
}
...
void exahype::records::CellPacked::initDatatype() {
  {
    ...
    MPI_Address(const_cast<void*>(static_cast<const void*>(
                    &(dummyCellPacked[0]
                          ._persistentRecords._ADERDGCellDescriptionsIndex))),
                &disp[0]);
    MPI_Address(const_cast<void*>(static_cast<const void*>(
...
exahype::records::Cell::PersistentRecords::PersistentRecords(
    const int& ADERDGCellDescriptionsIndex, const bool& isInside,
    const State& state, const int& level,
...
exahype::records::Cell::Cell(
    ...
    const std::bitset<DIMENSIONS>& evenFlags,
    const tarch::la::Vector<DIMENSIONS_TIMES_TWO, short int>& accessNumber)
    : _persistentRecords(ADERDGCellDescriptionsIndex, isInside, state, level,
...
exahype::records::Cell::Cell(
    ...
    : _persistentRecords(ADERDGCellDescriptionsIndex, isInside, state,
                         ...
                         subtreeHoldsWorker, cellIsAForkCandidate) {}
...
exahype::records::CellPacked exahype::records::Cell::convert() const {
  return CellPacked(getADERDGCellDescriptionsIndex(), getIsInside(), getState(),
                    ...
                    getSubtreeHoldsWorker(), getCellIsAForkCandidate());
}
...
exahype::records::Cell::PersistentRecords::PersistentRecords(
    ...
    const tarch::la::Vector<DIMENSIONS_TIMES_TWO, short int>& accessNumber,
    const int& responsibleRank, const bool& subtreeHoldsWorker,
    const bool& cellIsAForkCandidate, const int& numberOfLoadsFromInputStream,
    const int& numberOfStoresToOutputStream)
    : _ADERDGCellDescriptionsIndex(ADERDGCellDescriptionsIndex),
      _isInside(isInside),
      _state(state),
...
exahype::records::CellPacked exahype::records::Cell::convert() const {
  return CellPacked(
      getADERDGCellDescriptionsIndex(), getIsInside(), getState(), getLevel(),
      getEvenFlags(), getAccessNumber(), getResponsibleRank(),
      getSubtreeHoldsWorker(), getCellIsAForkCandidate(),
...
exahype::records::Cell::Cell(
    ...
    const int& numberOfStoresToOutputStream)
    : _persistentRecords(
          ADERDGCellDescriptionsIndex, isInside, state, evenFlags, accessNumber,
          responsibleRank, subtreeHoldsWorker, cellIsAForkCandidate,
