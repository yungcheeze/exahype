 ...
 public:
  ...
  struct PersistentRecords {
    ...
    PersistentRecords(
        ...
        const double& currentMinTimeStepSize, const double& nextMinTimeStepSize,
        const double& currentMinTimeStamp,
    ...
    inline void setPreviousMinTimeStepSize(
        const double& previousMinTimeStepSize)
#ifdef UseManualInlining
        __attribute__((always_inline))
#endif
 ...
 public:
  ...
  struct PersistentRecords {
    ...
    PersistentRecords(const double& previousMinTimeStepSize,
                      ...
                      const double& nextMinTimeStepSize,
                      const double& currentMinTimeStamp,
                      const tarch::la::Vector<DIMENSIONS, double>& minMeshWidth,
                      const tarch::la::Vector<DIMENSIONS, double>& maxMeshWidth,
                      const double& numberOfInnerVertices,
