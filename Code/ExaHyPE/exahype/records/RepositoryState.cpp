...
std::string exahype::records::RepositoryState::toString(const Action& param) {
  switch (param) {
    ...
    case UseAdapterPlot:
      return "UseAdapterPlot";
    case UseAdapterSolutionUpdateAndGlobalTimeStepComputation:
      return "UseAdapterSolutionUpdateAndGlobalTimeStepComputation";
    case UseAdapterPredictorAndGlobalTimeStepComputation:
      return "UseAdapterPredictorAndGlobalTimeStepComputation";
    case UseAdapterADERDGTimeStep:
      return "UseAdapterADERDGTimeStep";
    case UseAdapterGlobalTimeStepComputation:
      return "UseAdapterGlobalTimeStepComputation";
    case UseAdapterFaceDataExchange:
      return "UseAdapterFaceDataExchange";
    case UseAdapterPredictor:
      return "UseAdapterPredictor";
    case UseAdapterCorrector:
      return "UseAdapterCorrector";
...
std::string exahype::records::RepositoryState::getActionMapping() {
  return "Action(WriteCheckpoint=0,ReadCheckpoint=1,Terminate=2,RunOnAllNodes="
         "3,UseAdapterInitialGrid=4,UseAdapterPatchInitialisation=5,"
         "UseAdapterPlot=6,"
         "UseAdapterSolutionUpdateAndGlobalTimeStepComputation=7,"
         "UseAdapterPredictorAndGlobalTimeStepComputation=8,"
         "UseAdapterADERDGTimeStep=9,UseAdapterGlobalTimeStepComputation=10,"
         "UseAdapterFaceDataExchange=11,UseAdapterPredictor=12,"
         "UseAdapterCorrector=13,NumberOfAdapters=14)";
}
