...
class exahype::adapters::InitialGrid2MultiscaleLinkedCell_1 {
  public:
    ...
    InitialGrid2MultiscaleLinkedCell_1(const InitialGrid2MultiscaleLinkedCell_1& masterThread);
    #endif

    virtual ~InitialGrid2MultiscaleLinkedCell_1();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const InitialGrid2MultiscaleLinkedCell_1& workerThread);
    #endif
