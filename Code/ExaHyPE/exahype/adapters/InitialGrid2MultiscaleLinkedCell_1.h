...
#ifndef EXAHYPE_ADAPTERS_InitialGrid2MultiscaleLinkedCell_1_H_
#define EXAHYPE_ADAPTERS_InitialGrid2MultiscaleLinkedCell_1_H_
...
namespace exahype {
namespace adapters {
class InitialGrid2MultiscaleLinkedCell_1;
}
}
 ...
 *
 * ADERDGCellDescriptionsIndex   Name of the index used for the cell indices
 *within the vertex and
 *          the cell
 *
 * @author Tobias Weinzierl
 * @version $Revision: 1.1 $
 */
class exahype::adapters::InitialGrid2MultiscaleLinkedCell_1 {
 public:
  ...
  virtual ~InitialGrid2MultiscaleLinkedCell_1();
