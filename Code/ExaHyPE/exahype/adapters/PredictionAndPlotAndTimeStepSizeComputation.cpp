...
peano::CommunicationSpecification   exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation::communicationSpecification() {
...
peano::MappingSpecification   exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation::touchVertexLastTimeSpecification() {
...
peano::MappingSpecification   exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation::touchVertexFirstTimeSpecification() { 
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation::enterCellSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation::leaveCellSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation::ascendSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation::descendSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation::PredictionAndPlotAndTimeStepSizeComputation() {
}
...
exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation::PredictionAndPlotAndTimeStepSizeComputation(const PredictionAndPlotAndTimeStepSizeComputation&  masterThread):
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation::mergeWithWorkerThread(const PredictionAndPlotAndTimeStepSizeComputation& workerThread) {
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation::createHangingVertex(
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation::destroyHangingVertex(
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation::createInnerVertex(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation::createBoundaryVertex(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation::destroyVertex(
      const exahype::Vertex&   fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      exahype::Vertex * const  coarseGridVertices,
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation::createCell(
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation::destroyCell(
...
#ifdef Parallel
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation::mergeWithNeighbour(
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation::prepareSendToNeighbour(
  exahype::Vertex&  vertex,
  int                                           toRank,
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation::prepareCopyToRemoteNode(
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation::mergeWithRemoteDataDueToForkOrJoin(
  exahype::Vertex&  localVertex,
...
bool exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation::prepareSendToWorker(
  exahype::Cell&                 fineGridCell,
  exahype::Vertex * const        fineGridVertices,
  const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
  exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation::prepareSendToMaster(
  exahype::Cell&                       localCell,
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation::mergeWithMaster(
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation::receiveDataFromMaster(
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation::mergeWithWorker(
  exahype::Cell&           localCell, 
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation::touchVertexFirstTime(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation::touchVertexLastTime(
      exahype::Vertex&         fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      exahype::Vertex * const  coarseGridVertices,
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation::enterCell(
      exahype::Cell&                 fineGridCell,
      exahype::Vertex * const        fineGridVertices,
      const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation::leaveCell(
      exahype::Cell&           fineGridCell,
      exahype::Vertex * const  fineGridVertices,
      const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
      exahype::Vertex * const  coarseGridVertices,
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation::beginIteration(
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation::endIteration(
  exahype::State&  solverState
) {
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation::descend(
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation::ascend(
  exahype::Cell * const    fineGridCells,
  exahype::Vertex * const  fineGridVertices,
  const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
  exahype::Vertex * const  coarseGridVertices,
