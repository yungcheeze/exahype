...
peano::CommunicationSpecification   exahype::adapters::CorrectionAndPlot::communicationSpecification() {
...
peano::MappingSpecification   exahype::adapters::CorrectionAndPlot::touchVertexLastTimeSpecification() {
...
peano::MappingSpecification   exahype::adapters::CorrectionAndPlot::touchVertexFirstTimeSpecification() { 
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::CorrectionAndPlot::enterCellSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::CorrectionAndPlot::leaveCellSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::CorrectionAndPlot::ascendSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::CorrectionAndPlot::descendSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
exahype::adapters::CorrectionAndPlot::CorrectionAndPlot() {
}
...
exahype::adapters::CorrectionAndPlot::CorrectionAndPlot(const CorrectionAndPlot&  masterThread):
...
void exahype::adapters::CorrectionAndPlot::mergeWithWorkerThread(const CorrectionAndPlot& workerThread) {
...
void exahype::adapters::CorrectionAndPlot::createHangingVertex(
...
void exahype::adapters::CorrectionAndPlot::destroyHangingVertex(
...
void exahype::adapters::CorrectionAndPlot::createInnerVertex(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::CorrectionAndPlot::createBoundaryVertex(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::CorrectionAndPlot::destroyVertex(
      const exahype::Vertex&   fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      exahype::Vertex * const  coarseGridVertices,
...
void exahype::adapters::CorrectionAndPlot::createCell(
...
void exahype::adapters::CorrectionAndPlot::destroyCell(
...
#ifdef Parallel
void exahype::adapters::CorrectionAndPlot::mergeWithNeighbour(
...
void exahype::adapters::CorrectionAndPlot::prepareSendToNeighbour(
  exahype::Vertex&  vertex,
  int                                           toRank,
...
void exahype::adapters::CorrectionAndPlot::prepareCopyToRemoteNode(
...
void exahype::adapters::CorrectionAndPlot::mergeWithRemoteDataDueToForkOrJoin(
  exahype::Vertex&  localVertex,
...
bool exahype::adapters::CorrectionAndPlot::prepareSendToWorker(
  exahype::Cell&                 fineGridCell,
  exahype::Vertex * const        fineGridVertices,
  const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
  exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::CorrectionAndPlot::prepareSendToMaster(
  exahype::Cell&                       localCell,
...
void exahype::adapters::CorrectionAndPlot::mergeWithMaster(
...
void exahype::adapters::CorrectionAndPlot::receiveDataFromMaster(
...
void exahype::adapters::CorrectionAndPlot::mergeWithWorker(
  exahype::Cell&           localCell, 
...
void exahype::adapters::CorrectionAndPlot::touchVertexFirstTime(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::CorrectionAndPlot::touchVertexLastTime(
      exahype::Vertex&         fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      exahype::Vertex * const  coarseGridVertices,
...
void exahype::adapters::CorrectionAndPlot::enterCell(
      exahype::Cell&                 fineGridCell,
      exahype::Vertex * const        fineGridVertices,
      const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::CorrectionAndPlot::leaveCell(
      exahype::Cell&           fineGridCell,
      exahype::Vertex * const  fineGridVertices,
      const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
      exahype::Vertex * const  coarseGridVertices,
...
void exahype::adapters::CorrectionAndPlot::beginIteration(
...
void exahype::adapters::CorrectionAndPlot::endIteration(
  exahype::State&  solverState
) {
...
void exahype::adapters::CorrectionAndPlot::descend(
...
void exahype::adapters::CorrectionAndPlot::ascend(
  exahype::Cell * const    fineGridCells,
  exahype::Vertex * const  fineGridVertices,
  const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
  exahype::Vertex * const  coarseGridVertices,
