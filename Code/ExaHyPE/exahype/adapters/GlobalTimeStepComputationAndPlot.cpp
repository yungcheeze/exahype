...
peano::CommunicationSpecification   exahype::adapters::GlobalTimeStepComputationAndPlot::communicationSpecification() {
...
peano::MappingSpecification   exahype::adapters::GlobalTimeStepComputationAndPlot::touchVertexLastTimeSpecification() {
...
peano::MappingSpecification   exahype::adapters::GlobalTimeStepComputationAndPlot::touchVertexFirstTimeSpecification() { 
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::GlobalTimeStepComputationAndPlot::enterCellSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::GlobalTimeStepComputationAndPlot::leaveCellSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::GlobalTimeStepComputationAndPlot::ascendSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::GlobalTimeStepComputationAndPlot::descendSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
exahype::adapters::GlobalTimeStepComputationAndPlot::GlobalTimeStepComputationAndPlot() {
}
...
exahype::adapters::GlobalTimeStepComputationAndPlot::GlobalTimeStepComputationAndPlot(const GlobalTimeStepComputationAndPlot&  masterThread):
...
void exahype::adapters::GlobalTimeStepComputationAndPlot::mergeWithWorkerThread(const GlobalTimeStepComputationAndPlot& workerThread) {
...
void exahype::adapters::GlobalTimeStepComputationAndPlot::createHangingVertex(
...
void exahype::adapters::GlobalTimeStepComputationAndPlot::destroyHangingVertex(
...
void exahype::adapters::GlobalTimeStepComputationAndPlot::createInnerVertex(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::GlobalTimeStepComputationAndPlot::createBoundaryVertex(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::GlobalTimeStepComputationAndPlot::destroyVertex(
      const exahype::Vertex&   fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      exahype::Vertex * const  coarseGridVertices,
...
void exahype::adapters::GlobalTimeStepComputationAndPlot::createCell(
...
void exahype::adapters::GlobalTimeStepComputationAndPlot::destroyCell(
...
#ifdef Parallel
void exahype::adapters::GlobalTimeStepComputationAndPlot::mergeWithNeighbour(
...
void exahype::adapters::GlobalTimeStepComputationAndPlot::prepareSendToNeighbour(
  exahype::Vertex&  vertex,
  int                                           toRank,
...
void exahype::adapters::GlobalTimeStepComputationAndPlot::prepareCopyToRemoteNode(
...
void exahype::adapters::GlobalTimeStepComputationAndPlot::mergeWithRemoteDataDueToForkOrJoin(
  exahype::Vertex&  localVertex,
...
bool exahype::adapters::GlobalTimeStepComputationAndPlot::prepareSendToWorker(
  exahype::Cell&                 fineGridCell,
  exahype::Vertex * const        fineGridVertices,
  const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
  exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::GlobalTimeStepComputationAndPlot::prepareSendToMaster(
  exahype::Cell&                       localCell,
...
void exahype::adapters::GlobalTimeStepComputationAndPlot::mergeWithMaster(
...
void exahype::adapters::GlobalTimeStepComputationAndPlot::receiveDataFromMaster(
...
void exahype::adapters::GlobalTimeStepComputationAndPlot::mergeWithWorker(
  exahype::Cell&           localCell, 
...
void exahype::adapters::GlobalTimeStepComputationAndPlot::touchVertexFirstTime(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::GlobalTimeStepComputationAndPlot::touchVertexLastTime(
      exahype::Vertex&         fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      exahype::Vertex * const  coarseGridVertices,
...
void exahype::adapters::GlobalTimeStepComputationAndPlot::enterCell(
      exahype::Cell&                 fineGridCell,
      exahype::Vertex * const        fineGridVertices,
      const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::GlobalTimeStepComputationAndPlot::leaveCell(
      exahype::Cell&           fineGridCell,
      exahype::Vertex * const  fineGridVertices,
      const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
      exahype::Vertex * const  coarseGridVertices,
...
void exahype::adapters::GlobalTimeStepComputationAndPlot::beginIteration(
...
void exahype::adapters::GlobalTimeStepComputationAndPlot::endIteration(
  exahype::State&  solverState
) {
...
void exahype::adapters::GlobalTimeStepComputationAndPlot::descend(
...
void exahype::adapters::GlobalTimeStepComputationAndPlot::ascend(
  exahype::Cell * const    fineGridCells,
  exahype::Vertex * const  fineGridVertices,
  const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
  exahype::Vertex * const  coarseGridVertices,
