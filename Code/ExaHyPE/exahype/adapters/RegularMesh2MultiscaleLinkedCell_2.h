...
#ifndef EXAHYPE_ADAPTERS_RegularMesh2MultiscaleLinkedCell_2_H_
#define EXAHYPE_ADAPTERS_RegularMesh2MultiscaleLinkedCell_2_H_
...
namespace exahype {
      namespace adapters {
        class RegularMesh2MultiscaleLinkedCell_2;
      } 
}
 ...
 */
class exahype::adapters::RegularMesh2MultiscaleLinkedCell_2 {
  public:
    ...
    RegularMesh2MultiscaleLinkedCell_2();

    #if defined(SharedMemoryParallelisation)
    RegularMesh2MultiscaleLinkedCell_2(const RegularMesh2MultiscaleLinkedCell_2& masterThread);
    #endif

    virtual ~RegularMesh2MultiscaleLinkedCell_2();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const RegularMesh2MultiscaleLinkedCell_2& workerThread);
    #endif
