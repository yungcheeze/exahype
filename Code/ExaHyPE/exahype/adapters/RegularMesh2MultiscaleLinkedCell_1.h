...
#ifndef EXAHYPE_ADAPTERS_RegularMesh2MultiscaleLinkedCell_1_H_
#define EXAHYPE_ADAPTERS_RegularMesh2MultiscaleLinkedCell_1_H_
...
namespace exahype {
      namespace adapters {
        class RegularMesh2MultiscaleLinkedCell_1;
      } 
}
 ...
 */
class exahype::adapters::RegularMesh2MultiscaleLinkedCell_1 {
  public:
    ...
    RegularMesh2MultiscaleLinkedCell_1();

    #if defined(SharedMemoryParallelisation)
    RegularMesh2MultiscaleLinkedCell_1(const RegularMesh2MultiscaleLinkedCell_1& masterThread);
    #endif

    virtual ~RegularMesh2MultiscaleLinkedCell_1();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const RegularMesh2MultiscaleLinkedCell_1& workerThread);
    #endif
