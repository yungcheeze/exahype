...
peano::CommunicationSpecification   exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation2d::communicationSpecification() {
...
peano::MappingSpecification   exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation2d::touchVertexLastTimeSpecification() {
...
peano::MappingSpecification   exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation2d::touchVertexFirstTimeSpecification() { 
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation2d::enterCellSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation2d::leaveCellSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation2d::ascendSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation2d::descendSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation2d::PredictionAndPlotAndTimeStepSizeComputation2d() {
}
...
exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation2d::PredictionAndPlotAndTimeStepSizeComputation2d(const PredictionAndPlotAndTimeStepSizeComputation2d&  masterThread):
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation2d::mergeWithWorkerThread(const PredictionAndPlotAndTimeStepSizeComputation2d& workerThread) {
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation2d::createHangingVertex(
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation2d::destroyHangingVertex(
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation2d::createInnerVertex(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation2d::createBoundaryVertex(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation2d::destroyVertex(
      const exahype::Vertex&   fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      exahype::Vertex * const  coarseGridVertices,
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation2d::createCell(
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation2d::destroyCell(
...
#ifdef Parallel
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation2d::mergeWithNeighbour(
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation2d::prepareSendToNeighbour(
  exahype::Vertex&  vertex,
  int                                           toRank,
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation2d::prepareCopyToRemoteNode(
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation2d::mergeWithRemoteDataDueToForkOrJoin(
  exahype::Vertex&  localVertex,
...
bool exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation2d::prepareSendToWorker(
  exahype::Cell&                 fineGridCell,
  exahype::Vertex * const        fineGridVertices,
  const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
  exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation2d::prepareSendToMaster(
  exahype::Cell&                       localCell,
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation2d::mergeWithMaster(
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation2d::receiveDataFromMaster(
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation2d::mergeWithWorker(
  exahype::Cell&           localCell, 
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation2d::touchVertexFirstTime(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation2d::touchVertexLastTime(
      exahype::Vertex&         fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      exahype::Vertex * const  coarseGridVertices,
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation2d::enterCell(
      exahype::Cell&                 fineGridCell,
      exahype::Vertex * const        fineGridVertices,
      const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation2d::leaveCell(
      exahype::Cell&           fineGridCell,
      exahype::Vertex * const  fineGridVertices,
      const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
      exahype::Vertex * const  coarseGridVertices,
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation2d::beginIteration(
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation2d::endIteration(
  exahype::State&  solverState
) {
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation2d::descend(
...
void exahype::adapters::PredictionAndPlotAndTimeStepSizeComputation2d::ascend(
  exahype::Cell * const    fineGridCells,
  exahype::Vertex * const  fineGridVertices,
  const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
  exahype::Vertex * const  coarseGridVertices,
