...
#ifndef EXAHYPE_ADAPTERS_AugmentedAMRGrid2MultiscaleLinkedCell_8_H_
#define EXAHYPE_ADAPTERS_AugmentedAMRGrid2MultiscaleLinkedCell_8_H_
...
namespace exahype {
      namespace adapters {
        class AugmentedAMRGrid2MultiscaleLinkedCell_8;
      } 
}
 ...
 */
class exahype::adapters::AugmentedAMRGrid2MultiscaleLinkedCell_8 {
  public:
    ...
    AugmentedAMRGrid2MultiscaleLinkedCell_8();

    #if defined(SharedMemoryParallelisation)
    AugmentedAMRGrid2MultiscaleLinkedCell_8(const AugmentedAMRGrid2MultiscaleLinkedCell_8& masterThread);
    #endif

    virtual ~AugmentedAMRGrid2MultiscaleLinkedCell_8();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const AugmentedAMRGrid2MultiscaleLinkedCell_8& workerThread);
    #endif
