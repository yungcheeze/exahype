...
#ifndef EXAHYPE_ADAPTERS_CorrectorAndPredictorAndGlobalTimeStepComputationAndExport_H_
#define EXAHYPE_ADAPTERS_CorrectorAndPredictorAndGlobalTimeStepComputationAndExport_H_
...
namespace exahype {
      namespace adapters {
        class CorrectorAndPredictorAndGlobalTimeStepComputationAndExport;
      } 
}
...
class exahype::adapters::CorrectorAndPredictorAndGlobalTimeStepComputationAndExport {
  ...
  public:
    ...
    CorrectorAndPredictorAndGlobalTimeStepComputationAndExport(const CorrectorAndPredictorAndGlobalTimeStepComputationAndExport& masterThread);
    #endif

    virtual ~CorrectorAndPredictorAndGlobalTimeStepComputationAndExport();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const CorrectorAndPredictorAndGlobalTimeStepComputationAndExport& workerThread);
    #endif
