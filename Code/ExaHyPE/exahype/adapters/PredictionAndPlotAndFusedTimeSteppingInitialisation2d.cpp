...
peano::CommunicationSpecification   exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation2d::communicationSpecification() {
...
peano::MappingSpecification   exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation2d::touchVertexLastTimeSpecification() {
...
peano::MappingSpecification   exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation2d::touchVertexFirstTimeSpecification() { 
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation2d::enterCellSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation2d::leaveCellSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation2d::ascendSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation2d::descendSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation2d::PredictionAndPlotAndFusedTimeSteppingInitialisation2d() {
}
...
exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation2d::PredictionAndPlotAndFusedTimeSteppingInitialisation2d(const PredictionAndPlotAndFusedTimeSteppingInitialisation2d&  masterThread):
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation2d::mergeWithWorkerThread(const PredictionAndPlotAndFusedTimeSteppingInitialisation2d& workerThread) {
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation2d::createHangingVertex(
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation2d::destroyHangingVertex(
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation2d::createInnerVertex(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation2d::createBoundaryVertex(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation2d::destroyVertex(
      const exahype::Vertex&   fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      exahype::Vertex * const  coarseGridVertices,
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation2d::createCell(
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation2d::destroyCell(
...
#ifdef Parallel
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation2d::mergeWithNeighbour(
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation2d::prepareSendToNeighbour(
  exahype::Vertex&  vertex,
  int                                           toRank,
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation2d::prepareCopyToRemoteNode(
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation2d::mergeWithRemoteDataDueToForkOrJoin(
  exahype::Vertex&  localVertex,
...
bool exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation2d::prepareSendToWorker(
  exahype::Cell&                 fineGridCell,
  exahype::Vertex * const        fineGridVertices,
  const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
  exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation2d::prepareSendToMaster(
  exahype::Cell&                       localCell,
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation2d::mergeWithMaster(
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation2d::receiveDataFromMaster(
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation2d::mergeWithWorker(
  exahype::Cell&           localCell, 
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation2d::touchVertexFirstTime(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation2d::touchVertexLastTime(
      exahype::Vertex&         fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      exahype::Vertex * const  coarseGridVertices,
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation2d::enterCell(
      exahype::Cell&                 fineGridCell,
      exahype::Vertex * const        fineGridVertices,
      const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation2d::leaveCell(
      exahype::Cell&           fineGridCell,
      exahype::Vertex * const  fineGridVertices,
      const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
      exahype::Vertex * const  coarseGridVertices,
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation2d::beginIteration(
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation2d::endIteration(
  exahype::State&  solverState
) {
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation2d::descend(
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation2d::ascend(
  exahype::Cell * const    fineGridCells,
  exahype::Vertex * const  fineGridVertices,
  const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
  exahype::Vertex * const  coarseGridVertices,
