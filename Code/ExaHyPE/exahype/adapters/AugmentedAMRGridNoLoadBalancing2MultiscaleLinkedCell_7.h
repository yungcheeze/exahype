...
#ifndef EXAHYPE_ADAPTERS_AugmentedAMRGridNoLoadBalancing2MultiscaleLinkedCell_7_H_
#define EXAHYPE_ADAPTERS_AugmentedAMRGridNoLoadBalancing2MultiscaleLinkedCell_7_H_
...
namespace exahype {
      namespace adapters {
        class AugmentedAMRGridNoLoadBalancing2MultiscaleLinkedCell_7;
      } 
}
 ...
 */
class exahype::adapters::AugmentedAMRGridNoLoadBalancing2MultiscaleLinkedCell_7 {
  public:
    ...
    AugmentedAMRGridNoLoadBalancing2MultiscaleLinkedCell_7();

    #if defined(SharedMemoryParallelisation)
    AugmentedAMRGridNoLoadBalancing2MultiscaleLinkedCell_7(const AugmentedAMRGridNoLoadBalancing2MultiscaleLinkedCell_7& masterThread);
    #endif

    virtual ~AugmentedAMRGridNoLoadBalancing2MultiscaleLinkedCell_7();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const AugmentedAMRGridNoLoadBalancing2MultiscaleLinkedCell_7& workerThread);
    #endif
