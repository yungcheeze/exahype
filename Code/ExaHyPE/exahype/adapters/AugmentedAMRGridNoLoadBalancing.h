...
#ifndef EXAHYPE_ADAPTERS_AugmentedAMRGridNoLoadBalancing_H_
#define EXAHYPE_ADAPTERS_AugmentedAMRGridNoLoadBalancing_H_
...
namespace exahype {
      namespace adapters {
        class AugmentedAMRGridNoLoadBalancing;
      } 
}
 ...
 */
class exahype::adapters::AugmentedAMRGridNoLoadBalancing {
  private:
    ...
    typedef adapters::AugmentedAMRGridNoLoadBalancing2MultiscaleLinkedCell_7 Mapping7;
     ...
     Mapping7  _map2AugmentedAMRGridNoLoadBalancing2MultiscaleLinkedCell_7;
  ...
  public:
    ...
    AugmentedAMRGridNoLoadBalancing();

    #if defined(SharedMemoryParallelisation)
    AugmentedAMRGridNoLoadBalancing(const AugmentedAMRGridNoLoadBalancing& masterThread);
    #endif

    virtual ~AugmentedAMRGridNoLoadBalancing();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const AugmentedAMRGridNoLoadBalancing& workerThread);
    #endif
