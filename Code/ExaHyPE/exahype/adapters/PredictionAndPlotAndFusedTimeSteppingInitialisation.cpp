...
peano::CommunicationSpecification   exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation::communicationSpecification() {
...
peano::MappingSpecification   exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation::touchVertexLastTimeSpecification() {
...
peano::MappingSpecification   exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation::touchVertexFirstTimeSpecification() { 
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation::enterCellSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation::leaveCellSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation::ascendSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation::descendSpecification() {
  return peano::MappingSpecification::getMinimalSpecification()
...
exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation::PredictionAndPlotAndFusedTimeSteppingInitialisation() {
}
...
exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation::PredictionAndPlotAndFusedTimeSteppingInitialisation(const PredictionAndPlotAndFusedTimeSteppingInitialisation&  masterThread):
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation::mergeWithWorkerThread(const PredictionAndPlotAndFusedTimeSteppingInitialisation& workerThread) {
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation::createHangingVertex(
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation::destroyHangingVertex(
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation::createInnerVertex(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation::createBoundaryVertex(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation::destroyVertex(
      const exahype::Vertex&   fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      exahype::Vertex * const  coarseGridVertices,
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation::createCell(
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation::destroyCell(
...
#ifdef Parallel
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation::mergeWithNeighbour(
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation::prepareSendToNeighbour(
  exahype::Vertex&  vertex,
  int                                           toRank,
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation::prepareCopyToRemoteNode(
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation::mergeWithRemoteDataDueToForkOrJoin(
  exahype::Vertex&  localVertex,
...
bool exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation::prepareSendToWorker(
  exahype::Cell&                 fineGridCell,
  exahype::Vertex * const        fineGridVertices,
  const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
  exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation::prepareSendToMaster(
  exahype::Cell&                       localCell,
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation::mergeWithMaster(
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation::receiveDataFromMaster(
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation::mergeWithWorker(
  exahype::Cell&           localCell, 
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation::touchVertexFirstTime(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation::touchVertexLastTime(
      exahype::Vertex&         fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      exahype::Vertex * const  coarseGridVertices,
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation::enterCell(
      exahype::Cell&                 fineGridCell,
      exahype::Vertex * const        fineGridVertices,
      const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation::leaveCell(
      exahype::Cell&           fineGridCell,
      exahype::Vertex * const  fineGridVertices,
      const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
      exahype::Vertex * const  coarseGridVertices,
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation::beginIteration(
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation::endIteration(
  exahype::State&  solverState
) {
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation::descend(
...
void exahype::adapters::PredictionAndPlotAndFusedTimeSteppingInitialisation::ascend(
  exahype::Cell * const    fineGridCells,
  exahype::Vertex * const  fineGridVertices,
  const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
  exahype::Vertex * const  coarseGridVertices,
