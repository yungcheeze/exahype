...
void kernels::initDGMatrices(const std::set<int>& orders) {
  ...
  dudx[0][0][0] = 0.000000000000000E+000;
  ...
  dudx[1][0][0] = -1.73205080756888;
  dudx[1][0][1] = -1.73205080756888;
  dudx[1][1][0] = 1.73205080756888;
  dudx[1][1][1] = 1.73205080756888;
  ...
  dudx[2][0][0] = -3.87298334620742;
  dudx[2][0][1] = -1.29099444873581;
  dudx[2][0][2] = 1.29099444873581;
  dudx[2][1][0] = 5.16397779494322;
  dudx[2][1][1] = 0.0;
  dudx[2][1][2] = -5.16397779494322;
  dudx[2][2][0] = -1.29099444873581;
  dudx[2][2][1] = 1.29099444873581;
  dudx[2][2][2] = 3.87298334620742;
  ...
  dudx[3][0][0] = -6.66400047270456;
  dudx[3][0][1] = -1.51511522959847;
  dudx[3][0][2] = 0.657396448516548;
  dudx[3][0][3] = -1.16125633832453;
  dudx[3][1][0] = 9.72030883137039;
  dudx[3][1][1] = -0.768828784446417;
  dudx[3][1][2] = -2.94134046256143;
  dudx[3][1][3] = 4.21756469699036;
  dudx[3][2][0] = -4.21756469699036;
  dudx[3][2][1] = 2.94134046256143;
  dudx[3][2][2] = 0.768828784446416;
  dudx[3][2][3] = -9.72030883137039;
  dudx[3][3][0] = 1.16125633832453;
  dudx[3][3][1] = -0.657396448516549;
  dudx[3][3][2] = 1.51511522959847;
  dudx[3][3][3] = 6.66400047270456;
  ...
  dudx[4][0][0] = -10.1340811913091;
  dudx[4][0][1] = -1.92051204726392;
  dudx[4][0][2] = 0.602336319455663;
  dudx[4][0][3] = -0.488833230558736;
  dudx[4][0][4] = 1.10353370192663;
  dudx[4][1][0] = 15.4039041703445;
  dudx[4][1][1] = -1.51670643433575;
  dudx[4][1][2] = -2.87077648466948;
  dudx[4][1][3] = 1.85711605328767;
  dudx[4][1][4] = -3.92079823166656;
  dudx[4][2][0] = -8.08708750877533;
  dudx[4][2][1] = 4.80550130432860;
  dudx[4][2][2] = 0.0;
  dudx[4][2][3] = -4.80550130432860;
  dudx[4][2][4] = 8.08708750877533;
  dudx[4][3][0] = 3.92079823166656;
  dudx[4][3][1] = -1.85711605328767;
  dudx[4][3][2] = 2.87077648466948;
  dudx[4][3][3] = 1.51670643433575;
  dudx[4][3][4] = -15.4039041703445;
  dudx[4][4][0] = -1.10353370192663;
  dudx[4][4][1] = 0.488833230558736;
  dudx[4][4][2] = -0.602336319455663;
  dudx[4][4][3] = 1.92051204726392;
  dudx[4][4][4] = 10.1340811913091;
  ...
  dudx[5][0][0] = -14.2906542635432;
  dudx[5][0][1] = -2.44665094450282;
  dudx[5][0][2] = 0.648824636281340;
  dudx[5][0][3] = -0.384417667650658;
  dudx[5][0][4] = 0.416444521825969;
  dudx[5][0][5] = -1.07242111915536;
  dudx[5][1][0] = 22.2185673897881;
  dudx[5][1][1] = -2.34970456206819;
  dudx[5][1][2] = -3.21030080336390;
  dudx[5][1][3] = 1.50766679473151;
  dudx[5][1][4] = -1.51238022397769;
  dudx[5][1][5] = 3.78182294171865;
  dudx[5][2][0] = -12.8056333616177;
  dudx[5][2][1] = 6.97710759369412;
  dudx[5][2][2] = -0.506052557418655;
  dudx[5][2][3] = -4.19077785158206;
  dudx[5][2][4] = 3.27668778927483;
  dudx[5][2][5] = -7.58712205793611;
  dudx[5][3][0] = 7.58712205793612;
  dudx[5][3][1] = -3.27668778927483;
  dudx[5][3][2] = 4.19077785158206;
  dudx[5][3][3] = 0.506052557418652;
  dudx[5][3][4] = -6.97710759369412;
  dudx[5][3][5] = 12.8056333616177;
  dudx[5][4][0] = -3.78182294171866;
  dudx[5][4][1] = 1.51238022397769;
  dudx[5][4][2] = -1.50766679473151;
  dudx[5][4][3] = 3.21030080336390;
  dudx[5][4][4] = 2.34970456206819;
  dudx[5][4][5] = -22.2185673897881;
  dudx[5][5][0] = 1.07242111915536;
  dudx[5][5][1] = -0.416444521825969;
  dudx[5][5][2] = 0.384417667650658;
  dudx[5][5][3] = -0.648824636281342;
  dudx[5][5][4] = 2.44665094450282;
  dudx[5][5][5] = 14.2906542635432;
  ...
  dudx[6][0][0] = -19.1363646749315;
  dudx[6][0][1] = -3.07740010006487;
  dudx[6][0][2] = 0.738786906089635;
  dudx[6][0][3] = -0.369402827161276;
  dudx[6][0][4] = 0.296213518470781;
  dudx[6][0][5] = -0.377843290403441;
  dudx[6][0][6] = 1.05362097080365;
  dudx[6][1][0] = 30.1660682373151;
  dudx[6][1][1] = -3.29473135876334;
  dudx[6][1][2] = -3.74337405074762;
  dudx[6][1][3] = 1.48031370980963;
  dudx[6][1][4] = -1.09519287543963;
  dudx[6][1][5] = 1.34856094985632;
  dudx[6][1][6] = -3.70379089838906;
  dudx[6][2][0] = -18.3451357076279;
  dudx[6][2][1] = 9.48266087050298;
  dudx[6][2][2] = -0.971747035814698;
  dudx[6][2][3] = -4.30483308292376;
  dudx[6][2][4] = 2.46399395583784;
  dudx[6][2][5] = -2.77432671295856;
  dudx[6][2][6] = 7.35540539496397;
  dudx[6][3][0] = 12.0206676126229;
  dudx[6][3][1] = -4.91413846518046;
  dudx[6][3][2] = 5.64134877934168;
  dudx[6][3][3] = 0.0;
  dudx[6][3][4] = -5.64134877934168;
  dudx[6][3][5] = 4.91413846518046;
  dudx[6][3][6] = -12.0206676126229;
  dudx[6][4][0] = -7.35540539496397;
  dudx[6][4][1] = 2.77432671295856;
  dudx[6][4][2] = -2.46399395583784;
  dudx[6][4][3] = 4.30483308292376;
  dudx[6][4][4] = 0.971747035814699;
  dudx[6][4][5] = -9.48266087050298;
  dudx[6][4][6] = 18.3451357076279;
  dudx[6][5][0] = 3.70379089838906;
  dudx[6][5][1] = -1.34856094985632;
  dudx[6][5][2] = 1.09519287543963;
  dudx[6][5][3] = -1.48031370980963;
  dudx[6][5][4] = 3.74337405074762;
  dudx[6][5][5] = 3.29473135876333;
  dudx[6][5][6] = -30.1660682373151;
  dudx[6][6][0] = -1.05362097080365;
  dudx[6][6][1] = 0.377843290403441;
  dudx[6][6][2] = -0.296213518470782;
  dudx[6][6][3] = 0.369402827161276;
  dudx[6][6][4] = -0.738786906089635;
  dudx[6][6][5] = 3.07740010006488;
  dudx[6][6][6] = 19.1363646749315;
  ...
  dudx[7][0][0] = -24.6723540147803;
  dudx[7][0][1] = -3.80679853842774;
  dudx[7][0][2] = 0.856977588472523;
  dudx[7][0][3] = -0.386029576637310;
  dudx[7][0][4] = 0.262203957013796;
  dudx[7][0][5] = -0.250755017315009;
  dudx[7][0][6] = 0.354522891848221;
  dudx[7][0][7] = -1.04135224717181;
  dudx[7][1][0] = 39.2472636555488;
  dudx[7][1][1] = -4.36144187991706;
  dudx[7][1][2] = -4.41221989981728;
  dudx[7][1][3] = 1.57022076931592;
  dudx[7][1][4] = -0.982459201437345;
  dudx[7][1][5] = 0.904783039521224;
  dudx[7][1][6] = -1.25523042371068;
  dudx[7][1][7] = 3.65505378544184;
  dudx[7][2][0] = -24.6942856812855;
  dudx[7][2][1] = 12.3320325872074;
  dudx[7][2][2] = -1.45211666447287;
  dudx[7][2][3] = -4.70569665128642;
  dudx[7][2][4] = 2.27063911233578;
  dudx[7][2][5] = -1.90283221573187;
  dudx[7][2][6] = 2.52884357105373;
  dudx[7][2][7] = -7.22564524076939;
  dudx[7][3][0] = 17.1695629730558;
  dudx[7][3][1] = -6.77407325733088;
  dudx[7][3][2] = 7.26332678788761;
  dudx[7][3][3] = -0.379643635819476;
  dudx[7][3][4] = -5.45153296233952;
  dudx[7][3][5] = 3.50477200559564;
  dudx[7][3][6] = -4.23841712765958;
  dudx[7][3][7] = 11.6621306350382;
  dudx[7][4][0] = -11.6621306350382;
  dudx[7][4][1] = 4.23841712765958;
  dudx[7][4][2] = -3.50477200559565;
  dudx[7][4][3] = 5.45153296233952;
  dudx[7][4][4] = 0.379643635819472;
  dudx[7][4][5] = -7.26332678788761;
  dudx[7][4][6] = 6.77407325733088;
  dudx[7][4][7] = -17.1695629730558;
  dudx[7][5][0] = 7.22564524076940;
  dudx[7][5][1] = -2.52884357105374;
  dudx[7][5][2] = 1.90283221573188;
  dudx[7][5][3] = -2.27063911233578;
  dudx[7][5][4] = 4.70569665128642;
  dudx[7][5][5] = 1.45211666447287;
  dudx[7][5][6] = -12.3320325872074;
  dudx[7][5][7] = 24.6942856812855;
  dudx[7][6][0] = -3.65505378544184;
  dudx[7][6][1] = 1.25523042371068;
  dudx[7][6][2] = -0.904783039521225;
  dudx[7][6][3] = 0.982459201437346;
  dudx[7][6][4] = -1.57022076931592;
  dudx[7][6][5] = 4.41221989981728;
  dudx[7][6][6] = 4.36144187991707;
  dudx[7][6][7] = -39.2472636555488;
  dudx[7][7][0] = 1.04135224717181;
  dudx[7][7][1] = -0.354522891848221;
  dudx[7][7][2] = 0.250755017315009;
  dudx[7][7][3] = -0.262203957013796;
  dudx[7][7][4] = 0.386029576637310;
  dudx[7][7][5] = -0.856977588472523;
  dudx[7][7][6] = 3.80679853842774;
  dudx[7][7][7] = 24.6723540147803;
  ...
  dudx[8][0][0] = -30.8991827169835;
  dudx[8][0][1] = -4.63218472029402;
  dudx[8][0][2] = 0.997796081306655;
  dudx[8][0][3] = -0.419278650622120;
  dudx[8][0][4] = 0.256543087381117;
  dudx[8][0][5] = -0.208893165346314;
  dudx[8][0][6] = 0.223837996636034;
  dudx[8][0][7] = -0.339235939839986;
  dudx[8][0][8] = 1.03288687057482;
  dudx[8][1][0] = 49.4626017325298;
  dudx[8][1][1] = -5.55406469188891;
  dudx[8][1][2] = -5.19536036894586;
  dudx[8][1][3] = 1.72381228015036;
  dudx[8][1][4] = -0.970802008784658;
  dudx[8][1][5] = 0.760338204024569;
  dudx[8][1][6] = -0.798120064901230;
  dudx[8][1][7] = 1.19612774122447;
  dudx[8][1][8] = -3.62237112698749;
  dudx[8][2][0] = -31.8477222928916;
  dudx[8][2][1] = 15.5296323372948;
  dudx[8][2][2] = -1.96664167448930;
  dudx[8][2][3] = -5.27556427017989;
  dudx[8][2][4] = 2.28771703791198;
  dudx[8][2][5] = -1.62672803497203;
  dudx[8][2][6] = 1.63033350868190;
  dudx[8][2][7] = -2.38568843905795;
  dudx[8][2][8] = 7.14447620011321;
  dudx[8][3][0] = 23.0097127809385;
  dudx[8][3][1] = -8.85946163907006;
  dudx[8][3][2] = 9.07069957612577;
  dudx[8][3][3] = -0.724702245715045;
  dudx[8][3][4] = -5.67449495634154;
  dudx[8][3][5] = 3.08400753183306;
  dudx[8][3][6] = -2.79696361215774;
  dudx[8][3][7] = 3.90772662942600;
  dudx[8][3][8] = -11.4639076647186;
  dudx[8][4][0] = -16.6343252246113;
  dudx[8][4][1] = 5.89500870571070;
  dudx[8][4][2] = -4.64740578573829;
  dudx[8][4][3] = 6.70445742190599;
  dudx[8][4][4] = 0.0;
  dudx[8][4][5] = -6.70445742190598;
  dudx[8][4][6] = 4.64740578573829;
  dudx[8][4][7] = -5.89500870571070;
  dudx[8][4][8] = 16.6343252246113;
  dudx[8][5][0] = 11.4639076647186;
  dudx[8][5][1] = -3.90772662942600;
  dudx[8][5][2] = 2.79696361215774;
  dudx[8][5][3] = -3.08400753183306;
  dudx[8][5][4] = 5.67449495634154;
  dudx[8][5][5] = 0.724702245715037;
  dudx[8][5][6] = -9.07069957612576;
  dudx[8][5][7] = 8.85946163907006;
  dudx[8][5][8] = -23.0097127809385;
  dudx[8][6][0] = -7.14447620011321;
  dudx[8][6][1] = 2.38568843905795;
  dudx[8][6][2] = -1.63033350868191;
  dudx[8][6][3] = 1.62672803497203;
  dudx[8][6][4] = -2.28771703791198;
  dudx[8][6][5] = 5.27556427017989;
  dudx[8][6][6] = 1.96664167448930;
  dudx[8][6][7] = -15.5296323372948;
  dudx[8][6][8] = 31.8477222928916;
  dudx[8][7][0] = 3.62237112698749;
  dudx[8][7][1] = -1.19612774122447;
  dudx[8][7][2] = 0.798120064901230;
  dudx[8][7][3] = -0.760338204024570;
  dudx[8][7][4] = 0.970802008784658;
  dudx[8][7][5] = -1.72381228015036;
  dudx[8][7][6] = 5.19536036894586;
  dudx[8][7][7] = 5.55406469188891;
  dudx[8][7][8] = -49.4626017325297;
  dudx[8][8][0] = -1.03288687057482;
  dudx[8][8][1] = 0.339235939839986;
  dudx[8][8][2] = -0.223837996636034;
  dudx[8][8][3] = 0.208893165346314;
  dudx[8][8][4] = -0.256543087381117;
  dudx[8][8][5] = 0.419278650622120;
  dudx[8][8][6] = -0.997796081306655;
  dudx[8][8][7] = 4.63218472029402;
  dudx[8][8][8] = 30.8991827169835;
  ...
  dudx[9][0][0] = -37.8171527486180;
  dudx[9][0][1] = -5.55221178878697;
  dudx[9][0][2] = 1.15874199154603;
  dudx[9][0][3] = -0.463670843342151;
  dudx[9][0][4] = 0.264258083277646;
  dudx[9][0][5] = -0.194179854110539;
  dudx[9][0][6] = 0.178084922278927;
  dudx[9][0][7] = -0.206400938601256;
  dudx[9][0][8] = 0.328618912036927;
  dudx[9][0][9] = -1.02679258298284;
  dudx[9][1][0] = 60.8123335441465;
  dudx[9][1][1] = -6.87471113840964;
  dudx[9][1][2] = -6.08312226355395;
  dudx[9][1][3] = 1.92144265254853;
  dudx[9][1][4] = -1.00747512795645;
  dudx[9][1][5] = 0.711624223357240;
  dudx[9][1][6] = -0.638776739965744;
  dudx[9][1][7] = 0.731223402311088;
  dudx[9][1][8] = -1.15598468101532;
  dudx[9][1][9] = 3.59930126009660;
  dudx[9][2][0] = -39.8026156547822;
  dudx[9][2][1] = 19.0776891317615;
  dudx[9][2][2] = -2.52379732085697;
  dudx[9][2][3] = -5.97058294339489;
  dudx[9][2][4] = 2.40850404401795;
  dudx[9][2][5] = -1.54270321332220;
  dudx[9][2][6] = 1.31995100823980;
  dudx[9][2][7] = -1.47186623012038;
  dudx[9][2][8] = 2.29323892415239;
  dudx[9][2][9] = -7.08984164712197;
  dudx[9][3][0] = 29.5284679379790;
  dudx[9][3][1] = -11.1720509911342;
  dudx[9][3][2] = 11.0693723329507;
  dudx[9][3][3] = -1.06725496059118;
  dudx[9][3][4] = -6.11505442886767;
  dudx[9][3][5] = 2.98806831172731;
  dudx[9][3][6] = -2.30736185373899;
  dudx[9][3][7] = 2.44716961643150;
  dudx[9][3][8] = -3.71410840775407;
  dudx[9][3][9] = 11.3411809115424;
  dudx[9][4][0] = -22.2377029158574;
  dudx[9][4][1] = 7.74052346809455;
  dudx[9][4][2] = -5.90043670350459;
  dudx[9][4][3] = 8.08036247547946;
  dudx[9][4][4] = -0.304497427652666;
  dudx[9][4][5] = -6.71707432483301;
  dudx[9][4][6] = 3.94839904388578;
  dudx[9][4][7] = -3.77936781343969;
  dudx[9][4][8] = 5.46747393410527;
  dudx[9][4][9] = -16.3405177786664;
  dudx[9][5][0] = 16.3405177786664;
  dudx[9][5][1] = -5.46747393410527;
  dudx[9][5][2] = 3.77936781343969;
  dudx[9][5][3] = -3.94839904388578;
  dudx[9][5][4] = 6.71707432483301;
  dudx[9][5][5] = 0.304497427652673;
  dudx[9][5][6] = -8.08036247547946;
  dudx[9][5][7] = 5.90043670350460;
  dudx[9][5][8] = -7.74052346809456;
  dudx[9][5][9] = 22.2377029158574;
  dudx[9][6][0] = -11.3411809115424;
  dudx[9][6][1] = 3.71410840775406;
  dudx[9][6][2] = -2.44716961643149;
  dudx[9][6][3] = 2.30736185373899;
  dudx[9][6][4] = -2.98806831172731;
  dudx[9][6][5] = 6.11505442886767;
  dudx[9][6][6] = 1.06725496059119;
  dudx[9][6][7] = -11.0693723329507;
  dudx[9][6][8] = 11.1720509911342;
  dudx[9][6][9] = -29.5284679379790;
  dudx[9][7][0] = 7.08984164712196;
  dudx[9][7][1] = -2.29323892415238;
  dudx[9][7][2] = 1.47186623012038;
  dudx[9][7][3] = -1.31995100823980;
  dudx[9][7][4] = 1.54270321332219;
  dudx[9][7][5] = -2.40850404401795;
  dudx[9][7][6] = 5.97058294339489;
  dudx[9][7][7] = 2.52379732085698;
  dudx[9][7][8] = -19.0776891317615;
  dudx[9][7][9] = 39.8026156547822;
  dudx[9][8][0] = -3.59930126009659;
  dudx[9][8][1] = 1.15598468101531;
  dudx[9][8][2] = -0.731223402311086;
  dudx[9][8][3] = 0.638776739965742;
  dudx[9][8][4] = -0.711624223357239;
  dudx[9][8][5] = 1.00747512795645;
  dudx[9][8][6] = -1.92144265254853;
  dudx[9][8][7] = 6.08312226355394;
  dudx[9][8][8] = 6.87471113840963;
  dudx[9][8][9] = -60.8123335441464;
  dudx[9][9][0] = 1.02679258298284;
  dudx[9][9][1] = -0.328618912036926;
  dudx[9][9][2] = 0.206400938601255;
  dudx[9][9][3] = -0.178084922278927;
  dudx[9][9][4] = 0.194179854110538;
  dudx[9][9][5] = -0.264258083277646;
  dudx[9][9][6] = 0.463670843342151;
  dudx[9][9][7] = -1.15874199154603;
  dudx[9][9][8] = 5.55221178878697;
  dudx[9][9][9] = 37.8171527486180;
