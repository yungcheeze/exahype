! This file was created here as
!  cp ../MHD/Parameters.f90  .
! And modified afterwards so it reflects the parameters as they are in
! typesDef.f90. It's important that they keep the same!!
