...
from extractPerformanceIndicators import getSummary
    ...
    for pdegree in pdegrees:
      for hmax in hmaxs:
        for compiler in compilers:
          for mode in modes:
            name = 'ExaHyPE_Euler__dimension_' + dimension + '__process_' + `process` + '__pdegree_' + `pdegree` + '__hmax_' + hmax + '__compiler_' + compiler
            filename = name + '.slurm'
