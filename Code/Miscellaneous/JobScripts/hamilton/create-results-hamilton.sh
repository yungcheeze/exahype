...
sbatch --nodes=3  --ntasks-per-node=16 euler-asserts.slurm-script
sbatch --nodes=4  --ntasks-per-node=16 euler-asserts.slurm-script
sbatch --nodes=5  --ntasks-per-node=16 euler-asserts.slurm-script
sbatch --nodes=6  --ntasks-per-node=16 euler-asserts.slurm-script
sbatch --nodes=7  --ntasks-per-node=16 euler-asserts.slurm-script
sbatch --nodes=8  --ntasks-per-node=16 euler-asserts.slurm-script
