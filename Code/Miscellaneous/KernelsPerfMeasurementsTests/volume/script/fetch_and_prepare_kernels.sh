...
cp $CODEGENERATORPATH/runtime/degree$DEGREE/volumeIntegral$DEGREE.cpp ../srcRaw
cp $CODEGENERATORPATH/runtime/degree$DEGREE/GaussLegendreQuadrature$DEGREE.cpp ../srcRaw
cp $CODEGENERATORPATH/runtime/degree$DEGREE/DGMatrices$DEGREE.cpp ../srcRaw
cp $CODEGENERATORPATH/runtime/degree$DEGREE/asm_volumeIntegral_$DEGREE.c ../srcGen #no need to adapt
let DEGREE=DEGREE+1;
done
