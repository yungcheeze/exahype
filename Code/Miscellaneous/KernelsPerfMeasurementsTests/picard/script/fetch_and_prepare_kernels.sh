...
cp $CODEGENERATORPATH/runtime/degree$DEGREE/picard$DEGREE.cpph ../srcRaw
...
cp $CODEGENERATORPATH/runtime/degree$DEGREE/asm_picard_$DEGREE.c ../srcGen #no need to adapt
let DEGREE=DEGREE+1;
done
