...
def plot_scaling(ax,x,y,label_,color_="blue",marker_="s",hyperthreading=False,annotate=False):
    """
    ...
    if not hyperthreading: 
        ...
        plt.plot(x2[0:-1],y[0:-1],label=r"%s" % label_,markersize=8,marker=marker_,markevery=1,lw=1.2,color=color_,markerfacecolor=color_,markeredgecolor=color_) 
        plt.plot(x2[-1],y[-1],label="",markersize=8,marker="s",markevery=1,lw=1.2,color=color_,markerfacecolor=color_,markeredgecolor=color_) 
