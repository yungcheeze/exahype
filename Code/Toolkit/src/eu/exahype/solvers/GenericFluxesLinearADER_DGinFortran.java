...
public final class GenericFluxesLinearADER_DGinFortran extends GenericFluxesADER_DG {
  ...
  public void writeUserPDE(java.io.BufferedWriter writer, String solverName, String projectName)
    ...
    for (int i = 0; i < _numberOfUnknowns + _numberOfParameters; i++) {
      for (int j = 0; j < _numberOfUnknowns + _numberOfParameters; j++) {
        writer.write("  Bn(" + String.format("%" + digits + "d", i + 1) + ", "
            + String.format("%" + digits + "d", j + 1) + ") = 0.0\n");
      }
      writer.write("  !\n");
    }
    writer.write("  !\n");
  ...
  public void writeTypesDef(java.io.BufferedWriter writer, String solverName, String projectName)
    ...
    writer.write(
        "    INTEGER, PARAMETER             :: nVar = " + _numberOfUnknowns + _numberOfParameters
