...
public class OptimisedFluxesLinearADER_DGinC implements Solver {
  ...
  public OptimisedFluxesLinearADER_DGinC(int dimensions, int numberOfVariables, int order,
  ...
  public void writeHeader(java.io.BufferedWriter writer, String solverName, String projectName)
    ...
    Helpers.invokeCodeGenerator(solverName, _numberOfVariables, _order, true, _dimensions,
