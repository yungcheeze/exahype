...
public class OptimisedFluxesLinearADER_DGinC implements Solver {
  ...
  public OptimisedFluxesLinearADER_DGinC(int dimensions, int numberOfVariables, int order, String microarchitecture, String pathToLibxsmm) {
  ...
  public void writeHeader( java.io.BufferedWriter writer, String solverName, String projectName ) throws java.io.IOException {
   Helpers.invokeCodeGenerator(solverName, _numberOfVariables, _order, true, _dimensions, _microarchitecture, _pathToLibxsmm );
  ...
  public void writeGeneratedImplementation( java.io.BufferedWriter writer, String solverName, String projectName ) throws java.io.IOException {
    ...
    writer.write("   kernels::aderdg::optimised::solutionAdjustment<adjustedSolutionValues>( luh, center, dx, t, dt );\n");
    writer.write("}\n");
    writer.write("\n\n\n");
  }
  ...
  public void writeUserImplementation( java.io.BufferedWriter writer, String solverName, String projectName ) throws java.io.IOException {
      ...
      writer.write("}\n");
      writer.write("\n\n\n");
      writer.write("void " + projectName + "::" + solverName + "::adjustedSolutionValues(const double* const x,const double w,const double t,const double dt,double* Q) {\n");
      writer.write("  // Dimensions             = "+_dimensions      +"\n");
      writer.write("  // Number of variables    = "+Integer.toString(_numberOfVariables)+"\n");
      writer.write("  // @todo Please implement\n");
      for (int i=0; i < _numberOfVariables; i++) {
